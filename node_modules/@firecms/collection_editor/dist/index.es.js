...
import { useAuthController, useCustomizationController, toSnakeCase, singular, IconForView, FieldCaption, SearchIconsView, ArrayContainer, serializeRegExp, useSnackbarController, resolveEnumValues, isPropertyBuilder, getFieldConfig, ErrorBoundary, PropertyConfigBadge, AIModifiedIndicator, prettifyIdentifier, useNavigationController, DEFAULT_FIELD_CONFIGS, mergeDeep, getFieldId, ConfirmationDialog, isValidRegExp, resolveCollection, unslugify, isEmptyObject, useLargeLayout, makePropertiesEditable, resolveEntityView, resolveEntityAction, AIIcon, useSelectionController, CircularProgressCenter, EntityCollectionTable, slugify, randomString, removeUndefined, ErrorView, removeInitialAndTrailingSlashes, getDefaultPropertiesOrder, getPropertyInPath, joinCollectionLists } from "@firecms/core";
...
function GeneralSettingsForm(t0) {
  ...
  let t7;
  if ($[11] !== updateDatabaseId || $[12] !== values.databaseId) {
    t7 = /* @__PURE__ */ jsx(DefaultDatabaseField, { databaseId: values.databaseId, onDatabaseIdUpdate: updateDatabaseId });
    $[11] = updateDatabaseId;
    $[12] = values.databaseId;
    $[13] = t7;
  } else {
    t7 = $[13];
  }
  ...
  if ($[14] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t8 = () => setIconDialogOpen(true);
    $[14] = t8;
  } else {
    t8 = $[14];
  }
  let t9;
  if ($[15] !== collectionIcon) {
    t9 = /* @__PURE__ */ jsx(Tooltip, { title: "Change icon", asChild: true, children: /* @__PURE__ */ jsx(IconButton, { shape: "square", onClick: t8, children: collectionIcon }) });
    $[15] = collectionIcon;
    $[16] = t9;
  } else {
    t9 = $[16];
  ...
  if ($[17] !== t6 || $[18] !== t7 || $[19] !== t9) {
    t10 = /* @__PURE__ */ jsxs("div", { className: "flex flex-row gap-2 py-2 pt-3 items-center", children: [
      t6,
      t7,
      t9
    ] });
  ...
  let t11;
  if ($[21] !== parentCollection) {
    t11 = parentCollection && /* @__PURE__ */ jsx(Chip, { colorScheme: "tealDarker", children: /* @__PURE__ */ jsxs(Typography, { variant: "caption", children: [
  ...
  const t13 = values.name ?? "";
  let t14;
  if ($[26] !== updateName) {
    t14 = (e) => updateName(e.target.value);
    $[26] = updateName;
    $[27] = t14;
  } else {
    t14 = $[27];
  }
  const t15 = showErrors && Boolean(errors.name);
  let t16;
  if ($[28] !== t13 || $[29] !== t14 || $[30] !== t15) {
    t16 = /* @__PURE__ */ jsx(TextField, { value: t13, onChange: t14, label: "Name", autoFocus: true, required: true, error: t15 });
    $[28] = t13;
    $[29] = t14;
    $[30] = t15;
    $[31] = t16;
  ...
  const t17 = touched.name && Boolean(errors.name);
  const t18 = touched.name && Boolean(errors.name) ? errors.name : "Name of this collection, usually a plural name (e.g. Products)";
  let t19;
  if ($[32] !== t17 || $[33] !== t18) {
    t19 = /* @__PURE__ */ jsx(FieldCaption, { error: t17, children: t18 });
    $[32] = t17;
    $[33] = t18;
    $[34] = t19;
  } else {
  ...
  let t20;
  if ($[35] !== t16 || $[36] !== t19) {
    t20 = /* @__PURE__ */ jsxs("div", { className: "col-span-12", children: [
      t16,
      t19
    ] });
    $[35] = t16;
  ...
  const t22 = showErrors && Boolean(errors.path);
  let t23;
  if ($[39] !== t22) {
    t23 = /* @__PURE__ */ jsx(Field, { name: "path", as: DebouncedTextField, label: "Path", required: true, error: t22 });
    $[39] = t22;
    $[40] = t23;
  } else {
    t23 = $[40];
  }
  const t24 = touched.path && Boolean(errors.path);
  const t25 = touched.path && Boolean(errors.path) ? errors.path : isSubcollection ? "Relative path to the parent (no need to include the parent path)" : "Path that this collection is stored in, in the database";
  let t26;
  if ($[41] !== t24 || $[42] !== t25) {
  ...
  let t27;
  if ($[44] !== t23 || $[45] !== t26) {
    t27 = /* @__PURE__ */ jsxs("div", { className: t21, children: [
      t23,
      t26
    ] });
    $[44] = t23;
  ...
  const t28 = showErrors && Boolean(errors.singularName);
  let t29;
  if ($[47] !== handleChange || $[48] !== setFieldTouched) {
    t29 = (e_0) => {
  ...
  const t30 = values.singularName ?? "";
  let t31;
  if ($[50] !== t28 || $[51] !== t29 || $[52] !== t30) {
    t31 = /* @__PURE__ */ jsx(TextField, { error: t28, name: "singularName", "aria-describedby": "singularName-helper", onChange: t29, value: t30, label: "Singular name" });
    $[50] = t28;
    $[51] = t29;
    $[52] = t30;
    $[53] = t31;
  ...
  const t33 = showErrors && Boolean(errors.singularName) ? errors.singularName : "Optionally define a singular name for your entities";
  let t34;
  if ($[54] !== t32 || $[55] !== t33) {
    t34 = /* @__PURE__ */ jsx(FieldCaption, { error: t32, children: t33 });
    $[54] = t32;
    $[55] = t33;
    $[56] = t34;
  } else {
  ...
  let t35;
  if ($[57] !== t31 || $[58] !== t34) {
    t35 = /* @__PURE__ */ jsxs("div", { className: "col-span-12", children: [
      t31,
      t34
    ] });
    $[57] = t31;
  ...
  const t36 = showErrors && Boolean(errors.description);
  const t37 = values.description ?? "";
  let t38;
  if ($[60] !== handleChange || $[61] !== t36 || $[62] !== t37) {
    t38 = /* @__PURE__ */ jsx(TextField, { error: t36, name: "description", value: t37, onChange: handleChange, multiline: true, minRows: 2, "aria-describedby": "description-helper-text", label: "Description" });
    $[60] = handleChange;
    $[61] = t36;
    $[62] = t37;
    $[63] = t38;
  ...
  const t40 = showErrors && Boolean(errors.description) ? errors.description : "Description of the collection, you can use markdown";
  let t41;
  if ($[64] !== t39 || $[65] !== t40) {
    t41 = /* @__PURE__ */ jsx(FieldCaption, { error: t39, children: t40 });
    $[64] = t39;
    $[65] = t40;
    $[66] = t41;
  } else {
  ...
  let t42;
  if ($[67] !== t38 || $[68] !== t41) {
    t42 = /* @__PURE__ */ jsxs("div", { className: "col-span-12", children: [
      t38,
      t41
    ] });
    $[67] = t38;
  ...
  const t43 = !isNewCollection;
  const t44 = showErrors && Boolean(errors.id);
  let t45;
  if ($[70] !== t43 || $[71] !== t44) {
    t45 = /* @__PURE__ */ jsx(Field, { name: "id", as: DebouncedTextField, disabled: t43, label: "Collection ID", error: t44 });
    $[70] = t43;
    $[71] = t44;
    $[72] = t45;
  } else {
  ...
  const t46 = touched.id && Boolean(errors.id);
  const t47 = touched.id && Boolean(errors.id) ? errors.id : "This ID identifies this collection. Typically the same as the path.";
  let t48;
  if ($[73] !== t46 || $[74] !== t47) {
    t48 = /* @__PURE__ */ jsx(FieldCaption, { error: t46, children: t47 });
    $[73] = t46;
    $[74] = t47;
    $[75] = t48;
  } else {
  ...
  let t49;
  if ($[76] !== t45 || $[77] !== t48) {
    t49 = /* @__PURE__ */ jsxs("div", { className: "col-span-12", children: [
      t45,
      t48
    ] });
    $[76] = t45;
  ...
  let t50;
  if ($[79] !== setFieldValue) {
    t50 = (v) => setFieldValue("collectionGroup", v);
    $[79] = setFieldValue;
    $[80] = t50;
  } else {
    t50 = $[80];
  }
  const t51 = values.collectionGroup ?? false;
  let t52;
  if ($[81] !== t50 || $[82] !== t51) {
    t52 = /* @__PURE__ */ jsx(BooleanSwitchWithLabel, { position: "start", size: "large", label: "Collection group", onValueChange: t50, value: t51 });
    $[81] = t50;
    $[82] = t51;
    $[83] = t52;
  } else {
  ...
  if ($[84] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t53 = /* @__PURE__ */ jsx(FieldCaption, { children: "A collection group consists of all collections with the same path. This allows you to query over multiple collections at once." });
    $[84] = t53;
  } else {
    t53 = $[84];
  }
  ...
  let t55;
  if ($[87] !== t20 || $[88] !== t27 || $[89] !== t35 || $[90] !== t42 || $[91] !== t49 || $[92] !== t54) {
  ...
  if ($[94] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t56 = /* @__PURE__ */ jsx(Typography, { variant: "subtitle2", children: "Advanced settings" });
    $[94] = t56;
  } else {
    t56 = $[94];
  }
...
function DefaultDatabaseField(t0) {
  ...
  let t3;
  if ($[2] !== t1 || $[3] !== t2) {
    t3 = /* @__PURE__ */ jsx(Tooltip, { title: "Database ID", side: "top", align: "start", children: /* @__PURE__ */ jsx(TextField, { size: "small", invisible: true, inputClassName: "text-end", value: t1, onChange: t2, placeholder: "(default)" }) });
    $[2] = t1;
    $[3] = t2;
    $[4] = t3;
  } else {
...
function EnumForm(t0) {
  ...
  let t4;
  if ($[7] !== onValuesChanged || $[8] !== values_0.enumValues) {
    t4 = () => {
      if (onValuesChanged) {
    ...
    $[7] = onValuesChanged;
    $[8] = values_0.enumValues;
    $[9] = t4;
  } else {
    t4 = $[9];
  }
  let t5;
  if ($[10] !== values_0.enumValues) {
    t5 = [values_0.enumValues];
    $[10] = values_0.enumValues;
    $[11] = t5;
  } else {
    t5 = $[11];
  }
  useEffect(t4, t5);
  let t6;
  if ($[12] !== allowDataInference || $[13] !== disabled || $[14] !== errors_0 || $[15] !== getData || $[16] !== updateIds || $[17] !== values_0) {
    t6 = /* @__PURE__ */ jsx(EnumFormFields, { enumValuesPath: "enumValues", values: values_0, errors: errors_0, shouldUpdateId: updateIds, disabled, allowDataInference, getData });
    $[12] = allowDataInference;
    $[13] = disabled;
    $[14] = errors_0;
    $[15] = getData;
    $[16] = updateIds;
  ...
  let t7;
  if ($[19] !== formex || $[20] !== t6) {
    t7 = /* @__PURE__ */ jsx(Formex, { value: formex, children: t6 });
    $[19] = formex;
    $[20] = t6;
    $[21] = t7;
  } else {
...
function EnumFormFields(t0) {
  ...
  let t2;
  if ($[1] !== disabled || $[2] !== enumValuesPath || $[3] !== errors?.enumValues || $[4] !== lastInternalIdAdded || $[5] !== shouldUpdateId || $[6] !== values.enumValues) {
    t2 = (t32) => {
      const {
        index,
        internalId
      ...
      return /* @__PURE__ */ jsx(EnumEntry, { index, disabled, enumValuesPath, autoFocus: justAdded, entryError, shouldUpdateId: shouldUpdateId || justAdded, onDialogOpen: () => setEditDialogIndex(index), inferredEntry: inferredValues.has(values.enumValues[index]?.id) }, `${internalId}`);
    };
    $[1] = disabled;
    $[2] = enumValuesPath;
    $[3] = errors?.enumValues;
    $[4] = lastInternalIdAdded;
    $[5] = shouldUpdateId;
    $[6] = values.enumValues;
    $[7] = t2;
  } else {
  ...
  const buildEntry = t2;
  let t3;
  if ($[8] !== enumValuesPath || $[9] !== getData || $[10] !== setFieldValue || $[11] !== values.enumValues) {
    t3 = async () => {
      if (!getData) {
      ...
      getData?.().then((data) => {
        ...
        const newEnumValues = foundEnumValues.filter((enumValue) => !currentEnumValues?.some((v) => v.id === enumValue.id));
      ...
      }).catch(_temp$f).finally(() => setInferring(false));
    };
    $[8] = enumValuesPath;
    $[9] = getData;
    $[10] = setFieldValue;
    $[11] = values.enumValues;
    $[12] = t3;
  } else {
    t3 = $[12];
  }
  ...
  if ($[15] !== allowDataInference || $[16] !== disabled || $[17] !== inferValues || $[18] !== inferring) {
    t6 = allowDataInference && /* @__PURE__ */ jsxs(Button, { disabled: disabled || inferring, variant: "text", size: "small", onClick: inferValues, children: [
      inferring ? /* @__PURE__ */ jsx(CircularProgress, { size: "smallest" }) : /* @__PURE__ */ jsx(FindInPageIcon, {}),
  ...
  let t7;
  if ($[20] !== t6) {
    t7 = /* @__PURE__ */ jsxs("div", { className: "ml-3.5 flex flex-row items-center", children: [
      t4,
      t5,
      t6
    ] });
  ...
  let t8;
  if ($[22] !== enumValuesPath || $[23] !== setFieldValue) {
  ...
  let t13;
  if ($[33] !== editDialogIndex || $[34] !== enumValuesPath || $[35] !== t11) {
    t13 = /* @__PURE__ */ jsx(EnumEntryDialog, { index: editDialogIndex, open: t11, enumValuesPath, onClose: t12 });
    $[33] = editDialogIndex;
    $[34] = enumValuesPath;
    $[35] = t11;
    $[36] = t13;
  ...
  let t14;
  if ($[37] !== t10 || $[38] !== t13) {
    t14 = /* @__PURE__ */ jsxs(Paper, { className: "p-4 m-1", children: [
      t10,
      t13
    ] });
    $[37] = t10;
  ...
  let t15;
  if ($[40] !== t14 || $[41] !== t7) {
    t15 = /* @__PURE__ */ jsxs("div", { className: "col-span-12", children: [
      t7,
      t14
    ] });
    $[40] = t14;
...
const EnumEntry = React__default.memo(function EnumEntryInternal(t0) {
  ...
  const shouldUpdateIdRef = React__default.useRef(!getIn(values, `${enumValuesPath}[${index}].id`));
  const shouldUpdateId = updateId || shouldUpdateIdRef.current;
  const t1 = `${enumValuesPath}[${index}].id`;
  let t2;
  if ($[0] !== t1 || $[1] !== values) {
    t2 = getIn(values, t1);
    $[0] = t1;
  ...
  const idValue = t2;
  const t3 = `${enumValuesPath}[${index}].label`;
  let t4;
  if ($[3] !== t3 || $[4] !== values) {
    t4 = getIn(values, t3);
    $[3] = t3;
  ...
  let t5;
  if ($[6] !== enumValuesPath || $[7] !== idValue || $[8] !== index || $[9] !== labelValue || $[10] !== setFieldValue || $[11] !== shouldUpdateId) {
    t5 = () => {
  ...
  const t7 = `${enumValuesPath}[${index}].color`;
  let colorValue;
  let t8;
  if ($[15] !== idValue || $[16] !== t7 || $[17] !== values) {
    colorValue = getIn(values, t7);
    t8 = colorValue ? getColorSchemeForKey(colorValue) : idValue ? getColorSchemeForSeed(String(idValue)) : void 0;
    $[15] = idValue;
    $[16] = t7;
    $[17] = values;
    $[18] = colorValue;
  ...
  const colorScheme = t8;
  const t9 = `${enumValuesPath}[${index}].label`;
  let t10;
  if ($[20] !== inferredEntry) {
    t10 = inferredEntry && /* @__PURE__ */ jsx(FindInPageIcon, { size: "small" });
    $[20] = inferredEntry;
    $[21] = t10;
  } else {
    t10 = $[21];
  }
  const t11 = Boolean(entryError?.label);
  let t12;
  if ($[22] !== autoFocus || $[23] !== disabled || $[24] !== t10 || $[25] !== t11 || $[26] !== t9) {
    t12 = /* @__PURE__ */ jsx(Field, { name: t9, as: DebouncedTextField, className: "flex-grow", required: true, disabled, size: "small", autoFocus, autoComplete: "off", endAdornment: t10, error: t11 });
    $[22] = autoFocus;
    $[23] = disabled;
    $[24] = t10;
    $[25] = t11;
  ...
  let t13;
  if ($[28] !== colorScheme?.color || $[29] !== colorValue || $[30] !== disabled || $[31] !== entryError?.id || $[32] !== onDialogOpen) {
    t13 = !disabled && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("button", { type: "button", onClick: () => onDialogOpen(), className: "w-5 h-5 rounded-full flex-shrink-0 self-center border border-surface-accent-200 dark:border-surface-accent-700 hover:scale-110 transition-transform cursor-pointer ml-3", style: {
        backgroundColor: colorScheme?.color ?? "#ccc"
      }, title: colorValue ? `Color: ${colorValue}` : "Auto color - Click to change", "aria-label": "Edit enum color" }),
      /* @__PURE__ */ jsx(Badge, { color: "error", invisible: !entryError?.id, children: /* @__PURE__ */ jsx(IconButton, { size: "small", "aria-label": "edit", className: "m-1", onClick: () => onDialogOpen(), children: /* @__PURE__ */ jsx(SettingsIcon, { size: "small" }) }) })
    ] });
    $[28] = colorScheme?.color;
    $[29] = colorValue;
    $[30] = disabled;
    $[31] = entryError?.id;
    $[32] = onDialogOpen;
  ...
  let t14;
  if ($[34] !== t12 || $[35] !== t13) {
    t14 = /* @__PURE__ */ jsxs("div", { className: "flex w-full align-center justify-center", children: [
      t12,
      t13
    ] });
    $[34] = t12;
  ...
  let t15;
  if ($[37] !== entryError?.label) {
    t15 = entryError?.label && /* @__PURE__ */ jsx(Typography, { variant: "caption", className: "ml-3.5 text-red-500 dark:text-red-500", children: entryError?.label });
    $[37] = entryError?.label;
    $[38] = t15;
  } else {
    t15 = $[38];
  ...
  let t16;
  if ($[39] !== entryError?.id) {
    t16 = entryError?.id && /* @__PURE__ */ jsx(Typography, { variant: "caption", className: "ml-3.5 text-red-500 dark:text-red-500", children: entryError?.id });
    $[39] = entryError?.id;
    $[40] = t16;
  } else {
    t16 = $[40];
  ...
  if ($[41] !== t14 || $[42] !== t15 || $[43] !== t16) {
    t17 = /* @__PURE__ */ jsxs(Fragment, { children: [
      t14,
      t15,
      t16
    ] });
...
function EnumEntryDialog(t0) {
  ...
  let t1;
  if ($[0] !== enumValuesPath || $[1] !== errors || $[2] !== index) {
    t1 = index !== void 0 ? getIn(errors, `${enumValuesPath}[${index}].id`) : void 0;
    $[0] = enumValuesPath;
    $[1] = errors;
    $[2] = index;
    $[3] = t1;
  ...
  const idError = t1;
  let t2;
  if ($[4] !== enumValuesPath || $[5] !== index || $[6] !== values) {
    t2 = index !== void 0 ? getIn(values, `${enumValuesPath}[${index}].color`) : void 0;
    $[4] = enumValuesPath;
    $[5] = index;
    $[6] = values;
    $[7] = t2;
  ...
  let t3;
  if ($[8] !== onClose) {
    t3 = (open_0) => !open_0 ? onClose() : void 0;
    $[8] = onClose;
    $[9] = t3;
  } else {
    t3 = $[9];
  ...
  if ($[10] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t4 = /* @__PURE__ */ jsx(DialogTitle, { hidden: true, children: "Enum form dialog" });
    $[10] = t4;
  } else {
    t4 = $[10];
  }
  let t5;
  if ($[11] !== colorValue || $[12] !== enumValuesPath || $[13] !== idError || $[14] !== index || $[15] !== setFieldValue) {
    t5 = index !== void 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Field, { name: `${enumValuesPath}[${index}].id`, as: DebouncedTextField, required: true, label: "ID", size: "small", autoComplete: "off", error: Boolean(idError) }),
        /* @__PURE__ */ jsx(FieldCaption, { error: Boolean(idError), children: idError ?? "Value saved in the data source" })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Typography, { variant: "body2", className: "font-medium mb-2", children: "Chip color" }),
        /* @__PURE__ */ jsx(ColorPicker, { value: colorValue, onChange: (color) => setFieldValue(`${enumValuesPath}[${index}].color`, color), size: "small", allowClear: true })
      ] })
    ] });
    $[11] = colorValue;
    $[12] = enumValuesPath;
  ...
  let t6;
  if ($[17] !== t5) {
    t6 = /* @__PURE__ */ jsx(DialogContent, { children: t5 });
    $[17] = t5;
    $[18] = t6;
  } else {
    t6 = $[18];
  ...
  let t7;
  if ($[19] !== onClose) {
    t7 = /* @__PURE__ */ jsx(DialogActions, { children: /* @__PURE__ */ jsx(Button, { autoFocus: true, onClick: onClose, children: "Ok" }) });
    $[19] = onClose;
    $[20] = t7;
  } else {
    t7 = $[20];
  ...
  let t8;
  if ($[21] !== open || $[22] !== t3 || $[23] !== t6 || $[24] !== t7) {
    t8 = /* @__PURE__ */ jsxs(Dialog, { maxWidth: "md", "aria-labelledby": "enum-edit-dialog", open, onOpenChange: t3, children: [
      t4,
      t6,
      t7
    ] });
...
function SwitchControl(t0) {
  ...
  let t3;
  if ($[3] !== allowIndeterminate || $[4] !== disabled || $[5] !== field.value || $[6] !== label || $[7] !== size || $[8] !== t2) {
    t3 = /* @__PURE__ */ jsx(BooleanSwitchWithLabel, { label, size, position: "start", value: field.value, disabled, allowIndeterminate, onValueChange: t2 });
    $[3] = allowIndeterminate;
    $[4] = disabled;
    $[5] = field.value;
    $[6] = label;
    $[7] = size;
  ...
  if (tooltip) {
    let t4;
    if ($[10] !== formControlLabel || $[11] !== tooltip) {
      t4 = /* @__PURE__ */ jsx(Tooltip, { title: tooltip, children: formControlLabel });
      $[10] = formControlLabel;
      $[11] = tooltip;
      $[12] = t4;
    } else {
...
function GeneralPropertyValidation(t0) {
  ...
  let t1;
  if ($[0] !== disabled) {
    t1 = /* @__PURE__ */ jsx("div", { className: "col-span-6", children: /* @__PURE__ */ jsx(Field, { name: "validation.required", type: "checkbox", children: (t22) => {
      const {
        field,
        form
      } = t22;
      return /* @__PURE__ */ jsx(SwitchControl, { disabled, label: "Required", tooltip: "You won't be able to save this entity if this value is not set", form, field });
    } }) });
    $[0] = disabled;
    $[1] = t1;
  } else {
  ...
  let t2;
  if ($[2] !== disabled) {
    t2 = /* @__PURE__ */ jsx("div", { className: "col-span-6", children: /* @__PURE__ */ jsx(Field, { name: "validation.unique", type: "checkbox", children: (t32) => {
      const {
        field: field_0,
        form: form_0
      } = t32;
      return /* @__PURE__ */ jsx(SwitchControl, { disabled, label: "Unique", tooltip: "There cannot be multiple entities with the same value", form: form_0, field: field_0 });
    } }) });
    $[2] = disabled;
    $[3] = t2;
  } else {
  ...
  let t3;
  if ($[4] !== disabled || $[5] !== handleChange || $[6] !== values) {
    t3 = getIn(values, "validation.required") && /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(DebouncedTextField, { disabled, value: getIn(values, "validation.requiredMessage"), label: "Required message", name: "validation.requiredMessage", size: "small", onChange: handleChange }) });
    $[4] = disabled;
    $[5] = handleChange;
    $[6] = values;
    $[7] = t3;
...
function StringPropertyValidation(t0) {
  ...
  if ($[2] !== values) {
    ...
    t2 = typeof matchesValue === "string" ? matchesValue : serializeRegExp(matchesValue);
    $[2] = values;
    $[3] = t2;
  } else {
    t2 = $[3];
  ...
  let t3;
  if ($[4] !== disabled) {
    t3 = /* @__PURE__ */ jsx(GeneralPropertyValidation, { disabled });
    $[4] = disabled;
    $[5] = t3;
  } else {
    t3 = $[5];
  ...
  let t4;
  if ($[6] !== disabled || $[7] !== lowercase) {
    t4 = lowercase && /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsx(Field, { name: "validation.lowercase", type: "checkbox", children: (t52) => {
      const {
        field,
        form
      } = t52;
      return /* @__PURE__ */ jsx(SwitchControl, { label: "Lowercase", disabled, form, field });
    } }) });
    $[6] = disabled;
    $[7] = lowercase;
    $[8] = t4;
  ...
  let t5;
  if ($[9] !== disabled || $[10] !== uppercase) {
    t5 = uppercase && /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsx(Field, { name: "validation.uppercase", type: "checkbox", children: (t62) => {
      const {
        field: field_0,
        form: form_0
      } = t62;
      return /* @__PURE__ */ jsx(SwitchControl, { label: "Uppercase", disabled, form: form_0, field: field_0 });
    } }) });
    $[9] = disabled;
    $[10] = uppercase;
    $[11] = t5;
  ...
  let t6;
  if ($[12] !== disabled || $[13] !== trim) {
    t6 = trim && /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsx(Field, { name: "validation.trim", type: "checkbox", children: (t72) => {
      const {
        field: field_1,
        form: form_1
      } = t72;
      return /* @__PURE__ */ jsx(SwitchControl, { label: "Trim", disabled, form: form_1, field: field_1 });
    } }) });
    $[12] = disabled;
    $[13] = trim;
    $[14] = t6;
  ...
  if ($[15] !== t4 || $[16] !== t5 || $[17] !== t6) {
    t7 = /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-2 col-span-12", children: [
      t4,
      t5,
      t6
    ] });
  ...
  let t8;
  if ($[19] !== disabled || $[20] !== handleChange || $[21] !== length || $[22] !== values) {
    t8 = length && /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsx(DebouncedTextField, { value: getIn(values, "validation.length"), label: "Exact length", name: "validation.length", type: "number", size: "small", disabled, onChange: handleChange }) });
    $[19] = disabled;
    $[20] = handleChange;
    $[21] = length;
    $[22] = values;
  ...
  let t9;
  if ($[24] !== disabled || $[25] !== handleChange || $[26] !== min || $[27] !== values) {
    t9 = min && /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsx(DebouncedTextField, { value: getIn(values, "validation.min"), label: "Min length", name: "validation.min", type: "number", size: "small", disabled, onChange: handleChange }) });
    $[24] = disabled;
    $[25] = handleChange;
    $[26] = min;
    $[27] = values;
  ...
  let t10;
  if ($[29] !== disabled || $[30] !== handleChange || $[31] !== max || $[32] !== values) {
    t10 = max && /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsx(DebouncedTextField, { value: getIn(values, "validation.max"), label: "Max length", name: "validation.max", type: "number", size: "small", disabled, onChange: handleChange }) });
    $[29] = disabled;
    $[30] = handleChange;
    $[31] = max;
    $[32] = values;
  ...
  let t11;
  if ($[34] !== t10 || $[35] !== t8 || $[36] !== t9) {
    t11 = /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-2 col-span-12", children: [
      t8,
      t9,
      t10
    ] });
  ...
  let t12;
  if ($[38] !== disabled || $[39] !== matches || $[40] !== matchesError || $[41] !== matchesStringValue) {
    t12 = matches && /* @__PURE__ */ jsxs("div", { className: "col-span-12", children: [
      /* @__PURE__ */ jsx(Field, { name: "validation.matches", as: DebouncedTextField, label: "Matches regex", size: "small", disabled, value: matchesStringValue, error: Boolean(matchesError) }),
      /* @__PURE__ */ jsx(FieldCaption, { error: Boolean(matchesError), children: matchesError ? "Not a valid regexp" : "e.g. /^\\d+$/ for digits only" })
    ] });
    $[38] = disabled;
    $[39] = matches;
    $[40] = matchesError;
    $[41] = matchesStringValue;
    $[42] = t12;
  } else {
    t12 = $[42];
  }
  let t13;
  if ($[43] !== t11 || $[44] !== t12 || $[45] !== t3 || $[46] !== t7) {
    t13 = /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-2", children: [
      t3,
      t7,
      t11,
      t12
...
function ArrayPropertyValidation(t0) {
  ...
  let t4;
  if ($[2] !== disabled || $[3] !== handleChange || $[4] !== min || $[5] !== values) {
    t4 = min && /* @__PURE__ */ jsx("div", { className: "col-span-6", children: /* @__PURE__ */ jsx(DebouncedTextField, { value: getIn(values, "validation.min"), disabled, label: "Min length", name: "validation.min", type: "number", size: "small", onChange: handleChange }) });
    $[2] = disabled;
    $[3] = handleChange;
    $[4] = min;
    $[5] = values;
  ...
  let t5;
  if ($[7] !== disabled || $[8] !== handleChange || $[9] !== max || $[10] !== values) {
    t5 = max && /* @__PURE__ */ jsx("div", { className: "col-span-6", children: /* @__PURE__ */ jsx(DebouncedTextField, { value: getIn(values, "validation.max"), disabled, label: "Max length", name: "validation.max", type: "number", size: "small", onChange: handleChange }) });
    $[7] = disabled;
    $[8] = handleChange;
    $[9] = max;
    $[10] = values;
  ...
  if ($[12] !== t3 || $[13] !== t4 || $[14] !== t5) {
    t6 = /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-2", children: [
      t3,
      t4,
      t5
    ] });
...
function ValidationPanel(t0) {
  ...
  let t2;
  if ($[1] !== children) {
    t2 = /* @__PURE__ */ jsx(ExpandablePanel, { initiallyExpanded: false, asField: true, innerClassName: "p-4", title: t1, children });
    $[1] = children;
    $[2] = t2;
  } else {
    t2 = $[2];
...
function EnumPropertyField({
  ...
  const onValuesChanged = (value) => {
    ...
    if (!multiselect) {
      const enumIds = value.filter((v) => Boolean(v?.id)).map((v_0) => v_0.id);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(EnumForm, { enumValues, updateIds, disabled, allowDataInference, onError: (hasError) => {
      setFieldError(enumValuesPath, hasError ? "This enum property is missing some values" : void 0);
    }, getData: getData && fullPropertyPath ? () => getData().then((res) => res.map((entry) => getIn(entry, fullPropertyPath)).filter(Boolean)) : void 0, onValuesChanged }) }),
    /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsxs(ValidationPanel, { children: [
      !multiselect && /* @__PURE__ */ jsx(StringPropertyValidation, { disabled, showErrors }),
    ...
    }, size: "large", label: "Default value", value: defaultValue ?? "", children: enumValues.filter((enumValue) => Boolean(enumValue?.id)).map((enumValue_0) => /* @__PURE__ */ jsx(SelectItem, { value: enumValue_0.id?.toString(), children: enumValue_0.label }, enumValue_0.id)) }) })
  ] });
}
const fileTypes = {
  "image/*": "Images",
...
function StoragePropertyField(t0) {
  ...
  if ($[6] !== acceptedFiles || $[7] !== disabled || $[8] !== existing || $[9] !== fileName || $[10] !== fileNameValue || $[11] !== imageResizeFormat || $[12] !== imageResizeMaxHeight || $[13] !== imageResizeMaxWidth || $[14] !== imageResizeMode || $[15] !== imageResizeQuality || $[16] !== includeBucketUrl || $[17] !== maxSize || $[18] !== setFieldValue || $[19] !== storagePath || $[20] !== storagePathValue || $[21] !== storeUrl || $[22] !== values) {
    ...
    if ($[62] !== acceptedFiles || $[63] !== disabled || $[64] !== handleTypesChange || $[65] !== t262 || $[66] !== t272 || $[67] !== t282) {
      t11 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(MultiSelect, { className: "w-full", placeholder: "All file types allowed", disabled, name: acceptedFiles, value: t262, onValueChange: handleTypesChange, label: t272, renderValues: _temp3$8, children: t282 }) });
      $[62] = acceptedFiles;
      $[63] = disabled;
    ...
    if ($[125] !== disabled || $[126] !== imageResizeMode || $[127] !== t47 || $[128] !== t48) {
      t18 = /* @__PURE__ */ jsx("div", { className: "col-span-6", children: /* @__PURE__ */ jsxs(Select, { disabled, name: imageResizeMode, fullWidth: true, size: "medium", value: t47, onValueChange: t48, label: "Resize mode", renderValue: _temp4$5, children: [
        t49,
        t50
      ] }) });
      $[125] = disabled;
    ...
    if ($[137] !== disabled || $[138] !== imageResizeFormat || $[139] !== t51 || $[140] !== t52) {
      t19 = /* @__PURE__ */ jsx("div", { className: "col-span-6", children: /* @__PURE__ */ jsxs(Select, { disabled, size: "medium", fullWidth: true, name: imageResizeFormat, value: t51, onValueChange: t52, label: "Output format", renderValue: _temp5$2, children: [
        t53,
        t54,
        t55,
        t56
...
function removeNonEditableProperties(properties) {
  return Object.entries(properties).filter(([_, property]) => editableProperty(property)).map(([key, propertyOrBuilder]) => {
...
function PropertyFieldPreview(t0) {
  ...
  if ($[0] !== property || $[1] !== propertyConfigs) {
    t1 = getFieldConfig(property, propertyConfigs);
    $[0] = property;
    $[1] = propertyConfigs;
    $[2] = t1;
  } else {
  ...
  const t3 = onClick ? cardClickableMixin : "";
  ...
  let t9;
  if ($[12] !== t7 || $[13] !== t8) {
    t9 = /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsx(Typography, { className: "flex-grow pr-2", variant: t7, component: "span", color: "secondary", children: t8 }) });
    $[12] = t7;
    $[13] = t8;
    $[14] = t9;
  } else {
  ...
  let t10;
  if ($[15] !== property.dataType) {
    t10 = /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsx(Typography, { variant: "body2", component: "span", color: "disabled", children: property.dataType }) });
  ...
  let t11;
  if ($[17] !== t10 || $[18] !== t9) {
    t11 = /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center", children: [
      t9,
      t10
    ] });
    $[17] = t10;
  ...
  let t12;
  if ($[20] !== t11 || $[21] !== t6) {
    t12 = /* @__PURE__ */ jsxs("div", { className: "w-full flex flex-col", children: [
      t6,
      t11
    ] });
    $[20] = t11;
  ...
  let t15;
  if ($[29] !== onClick || $[30] !== t14 || $[31] !== t2) {
    t15 = /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxs("div", { onClick, className: "flex flex-row w-full cursor-pointer", children: [
      t2,
      t14
    ] }) });
    $[29] = onClick;
...
function NonEditablePropertyPreview(t0) {
  ...
  let t1;
  if ($[0] !== property || $[1] !== propertyConfigs) {
    t1 = !isPropertyBuilder(property) && property ? getFieldConfig(property, propertyConfigs) : void 0;
    $[0] = property;
    $[1] = propertyConfigs;
    $[2] = t1;
  } else {
  ...
  let t2;
  if ($[3] !== propertyConfig) {
    t2 = propertyConfig && /* @__PURE__ */ jsx(PropertyConfigBadge, { propertyConfig });
    $[3] = propertyConfig;
    $[4] = t2;
  } else {
    t2 = $[4];
  ...
  let t5;
  if ($[8] !== t2 || $[9] !== t3) {
    t5 = /* @__PURE__ */ jsxs("div", { className: "relative m-4", children: [
      t2,
      t3,
      t4
    ] });
  ...
  const t6 = onClick ? cardClickableMixin : "";
  const t7 = selected ? cardSelectedMixin : "";
  const t8 = selected ? "border-primary" : "border-transparent";
  let t9;
  if ($[11] !== t6 || $[12] !== t7 || $[13] !== t8) {
    t9 = cls("pl-2 w-full flex flex-row gap-4 items-center", cardMixin, t6, t7, "flex-grow p-4 border transition-colors duration-200", t8);
    $[11] = t6;
    $[12] = t7;
    $[13] = t8;
    $[14] = t9;
  ...
  let t12;
  if ($[17] !== propertyConfig) {
    t12 = propertyConfig && /* @__PURE__ */ jsx(Typography, { className: "flex-grow pr-2", variant: "body2", component: "span", color: "secondary", children: propertyConfig?.name });
    $[17] = propertyConfig;
    $[18] = t12;
  } else {
    t12 = $[18];
  ...
  let t13;
  if ($[19] !== property) {
    t13 = property && !isPropertyBuilder(property) && /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsx(Typography, { variant: "body2", component: "span", color: "disabled", children: property.dataType }) });
    $[19] = property;
    $[20] = t13;
  } else {
    t13 = $[20];
  ...
  let t14;
  if ($[21] !== property) {
    t14 = property && isPropertyBuilder(property) && /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsx(Typography, { variant: "body2", component: "span", color: "disabled", children: "This property is defined as a property builder in code" }) });
    $[21] = property;
    $[22] = t14;
  } else {
    t14 = $[22];
  ...
  let t15;
  if ($[23] !== property) {
    t15 = !property && /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsx(Typography, { variant: "body2", component: "span", color: "disabled", children: "This field is defined as an additional field in code" }) });
    $[23] = property;
    $[24] = t15;
  } else {
    t15 = $[24];
  ...
  let t16;
  if ($[25] !== t12 || $[26] !== t13 || $[27] !== t14 || $[28] !== t15) {
    t16 = /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center", children: [
      t12,
      t13,
      t14,
      t15
  ...
  let t17;
  if ($[30] !== t11 || $[31] !== t16) {
    t17 = /* @__PURE__ */ jsxs("div", { className: "w-full flex flex-col", children: [
      t11,
      t16
    ] });
    $[30] = t11;
  ...
  let t18;
  if ($[33] !== t17 || $[34] !== t9) {
    t18 = /* @__PURE__ */ jsx(Paper, { className: t9, children: t17 });
    $[33] = t17;
    $[34] = t9;
    $[35] = t18;
  } else {
  ...
  let t19;
  if ($[36] !== onClick || $[37] !== t18 || $[38] !== t5) {
    t19 = /* @__PURE__ */ jsxs("div", { onClick, className: "flex flex-row w-full cursor-pointer", children: [
      t5,
      t18
    ] });
    $[36] = onClick;
...
const AIModifiedPathsContext = createContext(null);
function AIModifiedPathsProvider(t0) {
  const $ = c(13);
  const {
    children
  } = t0;
  ...
  const [modifiedPaths, setModifiedPaths] = useState(t1);
  ...
  if ($[1] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t2 = (operations) => {
      ...
      setGenerationCounter(_temp$d);
    };
    $[1] = t2;
  } else {
    t2 = $[1];
  }
  const addModifiedPaths = t2;
  let t3;
  if ($[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t3 = (path) => {
      setModifiedPaths((prev_1) => {
        const newSet_0 = new Set(prev_1);
        for (const p of newSet_0) {
  ...
  const clearAllPaths = t4;
  let t5;
  if ($[4] !== modifiedPaths) {
    t5 = (path_0) => {
      if (modifiedPaths.has(path_0)) {
        return true;
      }
      for (const p_0 of modifiedPaths) {
        if (p_0.startsWith(path_0 + ".")) {
          return true;
        }
      }
      return false;
  ...
  const isPathModified = t5;
  let t6;
  if ($[6] !== generationCounter || $[7] !== isPathModified || $[8] !== modifiedPaths) {
    t6 = {
      modifiedPaths,
      generationCounter,
      addModifiedPaths,
  ...
  if ($[10] !== children || $[11] !== t6) {
    t7 = /* @__PURE__ */ jsx(AIModifiedPathsContext.Provider, { value: t6, children });
    $[10] = children;
    $[11] = t6;
    $[12] = t7;
  } else {
...
const PropertyTree = React__default.memo(function PropertyTree2(t0) {
  ...
  let t1;
  if ($[0] !== properties) {
    t1 = (key) => !key.includes(".") && properties[key];
    $[0] = properties;
    $[1] = t1;
  } else {
    t1 = $[1];
  }
  const filteredOrder = (propertiesOrderProp ?? propertyKeys).filter(t1);
  const missingKeys = propertyKeys.filter((key_0) => !filteredOrder.includes(key_0));
  ...
  const items = propertiesOrder.map((key_1) => getFullId(key_1, namespace));
  const T0 = DndContext;
  const t4 = closestCenter;
  let t5;
  if ($[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t5 = [restrictToVerticalAxis];
    $[4] = t5;
  } else {
    t5 = $[4];
  }
  const T1 = SortableContext;
  const t6 = verticalListSortingStrategy;
  const t7 = propertiesOrder && propertiesOrder.map((propertyKey, index) => {
    ...
    return /* @__PURE__ */ jsx(PropertyTreeEntry, { id, propertyKey, propertyOrBuilder: property, additionalField, errors, namespace, propertiesOrder, inferredPropertyKeys, onPropertyMove, onPropertyRemove, onPropertyClick, selectedPropertyKey, collectionEditable }, id);
  }).filter(Boolean);
  let t8;
  if ($[5] !== className || $[6] !== t7) {
  ...
  let t9;
  if ($[8] !== T1 || $[9] !== items || $[10] !== t6 || $[11] !== t8) {
    t9 = /* @__PURE__ */ jsx(T1, { items, strategy: t6, children: t8 });
    $[8] = T1;
    $[9] = items;
    $[10] = t6;
    $[11] = t8;
  ...
  let t10;
  if ($[13] !== T0 || $[14] !== handleDragEnd || $[15] !== sensors || $[16] !== t4 || $[17] !== t5 || $[18] !== t9) {
    t10 = /* @__PURE__ */ jsx(T0, { sensors, collisionDetection: t4, onDragEnd: handleDragEnd, modifiers: t5, children: t9 });
    $[13] = T0;
    $[14] = handleDragEnd;
    $[15] = sensors;
    $[16] = t4;
...
function PropertyTreeEntry(t0) {
  ...
  if (typeof propertyOrBuilder === "object") {
    ...
    if (property.dataType === "map" && property.properties) {
      let t62;
      if ($[12] !== collectionEditable || $[13] !== errors || $[14] !== fullId || $[15] !== inferredPropertyKeys || $[16] !== onPropertyClick || $[17] !== onPropertyMove || $[18] !== onPropertyRemove || $[19] !== property.properties || $[20] !== property.propertiesOrder || $[21] !== selectedPropertyKey) {
        t62 = /* @__PURE__ */ jsx(PropertyTree, { selectedPropertyKey, namespace: fullId, properties: property.properties, propertiesOrder: property.propertiesOrder, errors, onPropertyClick, onPropertyMove, onPropertyRemove, inferredPropertyKeys, collectionEditable });
        $[12] = collectionEditable;
        $[13] = errors;
        $[14] = fullId;
        $[15] = inferredPropertyKeys;
        $[16] = onPropertyClick;
        $[17] = onPropertyMove;
        $[18] = onPropertyRemove;
        $[19] = property.properties;
        $[20] = property.propertiesOrder;
        $[21] = selectedPropertyKey;
        $[22] = t62;
      } else {
        t62 = $[22];
      }
  ...
  let t7;
  if ($[26] !== aiModifiedPaths || $[27] !== propertyKey) {
    t7 = aiModifiedPaths?.isPathModified(`properties.${propertyKey}`) ?? false;
    $[26] = aiModifiedPaths;
    $[27] = propertyKey;
    $[28] = t7;
  } else {
  ...
  const isAIModified = t7;
  let t8;
  if ($[29] !== subtree) {
    t8 = subtree && /* @__PURE__ */ jsx("div", { className: "absolute border-l " + defaultBorderMixin, style: {
      left: "32px",
      top: "64px",
      bottom: "16px"
    } });
  ...
  let t10;
  if ($[40] !== isAIModified) {
    t10 = isAIModified && /* @__PURE__ */ jsx(AIModifiedIndicator, {});
    $[40] = isAIModified;
    $[41] = t10;
  } else {
    t10 = $[41];
  ...
  let t11;
  if ($[42] !== isPropertyInferred || $[43] !== namespace || $[44] !== onPropertyRemove || $[45] !== propertyKey) {
    t11 = isPropertyInferred && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(Tooltip, { title: "Inferred property", asChild: true, children: /* @__PURE__ */ jsx(IconButton, { size: "smallest", disabled: true, children: /* @__PURE__ */ jsx(FindInPageIcon, { size: "smallest" }) }) }),
      onPropertyRemove && /* @__PURE__ */ jsx(Tooltip, { title: "Remove inferred property", asChild: true, children: /* @__PURE__ */ jsx(IconButton, { size: "smallest", color: "inherit", onClick: (e) => {
        e.stopPropagation();
        onPropertyRemove(propertyKey, namespace);
      }, children: /* @__PURE__ */ jsx(DeleteIcon, { size: "smallest" }) }) })
    ] });
    $[42] = isPropertyInferred;
    $[43] = namespace;
    $[44] = onPropertyRemove;
    $[45] = propertyKey;
    $[46] = t11;
  ...
  if ($[47] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t12 = /* @__PURE__ */ jsx(IconButton, { size: "smallest", children: /* @__PURE__ */ jsx(MoreVertIcon, { size: "smallest" }) });
    $[47] = t12;
  } else {
    t12 = $[47];
  }
  let t13;
  if ($[48] !== namespace || $[49] !== onPropertyMove || $[50] !== propertiesOrder || $[51] !== propertyKey) {
    t13 = () => {
  ...
  if ($[53] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t14 = /* @__PURE__ */ jsx(VerticalAlignTopIcon, { size: "smallest" });
    $[53] = t14;
  } else {
    t14 = $[53];
  }
  let t15;
  if ($[54] !== t13) {
    t15 = /* @__PURE__ */ jsxs(MenuItem, { dense: true, onClick: t13, children: [
      t14,
      "Move to top"
    ] });
    $[54] = t13;
  ...
  let t16;
  if ($[56] !== namespace || $[57] !== onPropertyMove || $[58] !== propertiesOrder || $[59] !== propertyKey) {
    t16 = () => {
      const currentIndex_0 = propertiesOrder.indexOf(propertyKey);
      if (currentIndex_0 < propertiesOrder.length - 1) {
        const newOrder_0 = propertiesOrder.filter((k_0) => k_0 !== propertyKey);
        newOrder_0.push(propertyKey);
        onPropertyMove?.(newOrder_0, namespace);
      }
    };
    $[56] = namespace;
    $[57] = onPropertyMove;
  ...
  if ($[61] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t17 = /* @__PURE__ */ jsx(VerticalAlignBottomIcon, { size: "smallest" });
    $[61] = t17;
  } else {
    t17 = $[61];
  }
  let t18;
  if ($[62] !== t16) {
    t18 = /* @__PURE__ */ jsxs(MenuItem, { dense: true, onClick: t16, children: [
      t17,
      "Move to bottom"
    ] });
    $[62] = t16;
  ...
  let t19;
  if ($[64] !== namespace || $[65] !== onPropertyRemove || $[66] !== propertyKey) {
    t19 = () => onPropertyRemove?.(propertyKey, namespace);
    $[64] = namespace;
    $[65] = onPropertyRemove;
    $[66] = propertyKey;
    $[67] = t19;
  ...
  if ($[68] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t20 = /* @__PURE__ */ jsx(DeleteIcon, { size: "smallest" });
    $[68] = t20;
  } else {
    t20 = $[68];
  }
  let t21;
  if ($[69] !== t19) {
    t21 = /* @__PURE__ */ jsxs(MenuItem, { dense: true, onClick: t19, children: [
      t20,
      "Delete"
    ] });
    $[69] = t19;
  ...
  let t22;
  if ($[71] !== t15 || $[72] !== t18 || $[73] !== t21) {
    t22 = /* @__PURE__ */ jsxs(Menu, { trigger: t12, children: [
      t15,
      t18,
      t21
    ] });
  ...
  let t23;
  if ($[75] !== t10 || $[76] !== t11 || $[77] !== t22) {
    t23 = /* @__PURE__ */ jsxs("div", { className: "absolute top-3 right-3 flex flex-row items-center gap-1", children: [
      t10,
      t11,
      t22
    ] });
  ...
  let t24;
  if ($[79] !== subtree) {
    t24 = subtree && /* @__PURE__ */ jsx("div", { className: "ml-16", children: subtree });
    $[79] = subtree;
    $[80] = t24;
  } else {
    t24 = $[80];
  ...
  let t25;
  if ($[81] !== t23 || $[82] !== t24 || $[83] !== t8 || $[84] !== t9) {
    t25 = /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      t8,
      t9,
      t23,
      t24
  ...
  let t26;
  if ($[86] !== attributes || $[87] !== listeners || $[88] !== setNodeRef || $[89] !== style || $[90] !== t25) {
    t26 = /* @__PURE__ */ jsx("div", { ref: setNodeRef, style, className: "relative -ml-8 cursor-grab", ...attributes, ...listeners, children: t25 });
    $[86] = attributes;
    $[87] = listeners;
    $[88] = setNodeRef;
    $[89] = style;
...
function MapPropertyField(t0) {
  ...
  let t1;
  if ($[0] !== values.properties || $[1] !== values.propertiesOrder) {
    t1 = values.propertiesOrder ?? Object.keys(values.properties ?? {});
    $[0] = values.properties;
    $[1] = values.propertiesOrder;
    $[2] = t1;
  } else {
    t1 = $[2];
  }
  ...
  let t4;
  if ($[10] !== selectedPropertyKey || $[11] !== selectedPropertyNamespace || $[12] !== values.properties) {
    ...
    $[10] = selectedPropertyKey;
    $[11] = selectedPropertyNamespace;
    $[12] = values.properties;
    $[13] = t4;
  } else {
    t4 = $[13];
  }
  ...
  let t10;
  if ($[19] !== t9) {
    t10 = /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-end my-4", children: [
      t6,
      /* @__PURE__ */ jsxs(Button, { onClick: t7, startIcon: t8, children: [
        "Add property to ",
        t9
      ] })
    ] });
  ...
  let t11;
  if ($[21] !== values.properties) {
    t11 = values.properties ?? {};
    $[21] = values.properties;
    $[22] = t11;
  } else {
    t11 = $[22];
  }
  ...
  let t14;
  if ($[25] !== collectionEditable || $[26] !== onPropertyMove || $[27] !== propertiesOrder || $[28] !== t11) {
    t14 = /* @__PURE__ */ jsx(PropertyTree, { properties: t11, propertiesOrder, errors: t12, collectionEditable, onPropertyClick: t13, onPropertyMove });
    $[25] = collectionEditable;
    $[26] = onPropertyMove;
    $[27] = propertiesOrder;
    $[28] = t11;
    $[29] = t14;
  ...
  let t15;
  if ($[30] !== empty) {
    t15 = empty && /* @__PURE__ */ jsx(Typography, { variant: "label", className: "h-full flex items-center justify-center p-4", children: "Add the first property to this group" });
    $[30] = empty;
    $[31] = t15;
  } else {
    t15 = $[31];
  ...
  let t16;
  if ($[32] !== t14 || $[33] !== t15) {
    t16 = /* @__PURE__ */ jsxs(Paper, { className: "p-2 pl-8", children: [
      t14,
      t15
    ] });
    $[32] = t14;
  ...
  let t18;
  if ($[38] !== setFieldValue) {
    t18 = (v) => setFieldValue("spreadChildren", v);
    $[38] = setFieldValue;
    $[39] = t18;
  } else {
    t18 = $[39];
  ...
  let t22;
  if ($[44] !== t20) {
    t22 = /* @__PURE__ */ jsxs("div", { className: "col-span-12", children: [
      t20,
      t21
    ] });
    $[44] = t20;
  ...
  let t29;
  if ($[48] !== allowDataInference || $[49] !== collectionEditable || $[50] !== deleteProperty || $[51] !== getData || $[52] !== onPropertyCreated || $[53] !== propertyConfigs || $[54] !== propertyDialogOpen || $[55] !== selectedProperty || $[56] !== selectedPropertyKey || $[57] !== selectedPropertyNamespace || $[58] !== t25 || $[59] !== t26 || $[60] !== t27 || $[61] !== t28) {
    t29 = /* @__PURE__ */ jsx(PropertyFormDialog, { inArray: false, forceShowErrors: false, open: propertyDialogOpen, allowDataInference, collectionEditable, onCancel: t23, onOkClicked: t24, getData, onDelete: deleteProperty, propertyKey: selectedPropertyKey, propertyNamespace: selectedPropertyNamespace, property: selectedProperty, existingProperty: t25, autoUpdateId: t26, autoOpenTypeSelect: t27, onPropertyChanged: onPropertyCreated, existingPropertyKeys: t28, propertyConfigs });
    $[48] = allowDataInference;
    $[49] = collectionEditable;
    $[50] = deleteProperty;
    $[51] = getData;
    $[52] = onPropertyCreated;
    $[53] = propertyConfigs;
    $[54] = propertyDialogOpen;
    $[55] = selectedProperty;
    $[56] = selectedPropertyKey;
    $[57] = selectedPropertyNamespace;
    $[58] = t25;
    $[59] = t26;
    $[60] = t27;
    $[61] = t28;
...
function RepeatPropertyField(t0) {
  ...
  let t1;
  if ($[0] !== errors || $[1] !== propertyConfigs || $[2] !== setFieldValue || $[3] !== touched || $[4] !== values) {
    ofProperty = getIn(values, "of");
    let t22;
    if ($[9] !== errors || $[10] !== touched) {
    ...
    t1 = ofProperty && getFieldConfig(ofProperty, propertyConfigs);
    $[0] = errors;
    $[1] = propertyConfigs;
    $[2] = setFieldValue;
    $[3] = touched;
  ...
  let t3;
  if ($[15] !== allowDataInference || $[16] !== collectionEditable || $[17] !== disabled || $[18] !== existing || $[19] !== getData || $[20] !== ofProperty || $[21] !== ofPropertyError || $[22] !== onPropertyChanged || $[23] !== propertyConfigs || $[24] !== propertyDialogOpen || $[25] !== showErrors || $[26] !== widget) {
    t3 = (t42) => /* @__PURE__ */ jsxs(Paper, { className: "p-2 mt-4", children: [
      ofProperty && /* @__PURE__ */ jsx(PropertyFieldPreview, { property: ofProperty, onClick: disabled ? void 0 : () => setPropertyDialogOpen(true), includeName: false, includeEditButton: true, selected: false, hasError: false }),
      !disabled && !ofProperty && /* @__PURE__ */ jsxs(Button, { variant: "text", size: "large", color: ofPropertyError ? "error" : "primary", onClick: () => setPropertyDialogOpen(true), children: [
        "Edit ",
        `${widget ? widget.name : "repeat component"}`
      ] }),
      /* @__PURE__ */ jsx(PropertyFormDialog, { inArray: true, open: propertyDialogOpen, existingProperty: existing, getData, autoUpdateId: !existing, autoOpenTypeSelect: !existing, onOkClicked: () => setPropertyDialogOpen(false), allowDataInference, property: ofProperty, includeIdAndName: false, onPropertyChanged, forceShowErrors: showErrors, propertyConfigs, collectionEditable })
    ] });
    $[15] = allowDataInference;
  ...
  let t4;
  if ($[28] !== ofProperty || $[29] !== t3) {
    t4 = /* @__PURE__ */ jsxs("div", { className: "col-span-12", children: [
      t2,
      /* @__PURE__ */ jsx(Field, { name: "of", value: ofProperty, children: t3 })
    ] });
    $[28] = ofProperty;
    $[29] = t3;
    $[30] = t4;
  ...
  let t5;
  if ($[31] !== disabled) {
    t5 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(ValidationPanel, { children: /* @__PURE__ */ jsx(ArrayPropertyValidation, { disabled }) }) });
    $[31] = disabled;
    $[32] = t5;
  } else {
    t5 = $[32];
...
const CommonPropertyFields = React__default.forwardRef(function CommonPropertyFields2(t0, ref) {
  const $ = c(56);
  const {
    showErrors,
    disabledId,
  ...
  let t5;
  if ($[9] !== autoUpdateId || $[10] !== setFieldTouched || $[11] !== setFieldValue || $[12] !== touched) {
    t5 = (e) => {
  ...
  let t8;
  if ($[15] !== disabled || $[16] !== ref || $[17] !== t5 || $[18] !== t7 || $[19] !== values.name) {
    t8 = /* @__PURE__ */ jsx(Field, { name: "name", inputRef: ref, as: DebouncedTextField, value: t4, onChange: t5, style: t6, placeholder: "Field name", required: true, disabled, error: t7 });
    $[15] = disabled;
    $[16] = ref;
    $[17] = t5;
    $[18] = t7;
  ...
  let t10;
  if ($[21] !== nameError || $[22] !== t9) {
    t10 = /* @__PURE__ */ jsx(FieldCaption, { error: t9, children: nameError });
    $[21] = nameError;
    $[22] = t9;
    $[23] = t10;
  } else {
  ...
  const t12 = values.id;
  let t13;
  if ($[27] !== autoUpdateId || $[28] !== setFieldTouched || $[29] !== setFieldValue || $[30] !== touched) {
    t13 = (e_0) => {
  ...
  let t16;
  if ($[32] !== t13 || $[33] !== t14 || $[34] !== t15 || $[35] !== values.id) {
    t16 = /* @__PURE__ */ jsx(Field, { name: "id", as: DebouncedTextField, label: "ID", value: t12, onChange: t13, disabled: t14, required: true, size: "small", error: t15 });
    $[32] = t13;
    $[33] = t14;
    $[34] = t15;
    $[35] = values.id;
  ...
  let t18;
  if ($[37] !== idError || $[38] !== t17) {
    t18 = /* @__PURE__ */ jsx(FieldCaption, { error: t17, children: idError });
    $[37] = idError;
    $[38] = t17;
    $[39] = t18;
  } else {
  ...
  let t21;
  if ($[43] !== disabled || $[44] !== t20) {
    t21 = /* @__PURE__ */ jsx(Field, { name: "description", as: DebouncedTextField, label: "Description", disabled, error: t20 });
    $[43] = disabled;
    $[44] = t20;
    $[45] = t21;
  } else {
  ...
  let t23;
  if ($[46] !== descriptionError || $[47] !== t22) {
    t23 = /* @__PURE__ */ jsx(FieldCaption, { error: t22, children: descriptionError });
    $[46] = descriptionError;
    $[47] = t22;
    $[48] = t23;
  } else {
  ...
  let t24;
  if ($[49] !== t21 || $[50] !== t23) {
    t24 = /* @__PURE__ */ jsxs("div", { children: [
      t21,
      t23
    ] });
    $[49] = t21;
  ...
  let t25;
  if ($[52] !== t11 || $[53] !== t19 || $[54] !== t24) {
    t25 = /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 col-span-12", children: [
      t11,
      t19,
      t24
    ] });
...
function StringPropertyField(t0) {
  ...
  let t1;
  if ($[0] !== disabled || $[1] !== showErrors || $[2] !== widgetId) {
    t1 = widgetId === "text_field" && /* @__PURE__ */ jsx(StringPropertyValidation, { disabled, length: true, lowercase: true, matches: true, max: true, min: true, trim: true, uppercase: true, showErrors });
    $[0] = disabled;
    $[1] = showErrors;
    $[2] = widgetId;
    $[3] = t1;
...
function BooleanPropertyField(t0) {
  ...
  let t2;
  if ($[2] !== disabled) {
    t2 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(ValidationPanel, { children: /* @__PURE__ */ jsx(GeneralPropertyValidation, { disabled }) }) });
    $[2] = disabled;
    $[3] = t2;
  } else {
    t2 = $[3];
  ...
  let t3;
  if ($[4] !== defaultValue || $[5] !== disabled) {
    t3 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(Field, { name: "defaultValue", children: (t42) => {
      const {
        field,
        form
      } = t42;
      return /* @__PURE__ */ jsx(SwitchControl, { size: "medium", label: defaultValue === null || defaultValue === void 0 ? "Default value not set" : "Default value is " + defaultValue.toString(), disabled, allowIndeterminate: true, field, form });
    } }) });
    $[4] = defaultValue;
    $[5] = disabled;
    $[6] = t3;
...
function BlockPropertyField(t0) {
  ...
  const [selectedPropertyNamespace, setSelectedPropertyNamespace] = useState();
  let t1;
  if ($[0] !== setFieldValue || $[1] !== values.oneOf?.properties || $[2] !== values.oneOf?.propertiesOrder) {
    t1 = (t22) => {
      const {
        id,
        namespace,
    ...
    $[0] = setFieldValue;
    $[1] = values.oneOf?.properties;
    $[2] = values.oneOf?.propertiesOrder;
    $[3] = t1;
  } else {
    t1 = $[3];
  }
  ...
  let t2;
  if ($[4] !== selectedPropertyKey || $[5] !== selectedPropertyNamespace || $[6] !== values.oneOf?.properties) {
    const selectedPropertyFullId = selectedPropertyKey ? getFullId(selectedPropertyKey, selectedPropertyNamespace) : void 0;
    t2 = selectedPropertyFullId ? getIn(values.oneOf?.properties, selectedPropertyFullId.replaceAll(".", ".properties.")) : void 0;
    $[4] = selectedPropertyKey;
    $[5] = selectedPropertyNamespace;
    $[6] = values.oneOf?.properties;
    $[7] = t2;
  } else {
    t2 = $[7];
  }
  ...
  let t7;
  if ($[13] !== t6) {
    t7 = /* @__PURE__ */ jsxs(Button, { autoFocus: true, onClick: t4, startIcon: t5, children: [
      "Add property to ",
      t6
    ] });
    $[13] = t6;
  ...
  let t10;
  if ($[18] !== addChildButton) {
    t10 = /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-end mt-8 mb-4", children: [
      t9,
      addChildButton
    ] });
    $[18] = addChildButton;
  ...
  let t11;
  if ($[20] !== values.oneOf?.properties) {
    t11 = values.oneOf?.properties ?? {};
    $[20] = values.oneOf?.properties;
    $[21] = t11;
  } else {
    t11 = $[21];
  }
  ...
  let t16;
  if ($[25] !== collectionEditable || $[26] !== t11 || $[27] !== t12 || $[28] !== t14 || $[29] !== t15) {
    t16 = /* @__PURE__ */ jsx(PropertyTree, { properties: t11, propertiesOrder: t12, errors: t13, collectionEditable, onPropertyClick: t14, onPropertyMove: t15 });
    $[25] = collectionEditable;
    $[26] = t11;
    $[27] = t12;
    $[28] = t14;
  ...
  let t17;
  if ($[31] !== disabled || $[32] !== values.oneOf?.propertiesOrder?.length) {
    t17 = !disabled && values.oneOf?.propertiesOrder?.length === 0 && /* @__PURE__ */ jsx("div", { className: "h-full flex items-center justify-center p-4", children: "Add the first property to this block" });
    $[31] = disabled;
    $[32] = values.oneOf?.propertiesOrder?.length;
    $[33] = t17;
  } else {
    t17 = $[33];
  }
  let t18;
  if ($[34] !== t16 || $[35] !== t17) {
    t18 = /* @__PURE__ */ jsxs(Paper, { className: "p-2 pl-8", children: [
      t16,
      t17
    ] });
    $[34] = t16;
  ...
  let t20;
  if ($[40] !== allowDataInference || $[41] !== collectionEditable || $[42] !== deleteProperty || $[43] !== disabled || $[44] !== getData || $[45] !== onPropertyChanged || $[46] !== propertyConfigs || $[47] !== propertyDialogOpen || $[48] !== selectedProperty || $[49] !== selectedPropertyKey || $[50] !== selectedPropertyNamespace || $[51] !== values.oneOf?.propertiesOrder) {
    t20 = !disabled && /* @__PURE__ */ jsx(PropertyFormDialog, { inArray: false, forceShowErrors: false, open: propertyDialogOpen, getData, allowDataInference, onCancel: () => {
      setPropertyDialogOpen(false);
      setSelectedPropertyKey(void 0);
      setSelectedPropertyNamespace(void 0);
    }, onOkClicked: () => {
    ...
    $[40] = allowDataInference;
    $[41] = collectionEditable;
    $[42] = deleteProperty;
    $[43] = disabled;
    $[44] = getData;
    $[45] = onPropertyChanged;
    $[46] = propertyConfigs;
    $[47] = propertyDialogOpen;
    $[48] = selectedProperty;
    $[49] = selectedPropertyKey;
    $[50] = selectedPropertyNamespace;
    $[51] = values.oneOf?.propertiesOrder;
    $[52] = t20;
  } else {
    t20 = $[52];
  }
...
function NumberPropertyValidation(t0) {
  ...
  let t1;
  if ($[0] !== disabled) {
    t1 = /* @__PURE__ */ jsx(GeneralPropertyValidation, { disabled });
    $[0] = disabled;
    $[1] = t1;
  } else {
    t1 = $[1];
  ...
  let t3;
  if ($[4] !== disabled || $[5] !== handleChange || $[6] !== t2) {
    t3 = /* @__PURE__ */ jsx("div", { className: "col-span-6", children: /* @__PURE__ */ jsx(DebouncedTextField, { value: t2, label: "Min value", name: "validation.min", type: "number", size: "small", disabled, onChange: handleChange }) });
    $[4] = disabled;
    $[5] = handleChange;
    $[6] = t2;
    $[7] = t3;
  ...
  let t5;
  if ($[10] !== disabled || $[11] !== handleChange || $[12] !== t4) {
    t5 = /* @__PURE__ */ jsx("div", { className: "col-span-6", children: /* @__PURE__ */ jsx(DebouncedTextField, { value: t4, label: "Max value", name: "validation.max", type: "number", size: "small", disabled, onChange: handleChange }) });
    $[10] = disabled;
    $[11] = handleChange;
    $[12] = t4;
    $[13] = t5;
  ...
  let t7;
  if ($[16] !== disabled || $[17] !== handleChange || $[18] !== t6) {
    t7 = /* @__PURE__ */ jsx("div", { className: "col-span-6", children: /* @__PURE__ */ jsx(DebouncedTextField, { value: t6, label: "Less than", name: "validation.lessThan", type: "number", size: "small", disabled, onChange: handleChange }) });
    $[16] = disabled;
    $[17] = handleChange;
    $[18] = t6;
    $[19] = t7;
  ...
  let t9;
  if ($[22] !== disabled || $[23] !== handleChange || $[24] !== t8) {
    t9 = /* @__PURE__ */ jsx("div", { className: "col-span-6", children: /* @__PURE__ */ jsx(DebouncedTextField, { value: t8, label: "More than", name: "validation.moreThan", type: "number", size: "small", disabled, onChange: handleChange }) });
    $[22] = disabled;
    $[23] = handleChange;
    $[24] = t8;
    $[25] = t9;
  ...
  let t10;
  if ($[26] !== disabled) {
    t10 = /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsx(Field, { name: "validation.positive", type: "checkbox", children: (t112) => {
      const {
        field,
        form
      } = t112;
      return /* @__PURE__ */ jsx(SwitchControl, { label: "Positive value", disabled, form, field });
    } }) });
    $[26] = disabled;
    $[27] = t10;
  } else {
  ...
  let t11;
  if ($[28] !== disabled) {
    t11 = /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsx(Field, { name: "validation.negative", type: "checkbox", children: (t122) => {
      const {
        field: field_0,
        form: form_0
      } = t122;
      return /* @__PURE__ */ jsx(SwitchControl, { label: "Negative value", disabled, form: form_0, field: field_0 });
    } }) });
    $[28] = disabled;
    $[29] = t11;
  } else {
  ...
  let t12;
  if ($[30] !== disabled) {
    t12 = /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsx(Field, { name: "validation.integer", type: "checkbox", children: (t132) => {
      const {
        field: field_1,
        form: form_1
      } = t132;
      return /* @__PURE__ */ jsx(SwitchControl, { label: "Integer value", disabled, form: form_1, field: field_1 });
    } }) });
    $[30] = disabled;
    $[31] = t12;
  } else {
  ...
  let t13;
  if ($[32] !== t1 || $[33] !== t10 || $[34] !== t11 || $[35] !== t12 || $[36] !== t3 || $[37] !== t5 || $[38] !== t7 || $[39] !== t9) {
    t13 = /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-2", children: [
      t1,
      t3,
      t5,
...
function NumberPropertyField(t0) {
  ...
  let t1;
  if ($[0] !== disabled) {
    t1 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(ValidationPanel, { children: /* @__PURE__ */ jsx(NumberPropertyValidation, { disabled }) }) });
    $[0] = disabled;
    $[1] = t1;
  } else {
    t1 = $[1];
  ...
  let t4;
  if ($[6] !== disabled || $[7] !== t2 || $[8] !== t3) {
    t4 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(TextField, { name: "defaultValue", disabled, type: "number", onChange: t2, label: "Default value", value: t3 }) });
    $[6] = disabled;
    $[7] = t2;
    $[8] = t3;
    $[9] = t4;
...
function ReferencePropertyField(t0) {
  ...
  const pathValue = t1;
  let t2;
  if ($[4] !== errors || $[5] !== pathPath || $[6] !== showErrors) {
...
function CollectionsSelect(t0) {
  ...
  let t1;
  if ($[8] !== navigation?.collections) {
    t1 = navigation?.collections ?? [];
    $[8] = navigation?.collections;
    $[9] = t1;
  } else {
    t1 = $[9];
  }
  ...
  let t2;
  if ($[10] !== collections) {
    t2 = Array.from(new Set(Object.values(collections).map(_temp$c).filter(Boolean)).values());
    $[10] = collections;
    $[11] = t2;
  } else {
    t2 = $[11];
  ...
  if ($[12] !== collections || $[13] !== disabled || $[14] !== error || $[15] !== groups || $[16] !== handleChange || $[17] !== pathPath || $[18] !== props || $[19] !== value) {
    const ungroupedCollections = collections.filter(_temp2$8);
    ...
    t3 = /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(Select, { error: t4, disabled, value: value ?? "", position: "item-aligned", name: pathPath, size: "large", fullWidth: true, onChange: handleChange, label: "Target collection", renderValue: t5, ...props, children: [
      t6,
      ungroupedCollections && /* @__PURE__ */ jsx(SelectGroup, { label: "Views", children: ungroupedCollections.map(_temp3$7) })
    ] }) });
    $[12] = collections;
    $[13] = disabled;
    $[14] = error;
...
function _temp3$7(collection_2) {
...
function DateTimePropertyField(t0) {
  ...
  let t5;
  if ($[10] !== values) {
    t5 = getIn(values, "timezone");
    $[10] = values;
    $[11] = t5;
  } else {
    t5 = $[11];
  }
  const timezoneValue = t5;
  let t6;
  if ($[12] !== errors || $[13] !== touched) {
    t6 = getIn(touched, "timezone") && getIn(errors, "timezone");
    $[12] = errors;
    $[13] = touched;
    $[14] = t6;
  } else {
  ...
  const timezoneError = t6;
  const t7 = modeValue ?? "date";
  const t8 = Boolean(modeError);
  let t9;
  if ($[15] !== setFieldValue) {
    t9 = (v) => setFieldValue("mode", v);
    $[15] = setFieldValue;
    $[16] = t9;
  } else {
    t9 = $[16];
  ...
  let t11;
  if ($[17] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t10 = /* @__PURE__ */ jsx(SelectItem, { value: "date_time", children: " Date/Time " });
    t11 = /* @__PURE__ */ jsx(SelectItem, { value: "date", children: " Date " });
    $[17] = t10;
    $[18] = t11;
  } else {
    t10 = $[17];
  ...
  let t12;
  if ($[19] !== disabled || $[20] !== t7 || $[21] !== t8 || $[22] !== t9) {
    t12 = /* @__PURE__ */ jsxs(Select, { name: "mode", value: t7, error: t8, size: "large", onValueChange: t9, label: "Mode", fullWidth: true, renderValue: _temp$b, disabled, children: [
      t10,
      t11
    ] });
    $[19] = disabled;
  ...
  const t13 = Boolean(modeError);
  let t14;
  if ($[24] !== modeError || $[25] !== t13) {
    t14 = /* @__PURE__ */ jsx(FieldCaption, { error: t13, children: modeError });
    $[24] = modeError;
    $[25] = t13;
    $[26] = t14;
  } else {
  ...
  const t16 = autoValueValue ?? "";
  let t17;
  if ($[30] !== setFieldValue) {
    t17 = (v_1) => setFieldValue("autoValue", v_1 === "none" ? null : v_1);
    $[30] = setFieldValue;
    $[31] = t17;
  } else {
    t17 = $[31];
  }
  const t18 = Boolean(autoValueError);
  let t19;
  let t20;
  let t21;
  if ($[32] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t19 = /* @__PURE__ */ jsx(SelectItem, { value: "none", children: " None " });
    t20 = /* @__PURE__ */ jsx(SelectItem, { value: "on_create", children: " On create " });
    t21 = /* @__PURE__ */ jsx(SelectItem, { value: "on_update", children: " On any update " });
    $[32] = t19;
    $[33] = t20;
    $[34] = t21;
  } else {
  ...
  let t22;
  if ($[35] !== disabled || $[36] !== t16 || $[37] !== t17 || $[38] !== t18) {
    t22 = /* @__PURE__ */ jsxs(Select, { name: "autoValue", disabled, size: "large", fullWidth: true, value: t16, onValueChange: t17, renderValue: _temp2$7, error: t18, label: "Automatic value", children: [
      t19,
      t20,
      t21
    ] });
  ...
  const t23 = Boolean(autoValueError);
  const t24 = autoValueError ?? "Update this field automatically when creating or updating the entity";
  let t25;
  if ($[40] !== t23 || $[41] !== t24) {
    t25 = /* @__PURE__ */ jsx(FieldCaption, { error: t23, children: t24 });
    $[40] = t23;
    $[41] = t24;
    $[42] = t25;
  } else {
  ...
  let t26;
  if ($[43] !== t22 || $[44] !== t25) {
    t26 = /* @__PURE__ */ jsxs("div", { children: [
      t22,
      t25
    ] });
    $[43] = t22;
  ...
  const t27 = timezoneValue ?? "__local__";
  let t28;
  if ($[46] !== setFieldValue) {
    t28 = (v_3) => setFieldValue("timezone", v_3 === "__local__" ? void 0 : v_3);
    $[46] = setFieldValue;
    $[47] = t28;
  } else {
    t28 = $[47];
  }
  const t29 = Boolean(timezoneError);
  let t30;
  let t31;
  if ($[48] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t30 = /* @__PURE__ */ jsx(SelectItem, { value: "__local__", children: " Local timezone " });
    t31 = TIMEZONES.map(_temp4$4);
    $[48] = t30;
    $[49] = t31;
  } else {
    t30 = $[48];
  ...
  let t32;
  if ($[50] !== disabled || $[51] !== t27 || $[52] !== t28 || $[53] !== t29) {
    t32 = /* @__PURE__ */ jsxs(Select, { name: "timezone", disabled, size: "large", fullWidth: true, value: t27, onValueChange: t28, renderValue: _temp3$6, error: t29, label: "Timezone", children: [
      t30,
      t31
    ] });
    $[50] = disabled;
  ...
  const t33 = Boolean(timezoneError);
  const t34 = timezoneError ?? "Timezone for displaying and inputting dates. Values are always stored in UTC.";
  let t35;
  if ($[55] !== t33 || $[56] !== t34) {
  ...
  let t36;
  if ($[58] !== t32 || $[59] !== t35) {
    t36 = /* @__PURE__ */ jsxs("div", { children: [
      t32,
      t35
    ] });
    $[58] = t32;
  ...
  let t37;
  if ($[61] !== t15 || $[62] !== t26 || $[63] !== t36) {
    t37 = /* @__PURE__ */ jsxs("div", { className: "flex flex-col col-span-12 gap-2", children: [
      t15,
      t26,
      t36
    ] });
  ...
  let t38;
  if ($[65] !== disabled) {
    t38 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(ValidationPanel, { children: /* @__PURE__ */ jsx(GeneralPropertyValidation, { disabled }) }) });
    $[65] = disabled;
    $[66] = t38;
  } else {
    t38 = $[66];
  ...
  let t39;
  if ($[67] !== t37 || $[68] !== t38) {
    t39 = /* @__PURE__ */ jsxs(Fragment, { children: [
      t37,
      t38
    ] });
    $[67] = t37;
...
function _temp4$4(tz_0) {
  return /* @__PURE__ */ jsx(SelectItem, { value: tz_0.value, children: tz_0.label }, tz_0.value);
}
function _temp3$6(v_4) {
  if (!v_4 || v_4 === "__local__") {
    return "Local timezone";
  }
  const tz = TIMEZONES.find((t) => t.value === v_4);
  return tz?.label ?? v_4;
}
function _temp2$7(v_2) {
  switch (v_2) {
    case "on_create": {
      return "On create";
    }
...
function AdvancedPropertyValidation(t0) {
  ...
  let t3;
  if ($[4] !== t1 || $[5] !== t2) {
    t3 = /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-2", children: [
      t1,
      t2
    ] });
    $[4] = t1;
...
function ConditionsPanel(t0) {
  ...
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t1 = /* @__PURE__ */ jsxs("div", { className: "flex flex-row text-surface-500 text-text-secondary dark:text-text-secondary-dark", children: [
      ...
      /* @__PURE__ */ jsx(Typography, { variant: "subtitle2", className: "ml-4", children: "Conditions" })
    ] });
    $[0] = t1;
  } else {
    t1 = $[0];
  ...
  let t2;
  if ($[1] !== children) {
    t2 = /* @__PURE__ */ jsx(ExpandablePanel, { initiallyExpanded: true, asField: true, innerClassName: "p-4", title: t1, children });
    $[1] = children;
    $[2] = t2;
  } else {
    t2 = $[2];
...
function getPropertyPaths(properties, prefix = "") {
  ...
  for (const [key, propertyOrBuilder] of Object.entries(properties)) {
    ...
    paths.push(fullPath);
    if (property.dataType === "map" && property.properties) {
      const nestedPaths = getPropertyPaths(property.properties, fullPath);
      paths.push(...nestedPaths);
    }
    if (property.dataType === "array" && property.of) {
      const ofPropertyOrBuilder = property.of;
      if (!isPropertyBuilder(ofPropertyOrBuilder)) {
        const ofProperty = ofPropertyOrBuilder;
        if (ofProperty.dataType === "map" && ofProperty.properties) {
          const nestedPaths = getPropertyPaths(ofProperty.properties, `${fullPath}[]`);
          paths.push(...nestedPaths);
        }
      }
    }
...
function getPropertyAtPath$1(fieldPath, collectionProperties) {
  if (!collectionProperties) return void 0;
  const parts = fieldPath.split(".");
  let current = collectionProperties;
  let property;
  for (const part of parts) {
    if (!current) return void 0;
    const propertyOrBuilder = current[part];
    if (!propertyOrBuilder) return void 0;
    if (isPropertyBuilder(propertyOrBuilder)) return void 0;
    property = propertyOrBuilder;
    if (property.dataType === "map" && property.properties) {
...
function getFieldDataType(fieldPath, collectionProperties) {
  const contextField = CONTEXT_FIELDS$1.find((f) => f.id === fieldPath);
  if (contextField) return contextField.dataType;
  const property = getPropertyAtPath$1(fieldPath, collectionProperties);
...
function getOperatorsForDataType(dataType) {
  return OPERATORS$1.filter((op) => {
    const applicable = op.applicableTo;
    return applicable.includes(dataType) || applicable.includes("string") && !["number", "date", "array"].includes(dataType);
  });
}
function ConditionValueInput(t0) {
  const $ = c(31);
  const {
    value,
    onChange,
  ...
  if (dataType === "boolean") {
    const t12 = value === "true";
    let t22;
    if ($[0] !== onChange) {
      t22 = (newValue) => onChange(newValue ? "true" : "false");
      $[0] = onChange;
      $[1] = t22;
    } else {
      t22 = $[1];
    ...
    let t3;
    if ($[2] !== disabled || $[3] !== t12 || $[4] !== t22) {
      t3 = /* @__PURE__ */ jsx(BooleanSwitchWithLabel, { value: t12, size: "small", position: "start", disabled, onValueChange: t22 });
      $[2] = disabled;
      $[3] = t12;
      $[4] = t22;
      $[5] = t3;
  ...
  if (enumValues && enumValues.length > 0) {
    ...
    let t22;
    if ($[8] !== disabled || $[9] !== onChange || $[10] !== t12 || $[11] !== value) {
      t22 = /* @__PURE__ */ jsx(Select, { value, onValueChange: onChange, disabled, size: "small", className: "min-w-[120px]", placeholder: "Select value", children: t12 });
      $[8] = disabled;
      $[9] = onChange;
      $[10] = t12;
      $[11] = value;
  ...
  if (dataType === "number") {
    ...
    let t22;
    if ($[15] !== disabled || $[16] !== t12 || $[17] !== value) {
      t22 = /* @__PURE__ */ jsx(TextField, { value, type: "number", size: "small", disabled, placeholder: "Value", className: "flex-1 min-w-[80px]", onChange: t12 });
      $[15] = disabled;
      $[16] = t12;
      $[17] = value;
      $[18] = t22;
  ...
  if (dataType === "array") {
    let t12;
    if ($[19] !== onChange) {
      t12 = (e_0) => onChange(e_0.target.value);
      $[19] = onChange;
      $[20] = t12;
    } else {
      t12 = $[20];
    ...
    let t22;
    if ($[21] !== disabled || $[22] !== t12 || $[23] !== value) {
      t22 = /* @__PURE__ */ jsx(DebouncedTextField, { value, onChange: t12, disabled, size: "small", placeholder: "value1, value2", className: "flex-1 min-w-[120px]" });
      $[21] = disabled;
      $[22] = t12;
      $[23] = value;
      $[24] = t22;
  ...
  let t1;
  if ($[25] !== onChange) {
    t1 = (e_1) => onChange(e_1.target.value);
    $[25] = onChange;
    $[26] = t1;
  } else {
    t1 = $[26];
  ...
  let t2;
  if ($[27] !== disabled || $[28] !== t1 || $[29] !== value) {
    t2 = /* @__PURE__ */ jsx(DebouncedTextField, { value, onChange: t1, disabled, size: "small", placeholder: "Value", className: "flex-1 min-w-[100px]", inputClassName: "min-w-[100px]" });
    $[27] = disabled;
    $[28] = t1;
    $[29] = value;
    $[30] = t2;
...
function _temp$a(ev) {
  return /* @__PURE__ */ jsx(SelectItem, { value: String(ev.id), children: ev.label }, ev.id);
}
function ConditionRow(t0) {
  const $ = c(76);
  const {
    rule,
    onRuleChange,
  ...
  const showRemoveButton = t1 === void 0 ? true : t1;
  let T0;
  let enumValues;
  let fieldDataType;
  let showValueField;
  ...
  let t8;
  let t9;
  if ($[0] !== availableFields || $[1] !== collectionProperties || $[2] !== disabled || $[3] !== onRuleChange || $[4] !== rule || $[5] !== showErrors) {
    fieldDataType = getFieldDataType(rule.field, collectionProperties);
    const applicableOperators = getOperatorsForDataType(fieldDataType);
    let t102;
    if ($[18] !== collectionProperties || $[19] !== rule.field) {
      const property = getPropertyAtPath$1(rule.field, collectionProperties);
      t102 = getEnumValues(property);
      $[18] = collectionProperties;
      $[19] = rule.field;
      $[20] = t102;
    } else {
      t102 = $[20];
    ...
    enumValues = t102;
    const operator = OPERATORS$1.find((op) => op.id === rule.operator);
    showValueField = operator?.valueType !== "none";
    ...
    let t112;
    if ($[21] !== collectionProperties) {
      t112 = (fieldPath) => {
        const contextField = CONTEXT_FIELDS$1.find((f) => f.id === fieldPath);
        if (contextField) {
          return contextField.color;
        }
        if (!collectionProperties) {
          return "#888";
        }
        const prop = getPropertyAtPath$1(fieldPath, collectionProperties);
        if (!prop) {
          return "#888";
        }
      ...
      $[21] = collectionProperties;
      $[22] = t112;
    } else {
      t112 = $[22];
    }
    const getFieldColor2 = t112;
    const t122 = hasError ? "bg-red-50 dark:bg-red-900/20" : "bg-surface-100 dark:bg-surface-800";
    if ($[23] !== t122) {
      t8 = cls("flex items-center gap-2 p-2 rounded-md", t122);
      $[23] = t122;
      $[24] = t8;
    } else {
      t8 = $[24];
    }
    const t132 = rule.field;
    let t14;
    if ($[25] !== collectionProperties || $[26] !== onRuleChange || $[27] !== rule) {
      t14 = (value) => {
        const newDataType = getFieldDataType(value, collectionProperties);
        const newApplicableOps = getOperatorsForDataType(newDataType);
        const newOperator = newApplicableOps.find((op_0) => op_0.id === rule.operator) ? rule.operator : newApplicableOps[0]?.id ?? "==";
        onRuleChange({
          ...rule,
          field: value,
    ...
    let t15;
    if ($[29] !== getFieldColor2) {
      t15 = (value_0) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full shrink-0", style: {
          backgroundColor: getFieldColor2(value_0)
        } }),
        /* @__PURE__ */ jsx("span", { className: "truncate", children: value_0 })
      ] });
      $[29] = getFieldColor2;
      $[30] = t15;
    } else {
    ...
    if ($[31] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t16 = CONTEXT_FIELDS$1.map(_temp2$6);
      $[31] = t16;
    } else {
      t16 = $[31];
    }
    let t17;
    if ($[32] !== availableFields.length) {
      t17 = availableFields.length > 0 && /* @__PURE__ */ jsx(SelectItem, { value: "_divider", disabled: true, children: /* @__PURE__ */ jsx("span", { className: "text-xs text-surface-500", children: "─ Entity Fields ─" }) });
      $[32] = availableFields.length;
      $[33] = t17;
    } else {
      t17 = $[33];
    }
    let t18;
    if ($[34] !== availableFields || $[35] !== collectionProperties || $[36] !== getFieldColor2) {
      let t19;
      if ($[38] !== collectionProperties || $[39] !== getFieldColor2) {
        t19 = (field_0) => {
          const color = getFieldColor2(field_0);
          const dataType = getFieldDataType(field_0, collectionProperties);
          const prop_0 = getPropertyAtPath$1(field_0, collectionProperties);
          const hasEnum = !!getEnumValues(prop_0);
          return /* @__PURE__ */ jsx(SelectItem, { value: field_0, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx("div", { className: "w-3 h-3 rounded-full shrink-0", style: {
              backgroundColor: color
            } }),
            /* @__PURE__ */ jsx("span", { children: field_0 }),
            /* @__PURE__ */ jsx(Chip, { size: "small", colorScheme: "grayLight", className: "ml-auto", children: hasEnum ? "enum" : dataType })
          ] }) }, field_0);
        };
        $[38] = collectionProperties;
        $[39] = getFieldColor2;
        $[40] = t19;
      } else {
        t19 = $[40];
      }
      t18 = availableFields.map(t19);
      $[34] = availableFields;
      $[35] = collectionProperties;
      $[36] = getFieldColor2;
      $[37] = t18;
    } else {
      t18 = $[37];
    }
    if ($[41] !== disabled || $[42] !== rule.field || $[43] !== t14 || $[44] !== t15 || $[45] !== t17 || $[46] !== t18) {
      t9 = /* @__PURE__ */ jsxs(Select, { value: t132, onValueChange: t14, disabled, size: "small", inputClassName: "min-w-[180px]", renderValue: t15, placeholder: "Select field", children: [
        t16,
        t17,
        t18
      ] });
    ...
    T0 = Select;
    t2 = rule.operator;
    if ($[48] !== onRuleChange || $[49] !== rule) {
      t3 = (value_1) => onRuleChange({
        ...rule,
        operator: value_1
      });
      $[48] = onRuleChange;
    ...
    t5 = "small";
    t6 = "min-w-[120px]";
    t7 = applicableOperators.map(_temp3$5);
    $[0] = availableFields;
  ...
  let t10;
  if ($[51] !== T0 || $[52] !== t2 || $[53] !== t3 || $[54] !== t4 || $[55] !== t5 || $[56] !== t6 || $[57] !== t7) {
    t10 = /* @__PURE__ */ jsx(T0, { value: t2, onValueChange: t3, disabled: t4, size: t5, inputClassName: t6, children: t7 });
    $[51] = T0;
    $[52] = t2;
    $[53] = t3;
    $[54] = t4;
  ...
  let t11;
  if ($[59] !== disabled || $[60] !== enumValues || $[61] !== fieldDataType || $[62] !== onRuleChange || $[63] !== rule || $[64] !== showValueField) {
    t11 = showValueField && /* @__PURE__ */ jsx(ConditionValueInput, { value: rule.value, onChange: (newValue) => onRuleChange({
      ...rule,
      value: newValue
    }), dataType: fieldDataType, enumValues, disabled, operator: rule.operator });
    $[59] = disabled;
    $[60] = enumValues;
    $[61] = fieldDataType;
    $[62] = onRuleChange;
  ...
  let t12;
  if ($[66] !== disabled || $[67] !== onRemove || $[68] !== showRemoveButton) {
    t12 = showRemoveButton && /* @__PURE__ */ jsx(IconButton, { onClick: onRemove, disabled, size: "small", variant: "ghost", children: /* @__PURE__ */ jsx(DeleteIcon, { size: "smallest" }) });
    $[66] = disabled;
    $[67] = onRemove;
    $[68] = showRemoveButton;
    $[69] = t12;
  ...
  let t13;
  if ($[70] !== t10 || $[71] !== t11 || $[72] !== t12 || $[73] !== t8 || $[74] !== t9) {
    t13 = /* @__PURE__ */ jsxs("div", { className: t8, children: [
      t9,
      t10,
      t11,
      t12
...
function _temp3$5(op_1) {
  return /* @__PURE__ */ jsx(SelectItem, { value: op_1.id, children: op_1.label }, op_1.id);
}
function _temp2$6(field) {
  return /* @__PURE__ */ jsx(SelectItem, { value: field.id, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsx("div", { className: "w-3 h-3 rounded-full shrink-0", style: {
      backgroundColor: field.color
    } }),
    /* @__PURE__ */ jsx("span", { children: field.label }),
    /* @__PURE__ */ jsx(Chip, { size: "small", colorScheme: "grayLight", className: "ml-auto", children: field.dataType })
  ] }) }, field.id);
}
function ConditionGroupRow(t0) {
  const $ = c(62);
  const {
    conditionType,
    group,
  ...
  const handleLogicChange = t1;
  let t2;
  if ($[3] !== group || $[4] !== onGroupChange) {
    t2 = (index, rule) => {
  ...
  const handleRuleChange = t2;
  let t3;
  if ($[6] !== group || $[7] !== onGroupChange || $[8] !== onRemove) {
    t3 = (index_0) => {
      const newRules_0 = group.rules.filter((_, i) => i !== index_0);
      if (newRules_0.length === 0) {
        onRemove();
      } else {
        onGroupChange({
          ...group,
  ...
  const handleRemoveRule = t3;
  let t4;
  if ($[10] !== availableFields[0] || $[11] !== group || $[12] !== onGroupChange) {
    t4 = () => {
      const defaultRule = {
  ...
  const handleAddRule = t4;
  let t5;
  if ($[14] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t5 = cls("p-3 bg-surface-50 dark:bg-surface-900 rounded-lg border", defaultBorderMixin);
    $[14] = t5;
  } else {
    t5 = $[14];
  }
  let t6;
  if ($[15] !== conditionType) {
    t6 = CONDITION_TYPES.find((ct) => ct.id === conditionType)?.label;
    $[15] = conditionType;
    $[16] = t6;
  } else {
    t6 = $[16];
  ...
  let t7;
  if ($[17] !== t6) {
    t7 = /* @__PURE__ */ jsxs(Typography, { variant: "label", className: "font-medium text-primary", children: [
      t6,
      " when"
    ] });
    $[17] = t6;
  ...
  let t8;
  if ($[19] !== disabled || $[20] !== group.logic || $[21] !== group.rules.length || $[22] !== handleLogicChange) {
    t8 = group.rules.length > 1 && /* @__PURE__ */ jsxs(Select, { value: group.logic, onValueChange: (value) => handleLogicChange(value), disabled, size: "small", inputClassName: "min-w-[100px]", children: [
      /* @__PURE__ */ jsx(SelectItem, { value: "and", children: "All of these" }),
      /* @__PURE__ */ jsx(SelectItem, { value: "or", children: "Any of these" })
    ] });
    $[19] = disabled;
    $[20] = group.logic;
    $[21] = group.rules.length;
    $[22] = handleLogicChange;
    $[23] = t8;
  } else {
    t8 = $[23];
  }
  let t9;
  if ($[24] !== t7 || $[25] !== t8) {
    t9 = /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      t7,
      t8
    ] });
    $[24] = t7;
  ...
  if ($[27] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t10 = /* @__PURE__ */ jsx(DeleteIcon, { size: "smallest" });
    $[27] = t10;
  } else {
    t10 = $[27];
  }
  let t11;
  if ($[28] !== disabled || $[29] !== onRemove) {
    t11 = /* @__PURE__ */ jsx(IconButton, { onClick: onRemove, disabled, size: "small", variant: "ghost", children: t10 });
    $[28] = disabled;
    $[29] = onRemove;
    $[30] = t11;
  } else {
  ...
  let t12;
  if ($[31] !== t11 || $[32] !== t9) {
    t12 = /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
      t9,
      t11
    ] });
    $[31] = t11;
  ...
  let t13;
  if ($[34] !== availableFields || $[35] !== collectionProperties || $[36] !== disabled || $[37] !== group.logic || $[38] !== group.rules || $[39] !== handleRemoveRule || $[40] !== handleRuleChange || $[41] !== showErrors) {
    let t142;
    if ($[43] !== availableFields || $[44] !== collectionProperties || $[45] !== disabled || $[46] !== group.logic || $[47] !== group.rules.length || $[48] !== handleRemoveRule || $[49] !== handleRuleChange || $[50] !== showErrors) {
      t142 = (rule_0, index_1) => /* @__PURE__ */ jsxs(React__default.Fragment, { children: [
        index_1 > 0 && /* @__PURE__ */ jsx(Typography, { variant: "caption", className: "text-center text-secondary font-medium uppercase", children: group.logic === "and" ? "AND" : "OR" }),
        /* @__PURE__ */ jsx(ConditionRow, { rule: rule_0, onRuleChange: (newRule) => handleRuleChange(index_1, newRule), onRemove: () => handleRemoveRule(index_1), disabled, availableFields, collectionProperties, showErrors, showRemoveButton: group.rules.length > 1 })
      ] }, index_1);
      $[43] = availableFields;
      $[44] = collectionProperties;
      $[45] = disabled;
      $[46] = group.logic;
      $[47] = group.rules.length;
      $[48] = handleRemoveRule;
      $[49] = handleRuleChange;
      $[50] = showErrors;
      $[51] = t142;
  ...
  let t14;
  if ($[52] !== t13) {
    t14 = /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-2", children: t13 });
    $[52] = t13;
    $[53] = t14;
  } else {
    t14 = $[53];
  ...
  if ($[54] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t15 = cls("mt-3 w-full py-2 px-3 rounded-md text-sm", "border border-dashed text-secondary", "hover:bg-surface-100 dark:hover:bg-surface-800", "transition-colors", defaultBorderMixin);
    $[54] = t15;
  } else {
    t15 = $[54];
  }
  let t16;
  if ($[55] !== disabled || $[56] !== handleAddRule) {
    t16 = /* @__PURE__ */ jsx("button", { onClick: handleAddRule, disabled, type: "button", className: t15, children: "+ Add condition" });
    $[55] = disabled;
    $[56] = handleAddRule;
    $[57] = t16;
  } else {
  ...
  let t17;
  if ($[58] !== t12 || $[59] !== t14 || $[60] !== t16) {
    t17 = /* @__PURE__ */ jsxs("div", { className: t5, children: [
      t12,
      t14,
      t16
    ] });
...
function simpleRuleToJsonLogic(rule) {
  ...
  if (rule.operator === "!in") {
    return {
      "!": {
        "in": [fieldVar, parsedValue]
      }
    };
  }
  return {
    [rule.operator]: [fieldVar, parsedValue]
  };
}
function jsonLogicToSimpleRule(jsonLogic) {
  try {
...
function groupToJsonLogic(group) {
  const ruleLogics = group.rules.filter((rule) => rule.field && rule.operator).map((rule) => simpleRuleToJsonLogic(rule));
  const groupLogics = (group.groups || []).map((g) => groupToJsonLogic(g));
  ...
  return {
    [group.logic]: allLogics
  };
}
function jsonLogicToGroup(jsonLogic) {
  try {
    const operator = Object.keys(jsonLogic)[0];
      ...
      if (Array.isArray(args)) {
        ...
        for (const arg of args) {
          ...
          if (nestedOperator === "and" || nestedOperator === "or") {
            ...
            const rule2 = jsonLogicToSimpleRule(arg);
            if (rule2) {
              rules.push(rule2);
            }
          }
...
function ConditionsEditor(t0) {
  ...
  let t1;
  if ($[0] !== collectionProperties) {
    t1 = collectionProperties ? getPropertyPaths(collectionProperties) : [];
    $[0] = collectionProperties;
    $[1] = t1;
  } else {
    t1 = $[1];
  }
  const availableFields = t1;
  let t2;
  if ($[2] !== values) {
    t2 = values.conditions ?? {};
    $[2] = values;
    $[3] = t2;
  } else {
    t2 = $[3];
  ...
  if ($[4] !== conditions) {
    ...
    for (const type of CONDITION_TYPES) {
      const jsonLogic = conditions[type.id];
      if (jsonLogic) {
        console.log(`[ConditionsEditor] Parsing ${type.id}:`, jsonLogic);
        const group = jsonLogicToGroup(jsonLogic);
  ...
  let t3;
  if ($[6] !== availableFields[0] || $[7] !== setFieldValue) {
    t3 = (conditionType) => {
      const defaultRule = {
        field: availableFields[0] ?? "isNew",
        operator: "==",
      ...
      const jsonLogic_0 = groupToJsonLogic(defaultGroup);
      setFieldValue(`conditions.${conditionType}`, jsonLogic_0);
    };
    $[6] = availableFields[0];
    $[7] = setFieldValue;
    $[8] = t3;
  ...
  const handleAddCondition = t3;
  let t4;
  if ($[9] !== setFieldValue) {
    t4 = (type_0, group_0) => {
      const jsonLogic_1 = groupToJsonLogic(group_0);
      setFieldValue(`conditions.${type_0}`, jsonLogic_1);
    };
    $[9] = setFieldValue;
    $[10] = t4;
  } else {
  ...
  const handleGroupChange = t4;
  let t5;
  if ($[11] !== conditions || $[12] !== setFieldValue) {
    t5 = (type_1) => {
      const newConditions = {
        ...conditions
      };
      delete newConditions[type_1];
      if (Object.keys(newConditions).length === 0) {
        setFieldValue("conditions", void 0);
      } else {
  ...
  const handleRemoveCondition = t5;
  let availableConditionTypes;
  let t6;
  let t7;
  let t8;
  let t9;
  if ($[14] !== activeConditions || $[15] !== availableFields || $[16] !== collectionProperties || $[17] !== conditions || $[18] !== disabled || $[19] !== handleAddCondition || $[20] !== handleGroupChange || $[21] !== handleRemoveCondition || $[22] !== submitCount) {
    let t102;
    if ($[28] !== conditions) {
      t102 = (ct) => !conditions[ct.id];
      $[28] = conditions;
      $[29] = t102;
    } else {
      t102 = $[29];
    }
    availableConditionTypes = CONDITION_TYPES.filter(t102);
    t6 = "flex flex-col gap-4";
    if ($[30] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t7 = /* @__PURE__ */ jsx(Typography, { variant: "caption", color: "secondary", children: "Add conditions to dynamically control this field based on other field values or user context." });
      $[30] = t7;
    } else {
      t7 = $[30];
    }
    if ($[31] !== activeConditions || $[32] !== availableFields || $[33] !== collectionProperties || $[34] !== disabled || $[35] !== handleGroupChange || $[36] !== handleRemoveCondition || $[37] !== submitCount) {
      t8 = activeConditions.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-3", children: activeConditions.map((t112) => {
        const {
          type: type_2,
          group: group_1
        } = t112;
        return /* @__PURE__ */ jsx(ConditionGroupRow, { conditionType: type_2, group: group_1, onGroupChange: (newGroup) => handleGroupChange(type_2, newGroup), onRemove: () => handleRemoveCondition(type_2), disabled, availableFields, collectionProperties, showErrors: submitCount > 0 }, type_2);
      }) });
      $[31] = activeConditions;
      $[32] = availableFields;
      $[33] = collectionProperties;
      $[34] = disabled;
      $[35] = handleGroupChange;
    ...
    t9 = availableConditionTypes.length > 0 && /* @__PURE__ */ jsx(Select, { value: "", onValueChange: (value) => handleAddCondition(value), disabled, size: "small", placeholder: "+ Add condition...", className: "w-full max-w-xs", children: availableConditionTypes.map(_temp4$3) });
    $[14] = activeConditions;
    $[15] = availableFields;
    $[16] = collectionProperties;
    $[17] = conditions;
    $[18] = disabled;
    $[19] = handleAddCondition;
    $[20] = handleGroupChange;
    $[21] = handleRemoveCondition;
    $[22] = submitCount;
    $[23] = availableConditionTypes;
    $[24] = t6;
    $[25] = t7;
    $[26] = t8;
    $[27] = t9;
  } else {
    availableConditionTypes = $[23];
    t6 = $[24];
    t7 = $[25];
    t8 = $[26];
    t9 = $[27];
  ...
  let t10;
  if ($[39] !== activeConditions.length || $[40] !== availableConditionTypes) {
    t10 = activeConditions.length === 0 && availableConditionTypes.length === 0 && /* @__PURE__ */ jsx(Typography, { variant: "caption", color: "disabled", className: "text-center py-4", children: "All condition types are configured." });
    $[39] = activeConditions.length;
    $[40] = availableConditionTypes;
    $[41] = t10;
  } else {
    t10 = $[41];
  }
  let t11;
  if ($[42] !== t10 || $[43] !== t6 || $[44] !== t7 || $[45] !== t8 || $[46] !== t9) {
...
function _temp4$3(ct_0) {
  return /* @__PURE__ */ jsx(SelectItem, { value: ct_0.id, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsx("span", { className: "font-medium", children: ct_0.label }),
    /* @__PURE__ */ jsx("span", { className: "text-xs text-surface-500", children: ct_0.description })
  ] }) }, ct_0.id);
}
...
function getPropertyAtPath(fieldPath, collectionProperties) {
  if (!collectionProperties) return void 0;
  const parts = fieldPath.split(".");
  let current = collectionProperties;
  let property;
...
function getCurrentPropertyEnumValues(values) {
...
function getFieldColor(fieldPath, collectionProperties) {
...
function getFieldEnumValues(property) {
  if (!property) return [];
  if (property.dataType === "string" && property.enumValues) {
    if (Array.isArray(property.enumValues)) {
      return property.enumValues;
...
function buildEnumFilterRule(config, conditionType, allEnumIds) {
  ...
  if (config.operator === "!!") {
    ...
    condition = {
      [config.operator]: [fieldVar, parsedValue]
    };
  }
  if (conditionType === "allowedEnumValues") {
    return {
      "if": [
        condition,
        arrayToObject(config.selectedEnumIds),
        // When true: only these
        arrayToObject(allEnumIds)
        // When false: all
      ]
    };
...
function objectToArray(obj) {
  ...
  if (obj && typeof obj === "object") {
    ...
    if (keys.length > 0 && keys.every((k) => !isNaN(Number(k)))) {
      return keys.sort((a, b) => Number(a) - Number(b)).map((k) => String(obj[k]));
    }
  }
  return [];
}
function parseEnumFilterRule(rule) {
  try {
...
function EnumConditionRow(t0) {
  ...
  let t5;
  let t6;
  if ($[0] !== availableFields || $[1] !== collectionProperties || $[2] !== conditionType || $[3] !== config || $[4] !== disabled || $[5] !== onConfigChange || $[6] !== onRemove || $[7] !== showErrors || $[8] !== showValueField) {
    ...
    isFieldMissing = !config.field;
    isValueMissing = showValueField && !config.value && config.value !== "0";
    const isEnumSelectionMissing = config.selectedEnumIds.length === 0;
    hasError = showErrors && (isFieldMissing || isValueMissing || isEnumSelectionMissing);
    const t72 = hasError ? "border-red-300 dark:border-red-700" : defaultBorderMixin;
    if ($[18] !== t72) {
      t5 = cls("p-3 bg-surface-50 dark:bg-surface-900 rounded-lg border", t72);
      $[18] = t72;
      $[19] = t5;
    } else {
      t5 = $[19];
    ...
    let t82;
    if ($[20] !== conditionType) {
      t82 = ENUM_CONDITION_TYPES.find((ct) => ct.id === conditionType)?.label;
      $[20] = conditionType;
      $[21] = t82;
    } else {
      t82 = $[21];
    ...
    let t92;
    if ($[22] !== t82) {
      t92 = /* @__PURE__ */ jsxs(Typography, { variant: "label", className: "font-medium text-primary", children: [
        t82,
        " when"
      ] });
      $[22] = t82;
    ...
    let t102;
    if ($[24] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t102 = /* @__PURE__ */ jsx(DeleteIcon, { size: "smallest" });
      $[24] = t102;
    } else {
      t102 = $[24];
    }
    let t112;
    if ($[25] !== disabled || $[26] !== onRemove) {
      t112 = /* @__PURE__ */ jsx(IconButton, { onClick: onRemove, disabled, size: "small", variant: "ghost", children: t102 });
      $[25] = disabled;
      $[26] = onRemove;
      $[27] = t112;
    } else {
    ...
    if ($[28] !== t112 || $[29] !== t92) {
      t6 = /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-2", children: [
        t92,
        t112
      ] });
      $[28] = t112;
    ...
    t1 = "flex items-center gap-2 mb-3";
    const t122 = config.field;
    let t132;
    if ($[31] !== config || $[32] !== onConfigChange) {
      t132 = (value) => onConfigChange({
        ...config,
        field: value,
        value: ""
      });
    ...
    if ($[34] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t142 = CONTEXT_FIELDS.map(_temp$9);
      $[34] = t142;
    } else {
      t142 = $[34];
    }
    let t152;
    if ($[35] !== availableFields.length) {
      t152 = availableFields.length > 0 && /* @__PURE__ */ jsx(SelectItem, { value: "_divider", disabled: true, children: /* @__PURE__ */ jsx("span", { className: "text-xs text-surface-500", children: "─ Fields ─" }) });
      $[35] = availableFields.length;
      $[36] = t152;
    } else {
      t152 = $[36];
    }
    let t162;
    if ($[37] !== availableFields || $[38] !== collectionProperties) {
      let t172;
      if ($[40] !== collectionProperties) {
        t172 = (field_0) => /* @__PURE__ */ jsx(SelectItem, { value: field_0, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full", style: {
            backgroundColor: getFieldColor(field_0, collectionProperties)
          } }),
          /* @__PURE__ */ jsx("span", { children: field_0 })
        ] }) }, field_0);
        $[40] = collectionProperties;
        $[41] = t172;
      } else {
        t172 = $[41];
      }
      t162 = availableFields.map(t172);
      $[37] = availableFields;
      $[38] = collectionProperties;
      $[39] = t162;
    } else {
    ...
    if ($[42] !== config.field || $[43] !== disabled || $[44] !== t132 || $[45] !== t152 || $[46] !== t162) {
      t2 = /* @__PURE__ */ jsxs(Select, { value: t122, onValueChange: t132, disabled, size: "small", inputClassName: "min-w-[140px]", placeholder: "Field", children: [
        t142,
        t152,
        t162
      ] });
    ...
    const t17 = config.operator;
    let t18;
    if ($[48] !== config || $[49] !== onConfigChange) {
      t18 = (value_0) => onConfigChange({
        ...config,
        operator: value_0
      });
      $[48] = config;
    ...
    if ($[51] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t19 = OPERATORS.map(_temp2$5);
      $[51] = t19;
    } else {
      t19 = $[51];
    }
    if ($[52] !== config.operator || $[53] !== disabled || $[54] !== t18) {
      t3 = /* @__PURE__ */ jsx(Select, { value: t17, onValueChange: t18, disabled, size: "small", inputClassName: "min-w-[100px]", children: t19 });
      $[52] = config.operator;
      $[53] = disabled;
      $[54] = t18;
      $[55] = t3;
    ...
    t4 = showValueField && (isBoolean ? /* @__PURE__ */ jsx(BooleanSwitchWithLabel, { value: config.value === "true", size: "small", position: "start", disabled, onValueChange: (v) => onConfigChange({
      ...config,
      value: v ? "true" : "false"
    }) }) : fieldEnumValues.length > 0 ? /* @__PURE__ */ jsx(Select, { value: config.value, onValueChange: (value_1) => onConfigChange({
      ...config,
      value: value_1
    }), disabled, size: "small", placeholder: "Select value...", className: "min-w-[120px]", children: fieldEnumValues.map(_temp3$4) }) : /* @__PURE__ */ jsx(DebouncedTextField, { value: config.value, onChange: (e) => onConfigChange({
      ...config,
      value: e.target.value
    }), disabled, size: "small", placeholder: "Value", className: "flex-1 min-w-[80px]" }));
    $[0] = availableFields;
    $[1] = collectionProperties;
    $[2] = conditionType;
    $[3] = config;
  ...
  const t8 = conditionType === "allowedEnumValues" ? "Show only:" : "Hide:";
  let t9;
  if ($[61] !== t8) {
    t9 = /* @__PURE__ */ jsx(Typography, { variant: "caption", color: "secondary", className: "block mb-2", children: t8 });
    $[61] = t8;
    $[62] = t9;
  } else {
    t9 = $[62];
  }
  const t10 = config.selectedEnumIds;
  let t11;
  if ($[63] !== config || $[64] !== onConfigChange) {
    t11 = (values) => onConfigChange({
      ...config,
  ...
  let t12;
  if ($[66] !== propertyEnumValues) {
    t12 = propertyEnumValues.map(_temp4$2);
    $[66] = propertyEnumValues;
    $[67] = t12;
  } else {
    t12 = $[67];
  }
  let t13;
  if ($[68] !== config.selectedEnumIds || $[69] !== disabled || $[70] !== t11 || $[71] !== t12) {
    t13 = /* @__PURE__ */ jsx(MultiSelect, { value: t10, onValueChange: t11, disabled, size: "small", placeholder: "Select values...", useChips: true, children: t12 });
    $[68] = config.selectedEnumIds;
    $[69] = disabled;
    $[70] = t11;
    $[71] = t12;
    $[72] = t13;
  ...
  let t15;
  if ($[76] !== hasError || $[77] !== isFieldMissing || $[78] !== isValueMissing) {
    t15 = hasError && /* @__PURE__ */ jsx(Typography, { variant: "caption", className: "mt-2 text-red-500 dark:text-red-400", children: isFieldMissing ? "Please select a field for this condition" : isValueMissing ? "Please enter a value for this condition" : "Please select at least one value to filter" });
    $[76] = hasError;
    $[77] = isFieldMissing;
    $[78] = isValueMissing;
    $[79] = t15;
  ...
  let t16;
  if ($[80] !== t14 || $[81] !== t15 || $[82] !== t5 || $[83] !== t6 || $[84] !== t7) {
    t16 = /* @__PURE__ */ jsxs("div", { className: t5, children: [
      t6,
      t7,
      t14,
      t15
...
function _temp4$2(ev_0) {
  return /* @__PURE__ */ jsx(MultiSelectItem, { value: String(ev_0.id), children: ev_0.label }, String(ev_0.id));
}
function _temp3$4(ev) {
  return /* @__PURE__ */ jsx(SelectItem, { value: String(ev.id), children: ev.label }, String(ev.id));
}
function _temp2$5(op_0) {
  return /* @__PURE__ */ jsx(SelectItem, { value: op_0.id, children: op_0.label }, op_0.id);
}
function _temp$9(field) {
  return /* @__PURE__ */ jsx(SelectItem, { value: field.id, children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
    /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full", style: {
      backgroundColor: field.color
    } }),
...
function EnumConditionsEditor(t0) {
  const $ = c(45);
  const {
    disabled,
    collectionProperties
  ...
  const availableFields = t1;
  let propertyEnumValues;
  let t2;
  let t3;
  if ($[2] !== values) {
    t3 = /* @__PURE__ */ Symbol.for("react.early_return_sentinel");
    bb0: {
      propertyEnumValues = getCurrentPropertyEnumValues(values);
      if (propertyEnumValues.length === 0) {
        t3 = null;
        break bb0;
      }
      t2 = propertyEnumValues.map(_temp5$1);
    }
    $[2] = values;
    $[3] = propertyEnumValues;
    $[4] = t2;
    $[5] = t3;
  } else {
    propertyEnumValues = $[3];
    t2 = $[4];
    t3 = $[5];
  }
  ...
  let t5;
  if ($[10] !== allEnumIds || $[11] !== availableFields[0] || $[12] !== setFieldValue) {
    t5 = (conditionType) => {
      const defaultConfig = {
        field: availableFields[0] ?? "isNew",
        operator: "==",
      ...
      const rule_0 = buildEnumFilterRule(defaultConfig, conditionType, allEnumIds);
      setFieldValue(`conditions.${conditionType}`, rule_0);
    };
    $[10] = allEnumIds;
    $[11] = availableFields[0];
    $[12] = setFieldValue;
    $[13] = t5;
  } else {
    t5 = $[13];
  }
  const handleAddCondition = t5;
  let t6;
  if ($[14] !== allEnumIds || $[15] !== setFieldValue) {
    t6 = (type_0, config_0) => {
      const rule_1 = buildEnumFilterRule(config_0, type_0, allEnumIds);
      setFieldValue(`conditions.${type_0}`, rule_1);
    };
    $[14] = allEnumIds;
    $[15] = setFieldValue;
    $[16] = t6;
  ...
  const handleConfigChange = t6;
  let t7;
  if ($[17] !== conditions || $[18] !== setFieldValue) {
    t7 = (type_1) => {
      const newConditions = {
        ...conditions
      };
  ...
  const handleRemoveCondition = t7;
  let t8;
  if ($[20] !== activeConditions || $[21] !== availableFields || $[22] !== collectionProperties || $[23] !== conditions || $[24] !== disabled || $[25] !== handleAddCondition || $[26] !== handleConfigChange || $[27] !== handleRemoveCondition || $[28] !== propertyEnumValues || $[29] !== submitCount) {
    let t9;
    if ($[31] !== conditions) {
      t9 = (ct) => !conditions[ct.id];
      $[31] = conditions;
      $[32] = t9;
    } else {
      t9 = $[32];
    }
    const availableConditionTypes = ENUM_CONDITION_TYPES.filter(t9);
    let t10;
    let t11;
    let t12;
    if ($[33] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t10 = cls("flex flex-col gap-4 mt-4 pt-4 border-t", defaultBorderMixin);
      t11 = /* @__PURE__ */ jsx(Typography, { variant: "label", className: "font-medium", children: "Enum Value Conditions" });
      t12 = /* @__PURE__ */ jsx(Typography, { variant: "caption", color: "secondary", children: "Dynamically filter which options are available." });
      $[33] = t10;
      $[34] = t11;
      $[35] = t12;
    } else {
    ...
    let t13;
    if ($[36] !== activeConditions || $[37] !== availableFields || $[38] !== collectionProperties || $[39] !== disabled || $[40] !== handleConfigChange || $[41] !== handleRemoveCondition || $[42] !== propertyEnumValues || $[43] !== submitCount) {
      t13 = activeConditions.length > 0 && /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-3", children: activeConditions.map((t14) => {
        const {
          type: type_2,
          config: config_1
        } = t14;
        return /* @__PURE__ */ jsx(EnumConditionRow, { conditionType: type_2, config: config_1, onConfigChange: (newConfig) => handleConfigChange(type_2, newConfig), onRemove: () => handleRemoveCondition(type_2), disabled, availableFields, collectionProperties, propertyEnumValues, showErrors: submitCount > 0 }, type_2);
      }) });
      $[36] = activeConditions;
      $[37] = availableFields;
      $[38] = collectionProperties;
      $[39] = disabled;
      $[40] = handleConfigChange;
      $[41] = handleRemoveCondition;
      $[42] = propertyEnumValues;
      $[43] = submitCount;
      $[44] = t13;
    } else {
      t13 = $[44];
    }
    t8 = /* @__PURE__ */ jsxs("div", { className: t10, children: [
      t11,
      t12,
      t13,
      availableConditionTypes.length > 0 && /* @__PURE__ */ jsx(Select, { value: "", onValueChange: (value) => handleAddCondition(value), disabled, size: "small", placeholder: "+ Add enum condition...", className: "w-full max-w-xs", children: availableConditionTypes.map(_temp6) })
    ] });
    $[20] = activeConditions;
    $[21] = availableFields;
    $[22] = collectionProperties;
    $[23] = conditions;
    $[24] = disabled;
    $[25] = handleAddCondition;
    $[26] = handleConfigChange;
    $[27] = handleRemoveCondition;
    $[28] = propertyEnumValues;
    $[29] = submitCount;
    $[30] = t8;
  } else {
    t8 = $[30];
...
function _temp6(ct_0) {
  return /* @__PURE__ */ jsx(SelectItem, { value: ct_0.id, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
    /* @__PURE__ */ jsx("span", { className: "font-medium", children: ct_0.label }),
    /* @__PURE__ */ jsx("span", { className: "text-xs text-surface-500", children: ct_0.description })
  ] }) }, ct_0.id);
}
function _temp5$1(ev) {
  return String(ev.id);
}
function KeyValuePropertyField(t0) {
  ...
  let t1;
  if ($[0] !== disabled) {
    t1 = /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(ValidationPanel, { children: /* @__PURE__ */ jsx(GeneralPropertyValidation, { disabled }) }) }) });
    $[0] = disabled;
    $[1] = t1;
  } else {
    t1 = $[1];
...
function UrlPropertyField(t0) {
  ...
  if ($[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    ...
    t7 = /* @__PURE__ */ jsx(SelectItem, { value: "audio", children: "Audio" });
    $[4] = t4;
    $[5] = t5;
    $[6] = t6;
    $[7] = t7;
  ...
  if ($[8] !== disabled || $[9] !== t2 || $[10] !== t3) {
    t8 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsxs(Select, { disabled, position: "item-aligned", fullWidth: true, onValueChange: t2, label: "Preview type", renderValue: _temp$8, value: t3, children: [
      t4,
      t5,
      t6,
      t7
  ...
  let t9;
  if ($[12] !== disabled || $[13] !== showErrors) {
    t9 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(ValidationPanel, { children: /* @__PURE__ */ jsx(StringPropertyValidation, { disabled, max: true, min: true, trim: true, showErrors }) }) });
    $[12] = disabled;
    $[13] = showErrors;
    $[14] = t9;
  } else {
  ...
  let t12;
  if ($[19] !== disabled || $[20] !== t10 || $[21] !== t11) {
    t12 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(TextField, { name: "defaultValue", disabled, onChange: t10, label: "Default value", value: t11 }) });
    $[19] = disabled;
    $[20] = t10;
    $[21] = t11;
    $[22] = t12;
...
function MarkdownPropertyField(t0) {
  ...
  let t8;
  let t9;
  if ($[4] !== disabled || $[5] !== fileNameValue || $[6] !== setFieldValue || $[7] !== showErrors || $[8] !== storagePathValue || $[9] !== values) {
    const maxSizeValue = getIn(values, maxSize);
    let t162;
    if ($[25] !== values) {
      t162 = getIn(values, "markdown");
      $[25] = values;
      $[26] = t162;
    } else {
      t162 = $[26];
    }
    const markdownValue = t162;
    ...
    const updateMarkdownConfig = t172;
    if ($[30] !== disabled || $[31] !== showErrors) {
      t14 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(ValidationPanel, { children: /* @__PURE__ */ jsx(StringPropertyValidation, { disabled, length: true, lowercase: true, max: true, min: true, trim: true, uppercase: true, showErrors }) }) });
      $[30] = disabled;
      $[31] = showErrors;
      $[32] = t14;
    } else {
    ...
    let t182;
    if ($[33] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t182 = /* @__PURE__ */ jsxs("div", { className: "flex flex-row text-surface-500", children: [
        /* @__PURE__ */ jsx(SettingsIcon, {}),
        /* @__PURE__ */ jsx(Typography, { variant: "subtitle2", className: "ml-4", children: "Paste behavior" })
      ] });
      $[33] = t182;
    } else {
      t182 = $[33];
    }
    const t192 = !htmlValue;
    let t202;
    if ($[34] !== updateMarkdownConfig) {
      t202 = (value_0) => updateMarkdownConfig("html", !value_0);
      $[34] = updateMarkdownConfig;
      $[35] = t202;
    } else {
      t202 = $[35];
    }
    let t212;
    if ($[36] !== disabled || $[37] !== t192 || $[38] !== t202) {
      t212 = /* @__PURE__ */ jsx(BooleanSwitchWithLabel, { size: "small", disabled, value: t192, onValueChange: t202, label: "Strip HTML on paste" });
      $[36] = disabled;
      $[37] = t192;
      $[38] = t202;
      $[39] = t212;
    ...
    if ($[40] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t222 = /* @__PURE__ */ jsx(Typography, { variant: "caption", className: "ml-3.5 mt-1 mb-2", children: "Remove HTML tags and inline styles when pasting content from external sources" });
      $[40] = t222;
    } else {
      t222 = $[40];
    }
    let t232;
    if ($[41] !== updateMarkdownConfig) {
      t232 = (value_1) => updateMarkdownConfig("transformPastedText", value_1);
      $[41] = updateMarkdownConfig;
      $[42] = t232;
    } else {
      t232 = $[42];
    }
    let t242;
    if ($[43] !== disabled || $[44] !== t232 || $[45] !== transformPastedTextValue) {
      t242 = /* @__PURE__ */ jsx(BooleanSwitchWithLabel, { size: "small", disabled, value: transformPastedTextValue, onValueChange: t232, label: "Convert pasted text to markdown" });
      $[43] = disabled;
      $[44] = t232;
      $[45] = transformPastedTextValue;
      $[46] = t242;
    } else {
      t242 = $[46];
    }
    let t252;
    if ($[47] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t252 = /* @__PURE__ */ jsx(Typography, { variant: "caption", className: "ml-3.5 mt-1 mb-2", children: "Convert rich text (from Google Docs, Word, etc.) to clean markdown format" });
      $[47] = t252;
    } else {
      t252 = $[47];
    }
    if ($[48] !== t212 || $[49] !== t242) {
      t15 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(ExpandablePanel, { title: t182, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2 p-4", children: [
        t212,
        t222,
        t242,
        t252
    ...
    const t26 = hasFilenameCallback || disabled;
    const t27 = hasFilenameCallback ? "-" : fileNameValue;
    if ($[52] !== t26 || $[53] !== t27) {
      t10 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(Field, { name: fileName, as: DebouncedTextField, label: "File name", size: "small", disabled: t26, value: t27 }) });
      $[52] = t26;
      $[53] = t27;
      $[54] = t10;
    } else {
    ...
    const t28 = hasStoragePathCallback || disabled;
    const t29 = hasStoragePathCallback ? "-" : storagePathValue;
    let t30;
    if ($[55] !== t28 || $[56] !== t29) {
      t30 = /* @__PURE__ */ jsx(Field, { name: storagePath, as: DebouncedTextField, label: "Storage path", disabled: t28, size: "small", value: t29 });
      $[55] = t28;
      $[56] = t29;
      $[57] = t30;
    } else {
    ...
    if ($[58] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t31 = /* @__PURE__ */ jsxs(Typography, { variant: "caption", className: "ml-3.5 mt-1 mb-2", children: [
        /* @__PURE__ */ jsx("p", { children: "You can use the following placeholders in the file name and storage path values:" }),
        /* @__PURE__ */ jsxs("ul", { children: [
          /* @__PURE__ */ jsx("li", { children: "{file} - Full name of the uploaded file" }),
          /* @__PURE__ */ jsx("li", { children: "{file.name} - Name of the uploaded file without extension" }),
      ...
      t32 = /* @__PURE__ */ jsx(Typography, { variant: "caption", className: "ml-3.5 mt-1 mb-2", children: "When using Markdown, the URL of the uploaded files are always saved in the text value (not the path)." });
      $[58] = t31;
      $[59] = t32;
    } else {
      t31 = $[58];
  ...
  if ($[62] !== setFieldValue) {
    t16 = (e) => {
      ...
      if (value_2 === "") {
        ...
        setFieldValue(maxSize, parseInt(value_2));
      }
    };
    $[62] = setFieldValue;
    $[63] = t16;
  ...
  let t17;
  if ($[64] !== T0 || $[65] !== t16 || $[66] !== t3 || $[67] !== t4 || $[68] !== t5 || $[69] !== t6 || $[70] !== t7) {
    t17 = /* @__PURE__ */ jsx(T0, { name: t3, type: t4, label: t5, size: t6, value: t7, onChange: t16 });
    $[64] = T0;
    $[65] = t16;
    $[66] = t3;
    $[67] = t4;
  ...
  let t18;
  if ($[72] !== t17 || $[73] !== t8) {
    t18 = /* @__PURE__ */ jsx("div", { className: t8, children: t17 });
    $[72] = t17;
    $[73] = t8;
    $[74] = t18;
  } else {
  ...
  let t19;
  if ($[75] !== t10 || $[76] !== t11 || $[77] !== t18 || $[78] !== t9) {
    t19 = /* @__PURE__ */ jsxs("div", { className: t9, children: [
      t10,
      t11,
      t18
    ] });
  ...
  let t20;
  if ($[80] !== T1 || $[81] !== t12 || $[82] !== t19) {
    t20 = /* @__PURE__ */ jsx(T1, { title: t12, children: t19 });
    $[80] = T1;
    $[81] = t12;
    $[82] = t19;
    $[83] = t20;
  ...
  let t21;
  if ($[84] !== t13 || $[85] !== t20) {
    t21 = /* @__PURE__ */ jsx("div", { className: t13, children: t20 });
    $[84] = t13;
    $[85] = t20;
    $[86] = t21;
  } else {
  ...
  let t24;
  if ($[91] !== disabled || $[92] !== t22 || $[93] !== t23) {
    t24 = /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(TextField, { name: "defaultValue", disabled, onChange: t22, label: "Default value", value: t23 }) });
    $[91] = disabled;
    $[92] = t22;
    $[93] = t23;
    $[94] = t24;
  ...
  let t25;
  if ($[95] !== t14 || $[96] !== t15 || $[97] !== t21 || $[98] !== t24) {
...
const PropertyForm = React__default.memo(function PropertyForm2(props) {
  ...
  const lastSubmittedProperty = useRef(t4);
  let t5;
  if ($[7] !== onPropertyChanged || $[8] !== propertyNamespace) {
    t5 = (t62) => {
      const {
        id,
        property: property_0
  ...
  let t8;
  if ($[16] !== existingPropertyKeys || $[17] !== includeIdAndName || $[18] !== propertyKey) {
    t8 = (values) => {
      const errors = {};
      if (includeIdAndName) {
        if (!values.name) {
        ...
        if (!values.id) {
          ...
          const idError = validateId$1(values.id, keysToCheck);
          if (idError) {
            errors.id = idError;
          }
        }
      ...
      if (conditions) {
        ...
        const isIncompleteRule = (rule) => {
          if (!rule || typeof rule !== "object") {
            return false;
          }
          const ruleStr = JSON.stringify(rule);
          if (ruleStr.includes("values._placeholder")) {
            return true;
          }
          if (Object.keys(rule).some(_temp$7)) {
            return true;
          }
          for (const key_0 of Object.keys(rule)) {
            if (typeof rule[key_0] === "object" && isIncompleteRule(rule[key_0])) {
              return true;
            }
          }
          return false;
        ...
        for (const type of conditionTypes) {
          const rule_0 = conditions[type];
          if (rule_0 && isIncompleteRule(rule_0)) {
        ...
        for (const enumType of ["allowedEnumValues", "excludedEnumValues"]) {
          const rule_1 = conditions[enumType];
          if (rule_1 && typeof rule_1 === "object" && rule_1.if) {
            if (isIncompleteRule(rule_1)) {
  ...
  let t9;
  if ($[20] !== initialErrors || $[21] !== t6 || $[22] !== t7 || $[23] !== t8) {
    t9 = {
  ...
  let t10;
  let t11;
  if ($[25] !== formexController || $[26] !== getController) {
    t10 = () => {
  ...
  let t14;
  if ($[29] !== allowDataInference || $[30] !== autoOpenTypeSelect || $[31] !== autoUpdateId || $[32] !== collectionEditable || $[33] !== collectionProperties || $[34] !== disabled || $[35] !== existingProperty || $[36] !== formexController || $[37] !== getData || $[38] !== inArray || $[39] !== includeIdAndName || $[40] !== onDelete || $[41] !== onDismiss || $[42] !== onError || $[43] !== propertyConfigs || $[44] !== propertyNamespace || $[45] !== t12 || $[46] !== t13) {
    t14 = /* @__PURE__ */ jsx(PropertyEditFormFields, { onPropertyChanged: t12, onDelete, includeIdAndTitle: includeIdAndName, propertyNamespace, onError, onDismiss, showErrors: t13, existing: existingProperty, autoUpdateId, inArray, autoOpenTypeSelect, disabled, getData, allowDataInference, propertyConfigs, collectionEditable, collectionProperties, ...formexController });
    $[29] = allowDataInference;
    $[30] = autoOpenTypeSelect;
    $[31] = autoUpdateId;
    $[32] = collectionEditable;
    $[33] = collectionProperties;
    $[34] = disabled;
    $[35] = existingProperty;
    $[36] = formexController;
  ...
  let t15;
  if ($[48] !== formexController || $[49] !== t14) {
    t15 = /* @__PURE__ */ jsx(Formex, { value: formexController, children: t14 });
    $[48] = formexController;
    $[49] = t14;
    $[50] = t15;
  } else {
  ...
  return t15;
}, (a, b) => a.getData === b.getData && a.propertyKey === b.propertyKey && a.propertyNamespace === b.propertyNamespace && a.includeIdAndName === b.includeIdAndName && a.autoOpenTypeSelect === b.autoOpenTypeSelect && a.autoUpdateId === b.autoUpdateId && a.existingPropertyKeys === b.existingPropertyKeys && a.existingProperty === b.existingProperty && equal(a.property, b.property));
function PropertyFormDialog(t0) {
  ...
  if ($[9] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    ...
    t4 = /* @__PURE__ */ jsx(DialogTitle, { hidden: true, children: "Property edit view" });
    $[9] = t3;
    $[10] = t4;
  } else {
    t3 = $[9];
  ...
  let t5;
  if ($[11] !== onOkClicked || $[12] !== onPropertyChanged) {
    t5 = (params) => {
      onPropertyChanged?.(params);
      onOkClicked?.();
    };
  ...
  let t6;
  if ($[14] !== collectionEditable || $[15] !== formProps || $[16] !== getData || $[17] !== onCancel || $[18] !== t5) {
    t6 = /* @__PURE__ */ jsx(DialogContent, { children: /* @__PURE__ */ jsx(PropertyForm, { ...formProps, onDismiss: onCancel, onPropertyChanged: t5, collectionEditable, onPropertyChangedImmediate: false, getController, getData }) });
    $[14] = collectionEditable;
    $[15] = formProps;
    $[16] = getData;
    $[17] = onCancel;
    $[18] = t5;
  ...
  let t8;
  if ($[22] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t8 = /* @__PURE__ */ jsx(Button, { type: "submit", children: "Ok" });
    $[22] = t8;
  } else {
    t8 = $[22];
  }
  let t9;
  if ($[23] !== t7) {
    t9 = /* @__PURE__ */ jsxs(DialogActions, { children: [
      t7,
      t8
    ] });
    $[23] = t7;
  ...
  let t10;
  if ($[25] !== t6 || $[26] !== t9) {
    t10 = /* @__PURE__ */ jsxs("form", { noValidate: true, autoComplete: "off", onSubmit: t3, children: [
      t4,
      t6,
      t9
    ] });
  ...
  let t11;
  if ($[28] !== t10 || $[29] !== t2) {
    t11 = /* @__PURE__ */ jsx(Dialog, { open: t2, maxWidth: "xl", fullWidth: true, children: t10 });
    $[28] = t10;
    $[29] = t2;
    $[30] = t11;
  } else {
...
function PropertyEditFormFields(t0) {
  ...
  let t2;
  if ($[0] !== values) {
    t2 = values?.dataType ? getFieldId(values) : void 0;
    $[0] = values;
    $[1] = t2;
  } else {
    t2 = $[1];
  }
  const [selectedFieldConfigId, setSelectedFieldConfigId] = useState(t2);
  const deferredValues = useDeferredValue(values);
  const nameFieldRef = useRef(null);
  const lastSubmittedProperty = useRef(values);
  let t3;
  if ($[2] !== errors || $[3] !== showErrors) {
  ...
  let t4;
  if ($[5] !== deferredValues || $[6] !== includeIdAndTitle || $[7] !== onPropertyChanged || $[8] !== propertyNamespace) {
    t4 = () => {
  ...
  let t5;
  if ($[10] !== deferredValues || $[11] !== includeIdAndTitle || $[12] !== propertyNamespace) {
    t5 = [deferredValues, includeIdAndTitle, propertyNamespace];
    $[10] = deferredValues;
    $[11] = includeIdAndTitle;
    $[12] = propertyNamespace;
    $[13] = t5;
  } else {
    t5 = $[13];
  }
  ...
  const t7 = values?.id;
  let t8;
  if ($[19] !== errors || $[20] !== propertyNamespace || $[21] !== t7) {
    t8 = [errors, propertyNamespace, t7];
    $[19] = errors;
    $[20] = propertyNamespace;
    $[21] = t7;
    $[22] = t8;
  } else {
    t8 = $[22];
  ...
  useEffect(t6, t8);
  let t9;
  if ($[23] !== propertyConfigs || $[24] !== setValues || $[25] !== values) {
  ...
  if (selectedFieldConfigId === "text_field" || selectedFieldConfigId === "multiline" || selectedFieldConfigId === "user_select" || selectedFieldConfigId === "email") {
    ...
    if (selectedFieldConfigId === "url") {
      let t102;
      if ($[31] !== disabled || $[32] !== showErrors) {
        t102 = /* @__PURE__ */ jsx(UrlPropertyField, { disabled, showErrors });
        $[31] = disabled;
        $[32] = showErrors;
        $[33] = t102;
      } else {
      ...
      if (selectedFieldConfigId === "markdown") {
        let t102;
        if ($[34] !== disabled || $[35] !== showErrors) {
          t102 = /* @__PURE__ */ jsx(MarkdownPropertyField, { disabled, showErrors });
          $[34] = disabled;
          $[35] = showErrors;
          $[36] = t102;
        } else {
        ...
        if (selectedFieldConfigId === "select" || selectedFieldConfigId === "number_select") {
          const t102 = !existing;
          let t112;
          if ($[37] !== allowDataInference || $[38] !== disabled || $[39] !== getData || $[40] !== propertyNamespace || $[41] !== showErrors || $[42] !== t102) {
            t112 = /* @__PURE__ */ jsx(EnumPropertyField, { multiselect: false, allowDataInference, updateIds: t102, disabled, getData, propertyNamespace, showErrors });
            $[37] = allowDataInference;
            $[38] = disabled;
            $[39] = getData;
            $[40] = propertyNamespace;
            $[41] = showErrors;
            $[42] = t102;
            $[43] = t112;
          } else {
          ...
          if (selectedFieldConfigId === "multi_select" || selectedFieldConfigId === "multi_number_select") {
            const t102 = !existing;
            let t112;
            if ($[44] !== allowDataInference || $[45] !== disabled || $[46] !== getData || $[47] !== propertyNamespace || $[48] !== showErrors || $[49] !== t102) {
              t112 = /* @__PURE__ */ jsx(EnumPropertyField, { multiselect: true, updateIds: t102, disabled, allowDataInference, getData, propertyNamespace, showErrors });
              $[44] = allowDataInference;
              $[45] = disabled;
              $[46] = getData;
              $[47] = propertyNamespace;
              $[48] = showErrors;
              $[49] = t102;
              $[50] = t112;
            } else {
  ...
  let t18;
  if ($[119] !== disabled || $[120] !== existing || $[121] !== onDelete || $[122] !== values?.id) {
  ...
  let t20;
  if ($[127] !== autoUpdateId || $[128] !== disabled || $[129] !== existing || $[130] !== includeIdAndTitle || $[131] !== showErrors) {
  ...
  let t22;
  if ($[135] !== collectionProperties || $[136] !== disabled) {
  ...
  let t23;
  if ($[138] !== childComponent || $[139] !== t20 || $[140] !== t21 || $[141] !== t22) {
  ...
  let t24;
  if ($[143] !== deleteDialogOpen || $[144] !== onDelete || $[145] !== propertyNamespace || $[146] !== values?.id) {
    t24 = onDelete && /* @__PURE__ */ jsx(ConfirmationDialog, { open: deleteDialogOpen, onAccept: () => onDelete(values?.id, propertyNamespace), onCancel: () => setDeleteDialogOpen(false), title: /* @__PURE__ */ jsx("div", { children: "Delete this property?" }), body: /* @__PURE__ */ jsxs("div", { children: [
      " This will ",
      /* @__PURE__ */ jsx("b", { children: "not delete any data" }),
      ", only modify the collection."
    ] }) });
    $[143] = deleteDialogOpen;
    $[144] = onDelete;
    $[145] = propertyNamespace;
    $[146] = values?.id;
    $[147] = t24;
  } else {
    t24 = $[147];
...
function WidgetSelectView(t0) {
  ...
  if ($[0] !== disabled || $[1] !== existing || $[2] !== inArray || $[3] !== initialProperty || $[4] !== onOpenChange || $[5] !== onValueChange || $[6] !== open || $[7] !== propertyConfigs || $[8] !== value) {
    ...
    const displayedWidgets = (inArray ? allSupportedFields.filter(_temp2$4) : allSupportedFields).map(_temp3$3).reduce(_temp4$1, {});
    const key_0 = value;
    ...
    let t72;
    if ($[17] !== baseProperty || $[18] !== propertyConfig_1 || $[19] !== propertyConfigs) {
      const baseFieldConfig = baseProperty && !isPropertyBuilder(baseProperty) ? getFieldConfig(baseProperty, propertyConfigs) : void 0;
      t72 = baseFieldConfig && propertyConfig_1 ? mergeDeep(baseFieldConfig, propertyConfig_1) : propertyConfig_1;
      $[17] = baseProperty;
      $[18] = propertyConfig_1;
      $[19] = propertyConfigs;
      $[20] = t72;
    ...
    const groups = [...new Set(Object.keys(displayedWidgets).map(_temp5))];
    let t82;
    if ($[21] !== disabled || $[22] !== onOpenChange || $[23] !== open || $[24] !== value) {
      t82 = () => {
        if (!disabled) {
    ...
    const t92 = disabled ? fieldBackgroundDisabledMixin : fieldBackgroundHoverMixin;
    let t10;
    if ($[26] !== t92) {
      t10 = cls("select-none rounded-md text-sm p-4", fieldBackgroundMixin, t92, "relative flex items-center");
      $[26] = t92;
      $[27] = t10;
    } else {
      t10 = $[27];
    ...
    let t11;
    if ($[28] !== value) {
      t11 = !value && /* @__PURE__ */ jsx("em", { children: "Select a property widget" });
      $[28] = value;
      $[29] = t11;
    } else {
      t11 = $[29];
    ...
    let t12;
    if ($[30] !== computedFieldConfig || $[31] !== value) {
      t12 = value && computedFieldConfig && /* @__PURE__ */ jsxs("div", { className: cls("flex items-center"), children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-start text-base text-left", children: [
          ...
          /* @__PURE__ */ jsx(Typography, { variant: "caption", color: "secondary", children: computedFieldConfig.description })
        ] })
      ] });
      $[30] = computedFieldConfig;
      $[31] = value;
      $[32] = t12;
    } else {
      t12 = $[32];
    }
    if ($[33] !== t10 || $[34] !== t11 || $[35] !== t12 || $[36] !== t82) {
      t5 = /* @__PURE__ */ jsxs("div", { onClick: t82, className: t10, children: [
        t11,
        t12
      ] });
      $[33] = t10;
    ...
    T0 = DialogContent;
    t6 = /* @__PURE__ */ jsx("div", { children: groups.map((group_0) => /* @__PURE__ */ jsxs("div", { className: "mt-4", children: [
      /* @__PURE__ */ jsx(Typography, { variant: "label", children: group_0 }),
      /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-2 mt-4", children: Object.entries(displayedWidgets).map((t13) => {
        const [key_2, propertyConfig_2] = t13;
        const groupKey = WIDGET_TYPE_MAP[key_2];
        if (groupKey === group_0) {
          return /* @__PURE__ */ jsx(WidgetSelectViewItem, { initialProperty, onClick: () => {
            onValueChange(key_2);
  ...
  let t7;
  if ($[42] !== T0 || $[43] !== t6) {
    t7 = /* @__PURE__ */ jsx(T0, { children: t6 });
    $[42] = T0;
    $[43] = t6;
    $[44] = t7;
  } else {
  ...
  let t8;
  if ($[45] !== T1 || $[46] !== t1 || $[47] !== t2 || $[48] !== t3 || $[49] !== t4 || $[50] !== t7) {
    t8 = /* @__PURE__ */ jsxs(T1, { open: t1, onOpenChange: t2, maxWidth: t3, children: [
      t4,
      t7
    ] });
    $[45] = T1;
...
function WidgetSelectViewItem(t0) {
  ...
  let t2;
  if ($[1] !== propertyConfig || $[2] !== shouldWarnChangingDataType) {
    t2 = /* @__PURE__ */ jsx("div", { className: "mr-8", children: /* @__PURE__ */ jsx(PropertyConfigBadge, { propertyConfig, disabled: shouldWarnChangingDataType }) });
    $[1] = propertyConfig;
    $[2] = shouldWarnChangingDataType;
    $[3] = t2;
  } else {
    t2 = $[3];
  }
  ...
  let t6;
  if ($[9] !== t3 || $[10] !== t5) {
    t6 = /* @__PURE__ */ jsxs("div", { className: "flex flex-row gap-2 items-center", children: [
      t3,
      t5
    ] });
    $[9] = t3;
  ...
  let t7;
  if ($[12] !== propertyConfig.description) {
    t7 = /* @__PURE__ */ jsx(Typography, { variant: "caption", color: "secondary", className: "max-w-sm", children: propertyConfig.description });
    $[12] = propertyConfig.description;
    $[13] = t7;
  } else {
    t7 = $[13];
  }
...
function KanbanConfigSection({
  ...
  return /* @__PURE__ */ jsxs("div", { className, ref: panelRef, children: [
    /* @__PURE__ */ jsx(Select, { name: "kanban.columnProperty", label: "Kanban Column Property", size: "large", fullWidth: true, position: "item-aligned", disabled: enumStringProperties.length === 0, error: columnPropertyMissing, value: kanbanConfig?.columnProperty ?? "", onValueChange: (v) => {
      if (v) {
    ...
    showCreateButton && /* @__PURE__ */ jsxs(Fragment, { children: [
      ...
      }, propertyKey: dialogPropertyKey, existingProperty: false, autoOpenTypeSelect: false, autoUpdateId: false, inArray: false, allowDataInference: false, propertyConfigs: customizationController.propertyConfigs, collectionEditable: true, existingPropertyKeys: Object.keys(values.properties ?? {}), onPropertyChanged: ({
        id,
        property
      }) => {
        const newProperties = {
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "col-span-12 mt-4", children: [
        (() => {
          ...
          return /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsx(Select, { name: "orderProperty", label: "Order Property", size: "large", fullWidth: true, position: "item-aligned", disabled: numberProperties.length === 0, error: orderPropertyMissing, value: values.orderProperty ?? "", onValueChange: (v) => {
        ...
        (() => {
          ...
          return /* @__PURE__ */ jsxs(Fragment, { children: [
            /* @__PURE__ */ jsxs("button", { type: "button", className: "ml-3.5 text-sm text-primary hover:text-primary-dark mt-2", onClick: () => setOrderPropertyDialogOpen(true), children: [
              '+ Create "',
              dialogPropertyKey,
              '" property'
            ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "col-span-12", children: /* @__PURE__ */ jsx(Select, { name: "defaultSize", size: "large", fullWidth: true, label: "Default row size", position: "item-aligned", onChange: handleChange, value: values.defaultSize ?? "", renderValue: (value_2) => value_2.toUpperCase(), children: ["xs", "s", "m", "l", "xl"].map((value_3) => /* @__PURE__ */ jsx(SelectItem, { value: value_3, children: value_3.toUpperCase() }, `size-select-${value_3}`)) }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "col-span-12", children: [
        /* @__PURE__ */ jsx(BooleanSwitchWithLabel, { position: "start", size: "large", label: values.inlineEditing === void 0 || values.inlineEditing ? "Data can be edited directly in the table view" : "Data can be edited only in the form view", onValueChange: (v_0) => setFieldValue("inlineEditing", v_0), value: values.inlineEditing === void 0 ? true : values.inlineEditing }),
        /* @__PURE__ */ jsx(FieldCaption, { children: "Allow editing data directly in the table view, without opening the form view." })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "col-span-12", children: [
        /* @__PURE__ */ jsx(BooleanSwitchWithLabel, { position: "start", size: "large", label: values.includeJsonView === void 0 || values.includeJsonView ? "Include JSON view" : "Do not include JSON view", onValueChange: (v_1) => setFieldValue("includeJsonView", v_1), value: values.includeJsonView === void 0 ? true : values.includeJsonView }),
        /* @__PURE__ */ jsx(FieldCaption, { children: "Include the JSON representation of the document." })
      ] })
    ] }),
...
function GetCodeDialog(t0) {
  ...
  let tsCode;
  if ($[0] !== collection) {
    const collectionData = collectionToCode({
      ...collection
    });
    tsCode = collection ? 'import { EntityCollection } from "@firecms/core";\n\nconst ' + (collection?.name ? camelCase(collection.name) : "my") + "Collection:EntityCollection = " + JSON5.stringify(collectionData, null, "	") : "No collection selected";
    t1 = collection ? JSON.stringify(collectionData, null, 2) : "No collection selected";
    $[0] = collection;
    $[1] = t1;
    $[2] = tsCode;
  } else {
  ...
  let t2;
  if ($[3] !== collection.name) {
    t2 = /* @__PURE__ */ jsxs(DialogTitle, { variant: "h6", children: [
      "Code for ",
      collection.name
    ] });
    $[3] = collection.name;
  ...
  if ($[5] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t3 = (v) => setFormat(v);
    t4 = /* @__PURE__ */ jsx(Tab, { value: "ts", children: "TypeScript" });
    t5 = /* @__PURE__ */ jsx(Tab, { value: "json", children: "JSON" });
    $[5] = t3;
    $[6] = t4;
    $[7] = t5;
  } else {
  ...
  let t6;
  if ($[8] !== format) {
    t6 = /* @__PURE__ */ jsxs(Tabs, { value: format, onValueChange: t3, children: [
      t4,
      t5
    ] });
    $[8] = format;
  ...
  let t7;
  if ($[10] !== t2 || $[11] !== t6) {
    t7 = /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between pr-6", children: [
      t2,
      t6
    ] });
    $[10] = t2;
  ...
  let t8;
  if ($[13] !== format) {
    t8 = format === "json" ? "Use this config to define the collection in JSON format." : /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  let t9;
  if ($[15] !== t8) {
    t9 = /* @__PURE__ */ jsx(Typography, { variant: "body2", className: "mb-4", children: t8 });
    $[15] = t8;
    $[16] = t9;
  } else {
    t9 = $[16];
  }
  const t10 = format === "ts" ? "typescript" : "json";
  let t11;
  if ($[17] !== code || $[18] !== t10) {
    t11 = /* @__PURE__ */ jsx(Highlight, { theme: themes.vsDark, code, language: t10, children: _temp$6 });
    $[17] = code;
    $[18] = t10;
    $[19] = t11;
  } else {
  ...
  let t12;
  if ($[20] !== t11 || $[21] !== t9) {
    t12 = /* @__PURE__ */ jsxs(DialogContent, { children: [
      t9,
      t11
    ] });
    $[20] = t11;
  ...
  let t13;
  if ($[23] !== code || $[24] !== snackbarController) {
    t13 = (e) => {
      e.stopPropagation();
      e.preventDefault();
  ...
  if ($[26] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t14 = /* @__PURE__ */ jsx(ContentCopyIcon, { size: "small" });
    $[26] = t14;
  } else {
    t14 = $[26];
  }
  let t15;
  if ($[27] !== t13) {
    t15 = /* @__PURE__ */ jsxs(Button, { variant: "text", size: "small", onClick: t13, children: [
      t14,
      "Copy to clipboard"
    ] });
    $[27] = t13;
  ...
  let t16;
  if ($[29] !== onOpenChange) {
    t16 = /* @__PURE__ */ jsx(Button, { onClick: () => onOpenChange(false), children: "Close" });
    $[29] = onOpenChange;
    $[30] = t16;
  } else {
    t16 = $[30];
  ...
  let t17;
  if ($[31] !== t15 || $[32] !== t16) {
    t17 = /* @__PURE__ */ jsxs(DialogActions, { children: [
      t15,
      t16
    ] });
    $[31] = t15;
  ...
  let t18;
  if ($[34] !== onOpenChange || $[35] !== open || $[36] !== t12 || $[37] !== t17 || $[38] !== t7) {
    t18 = /* @__PURE__ */ jsxs(Dialog, { open, onOpenChange, maxWidth: "4xl", children: [
      t7,
      t12,
      t17
    ] });
...
function _temp$6(t0) {
  ...
  return /* @__PURE__ */ jsx("pre", { style, className: "p-4 rounded text-sm", children: tokens.map((line, i) => /* @__PURE__ */ jsx("div", { ...getLineProps({
    line
    ...
    doCollectionInference(values).then((newCollection) => {
      ...
      const findNewPropertyKeys = (existingProps, newProps, namespace) => {
        ...
        for (const key of Object.keys(newProps)) {
          ...
          if (!existingProp) {
            keys.push(fullKey);
          } else if (typeof newProp === "object" && "dataType" in newProp && newProp.dataType === "map" && newProp.properties) {
            const existingMapProps = typeof existingProp === "object" && "dataType" in existingProp && existingProp.dataType === "map" ? existingProp.properties : void 0;
      ...
      const addNewPropertiesOnly = (existingProps_0, newProps_0) => {
        ...
        for (const key_0 of Object.keys(newProps_0)) {
          ...
          } else if (typeof existingProp_0 === "object" && "dataType" in existingProp_0 && existingProp_0.dataType === "map" && typeof newProp_0 === "object" && "dataType" in newProp_0 && newProp_0.dataType === "map" && newProp_0.properties) {
    ...
    /* @__PURE__ */ jsxs("div", { className: cls("bg-surface-50 dark:bg-surface-900", "p-4 md:p-8 pb-20 md:pb-20", "col-span-12 lg:col-span-5 h-full overflow-auto", !asDialog && "border-r " + defaultBorderMixin), children: [
      /* @__PURE__ */ jsxs("div", { className: "flex my-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-1 mt-2 flex flex-row gap-2", children: [
          ...
          /* @__PURE__ */ jsx(Tooltip, { title: "Add new property", asChild: true, children: /* @__PURE__ */ jsx(Button, { onClick: () => setNewPropertyDialogOpen(true), children: /* @__PURE__ */ jsx(AddIcon, {}) }) })
        ] })
      ] }),
      /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsx(PropertyTree, { className: "pl-8", inferredPropertyKeys, selectedPropertyKey: selectedPropertyKey ? getFullId(selectedPropertyKey, selectedPropertyNamespace) : void 0, properties: values.properties, additionalFields: values.additionalFields, propertiesOrder: usedPropertiesOrder, onPropertyClick, onPropertyMove, onPropertyRemove: isNewCollection || inferredPropertyKeys && inferredPropertyKeys.length > 0 ? deleteProperty : void 0, collectionEditable, errors }) }),
      /* @__PURE__ */ jsx(Button, { className: "mt-8 w-full", size: "large", onClick: () => setNewPropertyDialogOpen(true), startIcon: /* @__PURE__ */ jsx(AddIcon, {}), children: "Add new property" })
    ] }),
...
function UnsavedChangesDialog(t0) {
  ...
  let t4;
  if ($[5] !== body) {
    t4 = body && /* @__PURE__ */ jsx(Typography, { children: body });
    $[5] = body;
    $[6] = t4;
  } else {
    t4 = $[6];
  ...
  let t10;
  if ($[17] !== open || $[18] !== t1 || $[19] !== t3 || $[20] !== t6 || $[21] !== t9) {
    t10 = /* @__PURE__ */ jsxs(Dialog, { open, onOpenChange: t1, "aria-labelledby": "alert-dialog-title", "aria-describedby": "alert-dialog-description", children: [
      t3,
      t6,
      t9
    ] });
...
function EntityCustomViewsSelectDialog(t0) {
  ...
  let t2;
  if ($[1] !== entityViews || $[2] !== onClose) {
    t2 = entityViews?.map((view) => /* @__PURE__ */ jsxs(Button, { onClick: () => onClose(view.key), fullWidth: true, variant: "text", children: [
      view.name,
      " (",
      view.key,
      ")"
  ...
  let t5;
  if ($[9] !== onClose) {
    t5 = /* @__PURE__ */ jsx(DialogActions, { children: /* @__PURE__ */ jsx(Button, { onClick: () => onClose(), children: "Cancel" }) });
    $[9] = onClose;
    $[10] = t5;
  } else {
    t5 = $[10];
...
function SubcollectionsEditTab(t0) {
  ...
  const embedded = t1 === void 0 ? false : t1;
  const {
  ...
  let t2;
  if ($[0] !== collection.subcollections) {
    t2 = collection.subcollections ?? [];
    $[0] = collection.subcollections;
    $[1] = t2;
  } else {
    t2 = $[1];
  }
  const [subcollections, setSubcollections] = React__default.useState(t2);
  let T0;
  let T1;
  let T2;
  let t10;
  ...
  if ($[2] !== collection.entityViews || $[3] !== contextEntityViews || $[4] !== subcollections || $[5] !== values.entityViews || $[6] !== values.name) {
    const resolvedEntityViews = values.entityViews?.filter(_temp$5).map((e_0) => resolveEntityView(e_0, contextEntityViews)).filter(Boolean) ?? [];
    ...
    t9 = "flex flex-col gap-16";
    let t112;
    if ($[18] !== values.name) {
      t112 = /* @__PURE__ */ jsxs(Typography, { variant: "h6", children: [
        "Subcollections of ",
        values.name
      ] });
      $[18] = values.name;
    ...
    let t122;
    if ($[20] !== subcollections) {
      t122 = subcollections && subcollections.length > 0 && /* @__PURE__ */ jsx(Table, { children: /* @__PURE__ */ jsx(TableBody, { children: subcollections.map((subcollection) => /* @__PURE__ */ jsxs(TableRow, { onClick: () => setCurrentDialog({
        isNewCollection: false,
        editedCollectionId: subcollection.id
      }), children: [
        /* @__PURE__ */ jsx(TableCell, { align: "left", children: /* @__PURE__ */ jsx(Typography, { variant: "subtitle2", className: "flex-grow", children: subcollection.name }) }),
    ...
    let t132;
    if ($[22] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t132 = /* @__PURE__ */ jsx(Button, { onClick: () => {
        setCurrentDialog({
          isNewCollection: true
        });
      }, startIcon: /* @__PURE__ */ jsx(AddIcon, {}), children: "Add subcollection" });
      $[22] = t132;
    } else {
      t132 = $[22];
    }
    let t142;
    if ($[23] !== t122) {
      t142 = /* @__PURE__ */ jsxs(Paper, { className: "flex flex-col gap-4 p-2 w-full", children: [
        t122,
        t132
      ] });
      $[23] = t122;
    ...
    if ($[25] !== t112 || $[26] !== t142) {
      t10 = /* @__PURE__ */ jsxs("div", { className: "flex-grow flex flex-col gap-4 items-start", children: [
        t112,
        t142
      ] });
      $[25] = t112;
    ...
    t6 = "flex-grow  flex flex-col gap-4 items-start";
    if ($[28] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t7 = /* @__PURE__ */ jsx(Typography, { variant: "h6", children: "Custom views" });
      $[28] = t7;
    } else {
      t7 = $[28];
    }
    if ($[29] !== totalEntityViews) {
      t8 = totalEntityViews === 0 && /* @__PURE__ */ jsx(Alert, { action: /* @__PURE__ */ jsx(Button, { variant: "text", size: "small", href: "https://firecms.co/docs/cloud/quickstart", component: "a", rel: "noopener noreferrer", target: "_blank", children: "More info" }), children: "Define your own custom views by uploading them with the CLI." });
      $[29] = totalEntityViews;
      $[30] = t8;
    } else {
      t8 = $[30];
    ...
    T2 = Paper;
    t5 = "flex flex-col gap-4 p-2 w-full";
    T1 = Table;
    T0 = TableBody;
    let t152;
    if ($[31] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t152 = (view) => /* @__PURE__ */ jsxs(TableRow, { children: [
    ...
    t3 = resolvedEntityViews.map(t152);
    t4 = hardCodedEntityViews.map(_temp3$2);
    $[2] = collection.entityViews;
    $[3] = contextEntityViews;
    $[4] = subcollections;
    $[5] = values.entityViews;
    $[6] = values.name;
    $[7] = T0;
    $[8] = T1;
    $[9] = T2;
  ...
  if ($[39] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t13 = /* @__PURE__ */ jsx(Button, { onClick: () => {
      setAddEntityViewDialogOpen(true);
    }, startIcon: /* @__PURE__ */ jsx(AddIcon, {}), children: "Add custom entity view" });
    $[39] = t13;
  } else {
    t13 = $[39];
  }
  let t14;
  if ($[40] !== T2 || $[41] !== t12 || $[42] !== t5) {
    t14 = /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(T2, { className: t5, children: [
      t12,
      t13
    ] }) });
    $[40] = T2;
  ...
  let t15;
  if ($[44] !== t14 || $[45] !== t6 || $[46] !== t7 || $[47] !== t8) {
    t15 = /* @__PURE__ */ jsxs("div", { className: t6, children: [
      t7,
      t8,
      t14
    ] });
  ...
  let t16;
  if ($[49] !== t10 || $[50] !== t15 || $[51] !== t9) {
    t16 = /* @__PURE__ */ jsxs("div", { className: t9, children: [
      t10,
      t15
    ] });
    $[49] = t10;
  ...
  const content = t16;
  let t17;
  if ($[53] !== content || $[54] !== embedded) {
    t17 = embedded ? content : /* @__PURE__ */ jsxs("div", { className: "overflow-auto my-auto", children: [
      /* @__PURE__ */ jsx(Container, { maxWidth: "2xl", className: "flex flex-col gap-4 p-8 m-auto", children: content }),
      /* @__PURE__ */ jsx("div", { style: {
        height: "52px"
      } })
    ] });
  ...
  let t18;
  if ($[56] !== collection.id || $[57] !== configController || $[58] !== parentCollectionIds || $[59] !== subcollectionToDelete || $[60] !== subcollections) {
    t18 = subcollectionToDelete && /* @__PURE__ */ jsx(ConfirmationDialog, { open: Boolean(subcollectionToDelete), onAccept: () => {
      const props = {
    ...
    }, onCancel: () => setSubcollectionToDelete(void 0), title: /* @__PURE__ */ jsx(Fragment, { children: "Delete this subcollection?" }), body: /* @__PURE__ */ jsxs(Fragment, { children: [
      " This will ",
      /* @__PURE__ */ jsx("b", { children: "not delete any data" }),
    ...
    $[56] = collection.id;
    $[57] = configController;
    $[58] = parentCollectionIds;
    $[59] = subcollectionToDelete;
    $[60] = subcollections;
    $[61] = t18;
  } else {
    t18 = $[61];
  ...
  let t19;
  if ($[62] !== setFieldValue || $[63] !== values.entityViews || $[64] !== viewToDelete) {
    t19 = viewToDelete && /* @__PURE__ */ jsx(ConfirmationDialog, { open: Boolean(viewToDelete), onAccept: () => {
      setFieldValue("entityViews", values.entityViews?.filter((e_5) => e_5 !== viewToDelete));
      setViewToDelete(void 0);
    }, onCancel: () => setViewToDelete(void 0), title: /* @__PURE__ */ jsx(Fragment, { children: "Remove this view?" }), body: /* @__PURE__ */ jsxs(Fragment, { children: [
      "This will ",
      /* @__PURE__ */ jsx("b", { children: "not delete any data" }),
      ", only the view in the CMS"
    ] }) });
    $[62] = setFieldValue;
    $[63] = values.entityViews;
    $[64] = viewToDelete;
    $[65] = t19;
  } else {
    t19 = $[65];
  }
  const t20 = Boolean(currentDialog);
  let t21;
  if ($[66] !== parentCollectionIds) {
    t21 = parentCollectionIds ?? [];
    $[66] = parentCollectionIds;
    $[67] = t21;
  } else {
    t21 = $[67];
  }
  let t22;
  if ($[68] !== t21 || $[69] !== values.id) {
    t22 = [...t21, values.id];
    $[68] = t21;
    $[69] = values.id;
    $[70] = t22;
  ...
  let t23;
  if ($[71] !== subcollections) {
    t23 = (updatedCollection) => {
  ...
  let t24;
  if ($[73] !== collection || $[74] !== collectionInference || $[75] !== configController || $[76] !== currentDialog || $[77] !== getUser || $[78] !== t20 || $[79] !== t22 || $[80] !== t23) {
    t24 = /* @__PURE__ */ jsx(CollectionEditorDialog, { open: t20, configController, parentCollection: collection, collectionInference, parentCollectionIds: t22, isNewCollection: false, ...currentDialog, getUser, handleClose: t23 });
    $[73] = collection;
    $[74] = collectionInference;
    $[75] = configController;
    $[76] = currentDialog;
    $[77] = getUser;
    $[78] = t20;
  ...
  let t25;
  if ($[82] !== setFieldValue || $[83] !== values.entityViews) {
    t25 = (selectedViewKey) => {
      if (selectedViewKey) {
    ...
    $[82] = setFieldValue;
    $[83] = values.entityViews;
    $[84] = t25;
  } else {
    t25 = $[84];
  }
  let t26;
  if ($[85] !== addEntityViewDialogOpen || $[86] !== t25) {
    t26 = /* @__PURE__ */ jsx(EntityCustomViewsSelectDialog, { open: addEntityViewDialogOpen, onClose: t25 });
    $[85] = addEntityViewDialogOpen;
    $[86] = t25;
    $[87] = t26;
  } else {
    t26 = $[87];
  ...
  let t27;
  if ($[88] !== t17 || $[89] !== t18 || $[90] !== t19 || $[91] !== t24 || $[92] !== t26) {
    t27 = /* @__PURE__ */ jsxs(Fragment, { children: [
      t17,
      t18,
      t19,
      t24,
...
function _temp3$2(view_0) {
  return /* @__PURE__ */ jsx(TableRow, { children: /* @__PURE__ */ jsxs(TableCell, { align: "left", children: [
    ...
    /* @__PURE__ */ jsxs(Typography, { variant: "caption", className: "flex-grow", children: [
      ...
      /* @__PURE__ */ jsx("code", { children: view_0.key })
    ] })
  ] }) }, view_0.key);
}
...
function EntityActionsEditTab(t0) {
  ...
  if ($[0] !== collection.entityActions || $[1] !== contextEntityActions || $[2] !== values.entityActions) {
    const resolvedEntityActions = values.entityActions?.filter(_temp$4).map((e_0) => resolveEntityAction(e_0, contextEntityActions)).filter(Boolean) ?? [];
    const hardCodedEntityActions = collection.entityActions?.filter(_temp2$2) ?? [];
    ...
    if ($[13] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t6 = /* @__PURE__ */ jsx(Typography, { variant: "h6", children: "Custom actions" });
      $[13] = t6;
    } else {
      t6 = $[13];
    }
    if ($[14] !== totalEntityActions) {
      t7 = totalEntityActions === 0 && /* @__PURE__ */ jsx(Alert, { action: /* @__PURE__ */ jsx(Button, { variant: "text", size: "small", href: "https://firecms.co/docs/custom_actions", component: "a", rel: "noopener noreferrer", target: "_blank", children: "More info" }), children: "Define your own custom actions by uploading them with the CLI." });
      $[14] = totalEntityActions;
      $[15] = t7;
    } else {
      t7 = $[15];
    }
    ...
    let t92;
    if ($[16] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t92 = (action) => /* @__PURE__ */ jsxs(TableRow, { children: [
    ...
    t2 = resolvedEntityActions.map(t92);
    t3 = hardCodedEntityActions.map(_temp3$1);
  ...
  let t10;
  if ($[21] !== T1 || $[22] !== t9) {
    t10 = /* @__PURE__ */ jsx(T1, { children: t9 });
    $[21] = T1;
    $[22] = t9;
    $[23] = t10;
  } else {
  ...
  let t11;
  if ($[24] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t11 = /* @__PURE__ */ jsx(Button, { onClick: () => {
      setAddEntityActionDialogOpen(true);
    }, startIcon: /* @__PURE__ */ jsx(AddIcon, {}), children: "Add custom entity action" });
    $[24] = t11;
  } else {
    t11 = $[24];
  }
  let t12;
  if ($[25] !== T2 || $[26] !== t10 || $[27] !== t4) {
    t12 = /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs(T2, { className: t4, children: [
      t10,
      t11
    ] }) });
    $[25] = T2;
  ...
  let t13;
  if ($[29] !== t12 || $[30] !== t5 || $[31] !== t6 || $[32] !== t7) {
    t13 = /* @__PURE__ */ jsxs("div", { className: t5, children: [
      t6,
      t7,
      t12
    ] });
  ...
  let t14;
  if ($[34] !== t13 || $[35] !== t8) {
    t14 = /* @__PURE__ */ jsx("div", { className: t8, children: t13 });
    $[34] = t13;
    $[35] = t8;
    $[36] = t14;
  } else {
  ...
  const content = t14;
  let t15;
  if ($[37] !== content || $[38] !== embedded) {
    t15 = embedded ? content : /* @__PURE__ */ jsxs("div", { className: "overflow-auto my-auto", children: [
      /* @__PURE__ */ jsx(Container, { maxWidth: "2xl", className: "flex flex-col gap-4 p-8 m-auto", children: content }),
      /* @__PURE__ */ jsx("div", { style: {
        height: "52px"
      } })
  ...
  let t16;
  if ($[40] !== actionToDelete || $[41] !== setFieldValue || $[42] !== values.entityActions) {
    t16 = actionToDelete && /* @__PURE__ */ jsx(ConfirmationDialog, { open: Boolean(actionToDelete), onAccept: () => {
    ...
    $[40] = actionToDelete;
    $[41] = setFieldValue;
    $[42] = values.entityActions;
    $[43] = t16;
  } else {
    t16 = $[43];
  }
  let t17;
  if ($[44] !== contextEntityActions || $[45] !== setFieldValue || $[46] !== values.entityActions) {
    t17 = (selectedActionKey) => {
    ...
    $[44] = contextEntityActions;
    $[45] = setFieldValue;
    $[46] = values.entityActions;
    $[47] = t17;
  } else {
    t17 = $[47];
  }
  let t18;
  if ($[48] !== addEntityActionDialogOpen || $[49] !== t17) {
    t18 = /* @__PURE__ */ jsx(EntityActionsSelectDialog, { open: addEntityActionDialogOpen, onClose: t17 });
    $[48] = addEntityActionDialogOpen;
    $[49] = t17;
    $[50] = t18;
  } else {
    t18 = $[50];
...
function ExtendSettingsForm(t0) {
  const $ = c(18);
  const {
    collection,
    parentCollection,
  ...
  let t1;
  if ($[0] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t1 = /* @__PURE__ */ jsxs("div", { children: [
      /* @__PURE__ */ jsx(Typography, { variant: "h5", className: "flex-grow", children: "Extend" }),
      /* @__PURE__ */ jsx(Typography, { variant: "body2", color: "secondary", children: "Add subcollections, custom views, and entity actions to this collection." })
    ] });
    $[0] = t1;
  } else {
    t1 = $[0];
  ...
  let t2;
  if ($[1] !== collection || $[2] !== collectionInference || $[3] !== configController || $[4] !== getUser || $[5] !== parentCollection || $[6] !== parentCollectionIds) {
    t2 = /* @__PURE__ */ jsx(SubcollectionsEditTab, { collection, parentCollection, configController, collectionInference, getUser, parentCollectionIds, embedded: true });
    $[1] = collection;
  ...
  let t3;
  if ($[8] !== collection) {
    t3 = /* @__PURE__ */ jsx(EntityActionsEditTab, { collection, embedded: true });
    $[8] = collection;
    $[9] = t3;
  } else {
    t3 = $[9];
  ...
  let t4;
  if ($[10] !== isMergedCollection || $[11] !== onResetToCode) {
    t4 = isMergedCollection && onResetToCode && /* @__PURE__ */ jsxs("div", { className: cls("flex flex-col gap-4 mt-8 border-t pt-8", defaultBorderMixin), children: [
      ...
      /* @__PURE__ */ jsx(Button, { color: "neutral", onClick: onResetToCode, children: "Reset to code" })
    ] });
    $[10] = isMergedCollection;
    $[11] = onResetToCode;
    $[12] = t4;
  } else {
    t4 = $[12];
  ...
  if ($[14] !== t2 || $[15] !== t3 || $[16] !== t4) {
    t6 = /* @__PURE__ */ jsx("div", { className: "overflow-auto my-auto", children: /* @__PURE__ */ jsxs(Container, { maxWidth: "4xl", className: "flex flex-col gap-8 p-8 m-auto", children: [
      t1,
      t2,
      t3,
      t4,
...
function validateProperties(properties, path, errors) {
...
function validateOptionalFields(collection, errors) {
  const stringFields = ["singularName", "description", "group", "databaseId"];
  for (const field of stringFields) {
    if (collection[field] !== void 0 && typeof collection[field] !== "string") {
      errors.push({
        path: field,
        message: "Must be a string"
      });
  ...
  const booleanFields = ["collectionGroup", "textSearchEnabled", "selectionEnabled", "inlineEditing", "hideFromNavigation", "hideIdFromForm", "hideIdFromCollection", "formAutoSave", "editable", "alwaysApplyDefaultValues", "includeJsonView", "history"];
  for (const field of booleanFields) {
    if (collection[field] !== void 0 && typeof collection[field] !== "boolean") {
      errors.push({
        path: field,
  ...
  if (collection.icon !== void 0 && typeof collection.icon !== "string" && typeof collection.icon !== "object") {
    errors.push({
      path: "icon",
      message: "Must be a string (icon key) or object"
    });
  }
  if (collection.propertiesOrder !== void 0) {
    if (!Array.isArray(collection.propertiesOrder)) {
      errors.push({
        path: "propertiesOrder",
        message: "Must be an array of strings"
      });
    } else if (!collection.propertiesOrder.every((item) => typeof item === "string")) {
      errors.push({
        path: "propertiesOrder",
  ...
  if (collection.subcollections !== void 0) {
    if (!Array.isArray(collection.subcollections)) {
      ...
      collection.subcollections.forEach((sub, index) => {
        const subErrors = [];
  ...
  if (collection.defaultViewMode !== void 0) {
  ...
  if (collection.kanban !== void 0) {
    if (typeof collection.kanban !== "object" || collection.kanban === null) {
      errors.push({
        path: "kanban",
        message: "Must be an object"
      });
    } else if (collection.kanban.columnProperty !== void 0 && typeof collection.kanban.columnProperty !== "string") {
      errors.push({
...
function validateCollectionObject(collection, errors) {
  if (!collection.id) {
    errors.push({
      path: "id",
      message: "Required field is missing"
...
function validateCollectionJson(jsonString) {
  ...
  return {
    ...
    errors,
    collection: errors.length === 0 ? parsed : void 0
  };
}
const EXAMPLE_JSON = `{
  "id": "products",
...
class CollectionGenerationApiError extends Error {
  code;
...
const DEFAULT_COLLECTION_GENERATION_ENDPOINT = "https://api.firecms.co/collections/generate";
function buildCollectionGenerationCallback({
  getAuthToken,
  ...
  return async (request) => {
    ...
    if (!response.ok) {
      ...
      throw new CollectionGenerationApiError(errorData.error || "Failed to generate collection", errorData.code);
    }
...
function AICollectionGeneratorPopover({
  ...
  const defaultTrigger = showLabel ? /* @__PURE__ */ jsx(Button, { variant: "text", size, disabled: loading, startIcon: loading ? /* @__PURE__ */ jsx(CircularProgress, { size: "smallest" }) : /* @__PURE__ */ jsx(AIIcon, { size: "small" }), children: "AI Assist" }) : /* @__PURE__ */ jsx(IconButton, { size, disabled: loading, "aria-label": "AI Assist", children: loading ? /* @__PURE__ */ jsx(CircularProgress, { size: "smallest" }) : /* @__PURE__ */ jsx(AIIcon, { size: "small" }) });
...
function CollectionEditorImportMapping(t0) {
  ...
  let t11;
  if ($[22] !== collectionEditable || $[23] !== onPropertyChanged || $[24] !== property || $[25] !== propertyConfigs || $[26] !== propertyKey || $[27] !== t8) {
    t11 = /* @__PURE__ */ jsx(PropertyFormDialog, { open: t8, propertyKey, property, inArray: false, autoUpdateId: false, onPropertyChanged, allowDataInference: false, collectionEditable, onOkClicked: t9, onCancel: t10, autoOpenTypeSelect: false, existingProperty: false, propertyConfigs });
...
function PropertySelect(t0) {
  ...
  if ($[13] !== disabled || $[14] !== selectOpen || $[15] !== t5 || $[16] !== t6 || $[17] !== t7 || $[18] !== t8) {
    t10 = /* @__PURE__ */ jsx(Select, { open: selectOpen, onOpenChange: setSelectOpen, invisible: true, size: "large", className: "w-full", disabled, error: t5, fullWidth: true, value: t6, placeholder: "Select a property widget", position: "item-aligned", renderValue: t7, onValueChange: t8, children: t9 });
    $[13] = disabled;
    $[14] = selectOpen;
    $[15] = t5;
    $[16] = t6;
...
function CollectionEditorDialog(props) {
  ...
  let t5;
  if ($[9] !== handleCancel || $[10] !== open || $[11] !== props) {
    t5 = open && /* @__PURE__ */ jsx(CollectionEditor, { ...props, handleCancel, setFormDirty });
    $[9] = handleCancel;
    $[10] = open;
    $[11] = props;
    $[12] = t5;
  ...
  let t8;
  if ($[16] !== t6 || $[17] !== unsavedChangesDialogOpen) {
    t8 = /* @__PURE__ */ jsx(UnsavedChangesDialog, { open: unsavedChangesDialogOpen, handleOk: t6, handleCancel: t7, body: "There are unsaved changes in this collection" });
    $[16] = t6;
    $[17] = unsavedChangesDialogOpen;
    $[18] = t8;
  } else {
    t8 = $[18];
  }
  let t9;
  if ($[19] !== t5 || $[20] !== t8) {
    t9 = /* @__PURE__ */ jsxs(AIModifiedPathsProvider, { children: [
      t5,
      t8
    ] });
    $[19] = t5;
  ...
  let t10;
  if ($[22] !== open || $[23] !== t3 || $[24] !== t9) {
    t10 = /* @__PURE__ */ jsxs(Dialog, { open, fullWidth: true, fullHeight: true, scrollable: false, maxWidth: "7xl", onOpenChange: t3, children: [
      t4,
      t9
    ] });
    $[22] = open;
...
function CollectionEditorInternal({
  ...
  const doCollectionInference = collectionInference ? (collection_0) => {
    ...
    return collectionInference?.(collection_0.path, collection_0.collectionGroup ?? false, parentPaths ?? [], collection_0.databaseId, collection_0.initialFilter, collection_0.initialSort);
  } : void 0;
    ...
    /* @__PURE__ */ jsx(Formex, { value: formController, children: /* @__PURE__ */ jsxs(Fragment, { children: [
      !isNewCollection && /* @__PURE__ */ jsxs("div", { className: cls("px-4 py-2 w-full flex items-center justify-end gap-2 bg-surface-50 dark:bg-surface-950 border-b", defaultBorderMixin), children: [
        ...
        /* @__PURE__ */ jsxs(Tabs, { value: currentView, onValueChange: (v) => setCurrentView(v), children: [
          ...
          /* @__PURE__ */ jsx(Tab, { value: "extend", children: "Extend" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("form", { noValidate: true, onSubmit: formController.handleSubmit, className: cls(isNewCollection ? "h-full" : "h-[calc(100%-48px)]", "flex-grow flex flex-col relative"), children: [
        ...
        currentView === "extend" && collection && /* @__PURE__ */ jsx(ExtendSettingsForm, { collection, parentCollection, configController, collectionInference, getUser, parentCollectionIds, isMergedCollection: !isNewCollection && isMergedCollection, onResetToCode: () => setDeleteRequested(true) }),
...
const ConfigControllerProvider = React__default.memo(function ConfigControllerProvider2(t0) {
  ...
  if ($[3] !== onAnalyticsEvent) {
    t2 = (t32) => {
      ...
      console.debug("Edit property", propertyKey, property, editedCollectionId, currentPropertiesOrder, parentCollectionIds_0, collection);
  ...
  if ($[30] !== currentPropertyDialog || $[31] !== getData || $[32] !== navigation) {
    t14 = currentPropertyDialog?.existingEntities || getData && currentPropertyDialog?.editedCollectionId ? async () => {
      ...
      if (currentPropertyDialog?.existingEntities) {
        data = currentPropertyDialog.existingEntities.map(_temp2);
      }
  ...
  if ($[34] !== collectionConfigController || $[35] !== currentPropertyDialog || $[36] !== snackbarController) {
    t15 = (t162) => {
      ...
      return collectionConfigController.saveProperty({
        ...
        snackbarController.open({
          type: "error",
          message: "Error persisting property: " + (e_0.message ?? "Details in the console")
        });
        return false;
      });
    };
  ...
  if ($[38] !== collectionConfigController || $[39] !== currentPropertyDialog?.currentPropertiesOrder || $[40] !== currentPropertyDialog?.editedCollectionId || $[41] !== currentPropertyDialog?.namespace || $[42] !== currentPropertyDialog?.parentCollectionIds || $[43] !== currentPropertyDialog?.propertyKey || $[44] !== snackbarController) {
    t16 = () => {
      ...
      return collectionConfigController.deleteProperty({
        ...
        snackbarController.open({
          type: "error",
          message: "Error deleting property: " + (e_1.message ?? "Details in the console")
        });
        return false;
      });
    };
...
function EditorCollectionAction(t0) {
  ...
  let t5;
  if ($[7] !== canEditCollection || $[8] !== collection || $[9] !== collectionEditorController || $[10] !== fullPath || $[11] !== parentCollection || $[12] !== parentCollectionIds || $[13] !== tableController?.data) {
...
function HomePageEditorCollectionAction(t0) {
  ...
  const collectionEditorController = useCollectionEditorController();
  let t1;
  if ($[0] !== authController || $[1] !== collection || $[2] !== collectionEditorController) {
  ...
  let t2;
  if ($[4] !== collection || $[5] !== collectionEditorController) {
    t2 = () => {
  ...
  let t3;
  if ($[7] !== collection || $[8] !== collectionEditorController) {
    t3 = () => {
    ...
    $[7] = collection;
    $[8] = collectionEditorController;
    $[9] = t3;
  } else {
    t3 = $[9];
  }
  const onDuplicateCollectionClicked = t3;
  const [deleteRequested, setDeleteRequested] = useState(false);
  let t4;
  if ($[10] !== collection || $[11] !== configController || $[12] !== snackbarController) {
    t4 = () => {
      configController?.deleteCollection({
        id: collection.id
      }).then(() => {
    ...
    $[10] = collection;
    $[11] = configController;
    $[12] = snackbarController;
    $[13] = t4;
  } else {
    t4 = $[13];
  }
  const deleteCollection = t4;
  let t5;
  if ($[14] !== onDuplicateCollectionClicked || $[15] !== permissions.createCollections || $[16] !== permissions.deleteCollections) {
    t5 = permissions.deleteCollections && /* @__PURE__ */ jsxs(Menu, { trigger: /* @__PURE__ */ jsx(IconButton, { size: "small", children: /* @__PURE__ */ jsx(MoreVertIcon, { size: "small" }) }), children: [
      permissions.createCollections && /* @__PURE__ */ jsxs(MenuItem, { dense: true, onClick: (event) => {
      ...
      /* @__PURE__ */ jsxs(MenuItem, { dense: true, onClick: (event_0) => {
    ...
    $[14] = onDuplicateCollectionClicked;
    $[15] = permissions.createCollections;
    $[16] = permissions.deleteCollections;
    $[17] = t5;
  } else {
    t5 = $[17];
  }
  let t6;
  if ($[18] !== onEditCollectionClicked || $[19] !== permissions.editCollections) {
    t6 = permissions.editCollections && /* @__PURE__ */ jsx(IconButton, { size: "small", onClick: (event_1) => {
      onEditCollectionClicked();
    }, children: /* @__PURE__ */ jsx(SettingsIcon, { size: "small" }) });
    $[18] = onEditCollectionClicked;
    $[19] = permissions.editCollections;
    $[20] = t6;
  } else {
    t6 = $[20];
  }
  ...
  let t9;
  if ($[24] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t8 = () => setDeleteRequested(false);
    t9 = /* @__PURE__ */ jsx(Fragment, { children: "Delete this collection?" });
    $[24] = t8;
    $[25] = t9;
  } else {
    t8 = $[24];
  ...
  let t11;
  if ($[27] !== deleteCollection || $[28] !== deleteRequested) {
    t11 = /* @__PURE__ */ jsx(ConfirmationDialog, { open: deleteRequested, onAccept: deleteCollection, onCancel: t8, title: t9, body: t10 });
    $[27] = deleteCollection;
    $[28] = deleteRequested;
    $[29] = t11;
  } else {
...
function CollectionViewHeaderAction(t0) {
  ...
  let t2;
  if ($[0] !== collection || $[1] !== collectionEditorController || $[2] !== parentCollectionIds || $[3] !== property || $[4] !== propertyKey || $[5] !== tableController.data) {
    t2 = () => {
    ...
    $[2] = parentCollectionIds;
    $[3] = property;
    $[4] = propertyKey;
    $[5] = tableController.data;
    $[6] = t2;
  } else {
    t2 = $[6];
  }
  ...
  let t4;
  if ($[8] !== t1 || $[9] !== t2) {
    t4 = /* @__PURE__ */ jsx(Tooltip, { asChild: true, title: "Edit", children: /* @__PURE__ */ jsx(IconButton, { className: t1, onClick: t2, size: "small", children: t3 }) });
    $[8] = t1;
    $[9] = t2;
    $[10] = t4;
  } else {
...
function PropertyAddColumnComponent(t0) {
  ...
  let t2;
  if ($[0] !== collection || $[1] !== collectionEditorController || $[2] !== parentCollectionIds || $[3] !== tableController.data) {
    t2 = () => {
      collectionEditorController.editProperty({
        editedCollectionId: collection.id,
        parentCollectionIds,
  ...
  let t5;
  if ($[8] !== t1 || $[9] !== t4) {
    t5 = /* @__PURE__ */ jsx(Tooltip, { asChild: true, title: t1, children: t4 });
    $[8] = t1;
    $[9] = t4;
    $[10] = t5;
  } else {
...
function NewCollectionButton() {
  ...
  let t2;
  if ($[3] !== t0) {
    t2 = /* @__PURE__ */ jsx("div", { className: "bg-surface-50 dark:bg-surface-900 min-w-fit rounded", children: /* @__PURE__ */ jsxs(Button, { className: "min-w-fit", onClick: t0, children: [
      t1,
      "New collection"
    ] }) });
    $[3] = t0;
...
function EditorCollectionActionStart(t0) {
  ...
  if (!equal(getObjectOrNull(tableController.filterValues), getObjectOrNull(collection.initialFilter)) || !equal(getObjectOrNull(tableController.sortBy), getObjectOrNull(collection.initialSort))) {
    const t22 = tableController.sortBy || tableController.filterValues ? "Save default filter and sort" : "Clear default filter and sort";
    let t32;
    if ($[4] !== collection || $[5] !== configController || $[6] !== parentCollectionIds || $[7] !== snackbarController || $[8] !== tableController.filterValues || $[9] !== tableController.sortBy) {
      t32 = () => configController?.saveCollection({
        id: collection.id,
        parentCollectionIds,
        collectionData: mergeDeep(collection, {
      ...
      $[5] = configController;
      $[6] = parentCollectionIds;
      $[7] = snackbarController;
      $[8] = tableController.filterValues;
      $[9] = tableController.sortBy;
      $[10] = t32;
    } else {
      t32 = $[10];
    }
    ...
    let t5;
    if ($[12] !== t32) {
      t5 = /* @__PURE__ */ jsx(Button, { size: "small", variant: "text", onClick: t32, children: t4 });
      $[12] = t32;
      $[13] = t5;
    } else {
      t5 = $[13];
    ...
    let t6;
    if ($[14] !== t22 || $[15] !== t5) {
      t6 = /* @__PURE__ */ jsx(Tooltip, { asChild: true, title: t22, children: t5 });
      $[14] = t22;
      $[15] = t5;
      $[16] = t6;
    } else {
    ...
    let t7;
    if ($[17] !== collection.initialFilter || $[18] !== collection.initialSort || $[19] !== tableController) {
      t7 = (collection.initialFilter || collection.initialSort) && /* @__PURE__ */ jsx(Tooltip, { title: "Reset to default filter and sort", children: /* @__PURE__ */ jsx(Button, { size: "small", variant: "text", onClick: () => {
      ...
      $[17] = collection.initialFilter;
      $[18] = collection.initialSort;
      $[19] = tableController;
      $[20] = t7;
    } else {
      t7 = $[20];
...
function NewCollectionCard(t0) {
  ...
  let t3;
  if ($[4] !== canCreateCollections || $[5] !== collectionEditorController || $[6] !== group) {
  ...
  let t6;
  if ($[10] !== canCreateCollections) {
    t6 = !canCreateCollections && /* @__PURE__ */ jsx(Typography, { variant: "caption", children: "You don't have permissions to create collections" });
    $[10] = canCreateCollections;
    $[11] = t6;
  } else {
    t6 = $[11];
  }
  let t7;
  if ($[12] !== t6) {
    t7 = /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center h-full w-full flex-grow flex-col", children: [
      t4,
      t5,
      t6
    ] });
  ...
  let t8;
  if ($[14] !== t3 || $[15] !== t7) {
    t8 = /* @__PURE__ */ jsx(Card, { className: t2, onClick: t3, children: t7 });
    $[14] = t3;
    $[15] = t7;
    $[16] = t8;
  } else {
...
function KanbanSetupAction(t0) {
  ...
  const collectionEditorController = useCollectionEditorController();
  let t1;
  if ($[0] !== collection.id || $[1] !== collectionEditorController || $[2] !== parentCollectionIds) {
    t1 = () => {
      collectionEditorController.editCollection({
        id: collection.id,
        parentCollectionIds,
  ...
  const handleConfigureClick = t1;
  let t2;
  if ($[4] !== handleConfigureClick) {
    t2 = /* @__PURE__ */ jsx(Button, { variant: "outlined", onClick: handleConfigureClick, children: "Configure Kanban" });
    $[4] = handleConfigureClick;
    $[5] = t2;
  } else {
    t2 = $[5];
  }
...
function AddKanbanColumnAction({
  collection,
  fullPath,
  parentCollectionIds,
  columnProperty
  ...
  const handleAddColumn = useCallback(async () => {
    ...
    setSaving(true);
    try {
      let property_0 = collection?.properties?.[columnProperty];
      let isCodeDefinedProperty = false;
      if (!property_0 || typeof property_0 === "function") {
        property_0 = resolvedCollection.properties?.[columnProperty];
        isCodeDefinedProperty = true;
      }
      if (!property_0 || typeof property_0 === "function" || !("dataType" in property_0) || property_0.dataType !== "string") {
        console.error("Column property not found or not a string. Property:", property_0);
        setSaving(false);
        return;
      }
      const stringProperty_0 = property_0;
      ...
      const updatedProperty = isCodeDefinedProperty ? {
        dataType: "string",
        name: stringProperty_0.name || columnProperty,
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: cls("border h-full w-80 min-w-80 mx-2 flex flex-col items-center justify-center rounded-md", "bg-surface-50 dark:bg-surface-950 hover:bg-surface-100 dark:hover:bg-surface-900", "cursor-pointer transition-colors duration-200 ease-in-out", defaultBorderMixin), onClick: () => setDialogOpen(true), children: [
      /* @__PURE__ */ jsx(IconButton, { size: "large", className: "opacity-60 hover:opacity-100", children: /* @__PURE__ */ jsx(AddIcon, { size: "large" }) }),
      /* @__PURE__ */ jsx(Typography, { variant: "caption", color: "secondary", className: "mt-2", children: "Add Column" })
    ] }),
    /* @__PURE__ */ jsxs(Dialog, { open: dialogOpen, onOpenChange: setDialogOpen, children: [
      /* @__PURE__ */ jsxs(DialogContent, { className: "max-w-md", children: [
        /* @__PURE__ */ jsx(Typography, { variant: "h6", className: "mb-4", children: "Add New Column" }),
        /* @__PURE__ */ jsxs(Typography, { variant: "body2", color: "secondary", className: "mb-4", children: [
          'Add a new option to the "',
          columnProperty,
          '" property. This will create a new column in the Kanban board.'
        ] }),
        /* @__PURE__ */ jsx(TextField, { label: "Column Name", value: newValueLabel, onChange: (e_0) => setNewValueLabel(e_0.target.value), onKeyDown: handleKeyDown, autoFocus: true, disabled: saving })
      ] }),
      /* @__PURE__ */ jsxs(DialogActions, { children: [
        /* @__PURE__ */ jsx(Button, { variant: "text", onClick: () => setDialogOpen(false), disabled: saving, children: "Cancel" }),
        /* @__PURE__ */ jsx(Button, { onClick: handleAddColumn, disabled: saving || !newValueLabel.trim(), children: saving ? "Adding..." : "Add Column" })
      ] })
    ] })
  ] });
}
function useCollectionEditorPlugin(t0) {
  ...
  let t8;
  if ($[22] !== collectionConfigController.loading || $[23] !== t2 || $[24] !== t5 || $[25] !== t6) {
    t8 = {
    ...
    $[22] = collectionConfigController.loading;
    $[23] = t2;
    $[24] = t5;
    $[25] = t6;
    $[26] = t8;
...
function MissingReferenceWidget(t0) {
  ...
  let t3;
  if ($[3] !== t2) {
    t3 = /* @__PURE__ */ jsx(ErrorView, { error: t2 });
    $[3] = t2;
    $[4] = t3;
  } else {
    t3 = $[4];
  ...
  if ($[5] !== collectionEditor || $[6] !== parentCollectionIds || $[7] !== path) {
    t4 = /* @__PURE__ */ jsx(Button, { className: "mx-2", size: "small", onClick: () => {
  ...
  let t5;
  if ($[9] !== t3 || $[10] !== t4) {
    t5 = /* @__PURE__ */ jsxs("div", { className: "p-1 flex flex-col items-center", children: [
      t3,
      t4
    ] });
    $[9] = t3;
