(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports, require("react"), require("@firecms/core"), require("react/jsx-runtime"), require("react-compiler-runtime"), require("react-fast-compare"), require("@firecms/ui")) : typeof define === "function" && define.amd ? define(["exports", "react", "@firecms/core", "react/jsx-runtime", "react-compiler-runtime", "react-fast-compare", "@firecms/ui"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.FireCMS = {}, global.React, global.core, global.jsxRuntime, global.reactCompilerRuntime, global.equal, global.ui));
})(this, (function(exports2, React, core, jsxRuntime, reactCompilerRuntime, equal, ui) {
  "use strict";
  ...
  function getSimplifiedProperties(properties, values, path = "") {
    ...
    return Object.entries(properties).map(([key, property]) => {
      if (core.isPropertyBuilder(property)) return {};
      const fullKey = path ? `${path}.${key}` : key;
      const valueInPath = core.getValueInPath(values, fullKey);
  ...
  function getSimpleProperty(property) {
    const fieldId = core.getFieldId(property);
    if (!fieldId) {
  ...
  function getSimplifiedProperty(property, path, value) {
    ...
    if (property.dataType === "array") {
      if (property.of && !core.isPropertyBuilder(property.of)) {
  ...
  function DataEnhancementControllerProvider({
    ...
    const resolvedCollection = core.resolveCollection({
      collection,
      path,
    ...
    const properties = React.useMemo(() => getSimplifiedProperties(resolvedCollection.properties, formContext?.values), [formContext?.values]);
    ...
    const dataSource = core.useDataSource(collection);
    ...
    const appendValueDelta = (propertyKey_0, delta) => {
      ...
      const value = core.getValueInPath(valuesRef.current, propertyKey_0);
    ...
    const updateSuggestedValues = (currentValues, updatedValues, replaceValues) => {
      ...
      Object.entries(updatedValues).forEach(([propertyKey_1, suggestion]) => {
        const value_0 = core.getValueInPath(currentValues, propertyKey_1);
      ...
      setSuggestions((prev_2) => ({
        ...
        ...Object.keys(updatedValues).reduce((acc, key) => {
          const value_1 = core.getValueInPath(formContext?.values, key);
  ...
  function AdvancedTextField({
    ...
    if (disabled) {
      return /* @__PURE__ */ jsxRuntime.jsx(ui.TextField, { label, disabled: true, value: internalValue });
    }
    const additional = {
      onKeyPress: (e_1) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: ui.cls("rounded-md relative max-w-full", ui.fieldBackgroundMixin, disabled ? ui.fieldBackgroundDisabledMixin : ui.fieldBackgroundHoverMixin, error ? "border border-red-500 dark:border-red-600" : "", {
      "min-h-[28px]": size === "smallest",
      "min-h-[32px]": size === "small",
      "min-h-[44px]": size === "medium",
      "min-h-[64px]": size === "large"
    }, className), children: [
      label && /* @__PURE__ */ jsxRuntime.jsx(ui.InputLabel, { className: ui.cls("absolute pointer-events-none", !error ? focused ? "text-primary" : "text-text-secondary dark:text-text-secondary-dark" : "text-red-500 dark:text-red-600", disabled ? "opacity-50" : "", size === "large" ? "top-1" : "-top-px"), shrink: hasValue || focused, children: label }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { ref, className: ui.cls("inset-0 whitespace-pre-wrap overflow-x-auto select-none pb-2 px-3", {
        "pt-8": size === "large",
        "pt-4": size === "medium" || size === "small"
      }), children: [
        addLineBreaks(originalValue, !endsWithHighlight && multiline),
        endsWithHighlight && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dark:bg-surface-700 bg-surface-300 p-px -m-px rounded-sm", children: addLineBreaks(highlight, multiline) })
      ] }),
      /* @__PURE__ */ jsxRuntime.jsx(ui.TextareaAutosize, { className: ui.cls({
        "min-h-[28px]": size === "smallest",
        "min-h-[32px]": size === "small",
        "min-h-[44px]": size === "medium",
        "min-h-[64px]": size === "large"
  ...
  function addLineBreaks(value, addLastBreak = false) {
    ...
    if (lines.length === 1) return /* @__PURE__ */ jsxRuntime.jsx("span", { className: "break-words", children: value ?? " " });
    return lines.map((p, i) => /* @__PURE__ */ jsxRuntime.jsxs(React.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "break-words", children: p ?? " " }),
      (lines.length - 1 !== i || addLastBreak) && /* @__PURE__ */ jsxRuntime.jsx("br", {})
    ] }, i));
  }
  const EnhanceTextFieldBinding = React.memo(function EnhanceTextFieldBinding2(t0) {
    ...
    if ($[6] !== propertyKey || $[7] !== t3 || $[8] !== t4) {
      t5 = /* @__PURE__ */ jsxRuntime.jsx(core.LabelWithIconAndTooltip, { propertyKey, icon: t3, title: t4 });
      $[6] = propertyKey;
      $[7] = t3;
      $[8] = t4;
      $[9] = t5;
    ...
    if ($[10] !== disabled || $[11] !== highlight || $[12] !== internalValue || $[13] !== multiline || $[14] !== setValue || $[15] !== showError || $[16] !== size || $[17] !== t2 || $[18] !== t5) {
      t6 = /* @__PURE__ */ jsxRuntime.jsx(AdvancedTextField, { inputType: t2, label: t5, value: internalValue, multiline, highlight, setValue, disabled, error: showError, size });
      $[10] = disabled;
      $[11] = highlight;
      $[12] = internalValue;
      $[13] = multiline;
    ...
    if ($[20] !== propertyKey || $[21] !== t6) {
      t7 = /* @__PURE__ */ jsxRuntime.jsx(core.PropertyIdCopyTooltip, { propertyKey, children: t6 });
      $[20] = propertyKey;
      $[21] = t6;
      $[22] = t7;
    } else {
    ...
    if ($[23] !== disabled || $[24] !== error || $[25] !== includeDescription || $[26] !== property || $[27] !== showError) {
      t8 = /* @__PURE__ */ jsxRuntime.jsx(core.FieldHelperText, { includeDescription, showError, error, disabled, property });
      $[23] = disabled;
      $[24] = error;
  ...
  function fieldBuilder(params) {
    ...
    const wrappedComponent = React.useMemo(() => function FieldWrapper(props) {
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(FieldInner, { loading, props, suggestedValue, enabled, enoughData, Field: params.Field, enhance, editorAIController });
    }, []);
  ...
  const FieldInner = React.memo(function FieldInner2(t0) {
    ...
    if (!enabled) {
      let t22;
      if ($[0] !== Field || $[1] !== props) {
        t22 = /* @__PURE__ */ jsxRuntime.jsx(Field, { ...props });
        $[0] = Field;
        $[1] = props;
        $[2] = t22;
      } else {
    ...
    if (property.dataType === "string" && property.markdown) {
      ...
      let t6;
      if ($[11] !== t32 || $[12] !== t52) {
        t6 = /* @__PURE__ */ jsxRuntime.jsx(core.MarkdownEditorFieldBinding, { ...t32, customProps: t52 });
        $[11] = t32;
        $[12] = t52;
        $[13] = t6;
      } else {
      ...
      if (property.dataType === "string" && !property.enumValues) {
        ...
        let t52;
        if ($[14] !== t32 || $[15] !== t42) {
          t52 = /* @__PURE__ */ jsxRuntime.jsx(EnhanceTextFieldBinding, { ...t32, highlight: t42 });
          $[14] = t32;
          $[15] = t42;
          $[16] = t52;
        } else {
        ...
        if ($[17] !== Field || $[18] !== props) {
          t32 = /* @__PURE__ */ jsxRuntime.jsx(Field, { ...props });
          $[17] = Field;
          $[18] = props;
          $[19] = t32;
        } else {
    ...
    if ($[26] !== allowInstructions || $[27] !== dataLoading || $[28] !== enhance || $[29] !== enhanceData || $[30] !== enoughData || $[31] !== loading || $[32] !== menuOpen || $[33] !== property.name || $[34] !== propertyInstructions || $[35] !== props.context.entityId || $[36] !== props.context.values || $[37] !== props.propertyKey || $[38] !== rightClass || $[39] !== showEnhanceIcon || $[40] !== tooltipOpen || $[41] !== topClass) {
      t4 = showEnhanceIcon && /* @__PURE__ */ jsxRuntime.jsx("div", { className: ui.cls("dark:bg-surface-700 bg-surface-100 rounded-full absolute", rightClass, topClass), children: /* @__PURE__ */ jsxRuntime.jsx(ui.Tooltip, { open: tooltipOpen, onOpenChange: setTooltipOpen, side: "left", asChild: false, title: enoughData ? `Autofill ${property.name ?? "this field"}` : `You need to input some data in the form before enhancing ${property.name ?? "this field"}`, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Menu, { open: menuOpen, onOpenChange: setMenuOpen, trigger: /* @__PURE__ */ jsxRuntime.jsx(ui.IconButton, { size: "smallest", "aria-label": "Enhance field", disabled: dataLoading || loading, className: enoughData ? "text-surface-900 dark:text-white" : "text-surface-400 dark:text-surface-600", onClick: () => {
        if (!props.context.entityId) {
          return;
        }
        if (!enoughData) {
      ...
      }, children: dataLoading || loading ? /* @__PURE__ */ jsxRuntime.jsx(ui.CircularProgress, { size: "smallest" }) : /* @__PURE__ */ jsxRuntime.jsx(ui.AutoAwesomeIcon, { size: "smallest" }) }), children: [
        /* @__PURE__ */ jsxRuntime.jsxs(ui.MenuItem, { onClick: () => enhanceData(), children: [
          /* @__PURE__ */ jsxRuntime.jsx(ui.AutoAwesomeIcon, { size: "small" }),
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsxRuntime.jsxs(ui.Typography, { variant: "body2", children: [
              " ",
              `Autofill ${property.name ?? "this field"}`
            ] }),
            /* @__PURE__ */ jsxRuntime.jsx(ui.Typography, { variant: "caption", children: "based on the rest of the entity" })
          ] })
        ] }),
        allowInstructions && /* @__PURE__ */ jsxRuntime.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntime.jsx(ui.TextField, { label: "Ask AI to write", size: "small", className: "w-[400px] max-w-full text-text-primary dark:text-text-primary-dark", value: propertyInstructions ?? "", onKeyDown: (e) => {
          if (e.key === "Enter") {
            enhanceData(propertyInstructions);
          }
        }, placeholder: "Instructions", onChange: (e_0) => setPropertyInstructions(e_0.target.value), endAdornment: /* @__PURE__ */ jsxRuntime.jsx(ui.IconButton, { size: "small", onClick: () => enhanceData(propertyInstructions), disabled: !propertyInstructions, children: /* @__PURE__ */ jsxRuntime.jsx(ui.SendIcon, { size: "small" }) }) }) })
      ] }) }) });
  ...
  function FormEnhanceAction({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(ui.Menu, { align: "end", sideOffset: 8, className: "max-w-[100vw]", trigger: /* @__PURE__ */ jsxRuntime.jsxs(ui.Button, { variant: "filled", color: "neutral", fullWidth: largeLayout && openEntityMode === "full_screen", size: "small", disabled: loading || disabled, children: [
      ...
      samplePrompts?.map((samplePrompt, index) => {
        return /* @__PURE__ */ jsxRuntime.jsxs(ui.MenuItem, { onClick: () => {
          ...
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "pl-9 flex-grow text-text-secondary dark:text-text-secondary-dark", children: samplePrompt.prompt }),
          ...
          }, size: "smallest", children: /* @__PURE__ */ jsxRuntime.jsx(ui.CloseIcon, { size: "smallest" }) })
      ...
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: ui.cls("my-2 w-[500px] max-w-full flex items-start text-surface-700 dark:text-surface-200"), children: [
        /* @__PURE__ */ jsxRuntime.jsx(ui.TextareaAutosize, { className: ui.cls("p-4 rounded-lg resize-none bg-surface-100 dark:bg-surface-800 mx-2 w-full flex-grow outline-none max-h-[300px] overflow-auto", ui.focusedDisabled), value: instructions, autoFocus: status === "new", disabled: loading || noIdSet, onFocus: (event) => {
        ...
        /* @__PURE__ */ jsxRuntime.jsx(ui.IconButton, { size: "small", onClick: () => {
          setInstructions("");
        }, color: !instructions ? "primary" : void 0, disabled: loading || !instructions, children: /* @__PURE__ */ jsxRuntime.jsx(ui.CloseIcon, { size: "small" }) }),
  ...
  const createLocalStorageKey = (path, status) => {
    ...
    return `data_enhancement::${statusString}::${core.stripCollectionPath(path)}`;
  };
  ...
  function useDataEnhancementPlugin(props) {
    ...
    const authController = core.useAuthController();
    const fieldBuilderEnabled = React.useCallback((params) => {
