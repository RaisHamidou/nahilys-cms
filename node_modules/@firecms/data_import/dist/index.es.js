...
import { getPropertyInPath, mergeDeep, resolveProperty, isPropertyBuilder, EntityReference, useSnackbarController, useCustomizationController, getFieldConfig, PropertyConfigBadge, ErrorBoundary, useDataSource, useAuthController, resolveCollection, getPropertiesWithPropertiesOrder, useNavigationController, useSelectionController, EntityCollectionTable, slugify } from "@firecms/core";
import { TableRow, TableCell, Typography, ChevronRightIcon, TableHeader, Table, TableBody, ExpandablePanel, SelectItem, TextField, BooleanSwitchWithLabel, DateTimeField, Select, UploadIcon, FileUpload, EditIcon, IconButton, Button, CenteredView, CircularProgress, cls, defaultBorderMixin, Tooltip, DialogTitle, DialogContent, DialogActions, Dialog } from "@firecms/ui";
import { inferTypeFromValue, buildEntityPropertiesFromData } from "@firecms/schema_inference";
...
const useImportConfig = () => {
  ...
  const [defaultValues, setDefaultValues] = useState(t0);
  ...
  const [importData, setImportData] = useState(t1);
  let t2;
  ...
  const [entities, setEntities] = useState(t2);
  let t3;
  ...
  const [headersMapping, setHeadersMapping] = useState(t3);
  let t4;
  ...
  const [headingsOrder, setHeadingsOrder] = useState(t4);
  let t5;
  ...
  const [originProperties, setOriginProperties] = useState(t5);
  let t6;
  if ($[6] !== headersMapping || $[7] !== headingsOrder) {
  ...
  let t7;
  if ($[9] !== defaultValues || $[10] !== entities || $[11] !== headersMapping || $[12] !== idColumn || $[13] !== importData || $[14] !== inUse || $[15] !== originProperties || $[16] !== t6) {
    t7 = {
      inUse,
      setInUse,
      idColumn,
...
function convertDataToEntity(authController, navigation, data, idColumn, headersMapping, properties, path, defaultValues) {
...
function processValueMapping(authController, value, navigation, property) {
  if (value === null) return null;
  if (property === void 0) return value;
  const usedProperty = resolveProperty({
  ...
  if (from === "array" && to === "array" && Array.isArray(value) && usedProperty.of && !isPropertyBuilder(usedProperty.of)) {
    return value.map((v) => processValueMapping(authController, v, navigation, usedProperty.of));
    ...
    return value.split(",").map((v) => processValueMapping(authController, v, usedProperty.of));
    ...
    if (databaseId === void 0) {
      const targetCollection = navigation.getCollectionById(path);
...
function DataNewPropertiesMapping(t0) {
  ...
  let t2;
  if ($[2] !== headersMapping || $[3] !== idColumn || $[4] !== t1) {
    t2 = /* @__PURE__ */ jsx(IdSelectField, { idColumn, headersMapping, onChange: t1 });
    $[2] = headersMapping;
    $[3] = idColumn;
    $[4] = t1;
    $[5] = t2;
  ...
  if ($[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t3 = /* @__PURE__ */ jsx("div", { className: "h-4" });
    $[6] = t3;
  } else {
    t3 = $[6];
  }
  ...
  if ($[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t5 = /* @__PURE__ */ jsx(TableCell, { header: true, style: {
      width: "20%"
    }, children: "Column in file" });
    t6 = /* @__PURE__ */ jsx(TableCell, { header: true });
    $[8] = t5;
    $[9] = t6;
  } else {
    t5 = $[8];
  ...
  if ($[10] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t7 = /* @__PURE__ */ jsxs(TableHeader, { children: [
      t5,
      t6,
      /* @__PURE__ */ jsx(TableCell, { header: true, style: {
        width: "75%"
  ...
  let t8;
  if ($[11] !== buildPropertyView || $[12] !== destinationProperties || $[13] !== headersMapping || $[14] !== headingsOrder || $[15] !== idColumn || $[16] !== originProperties) {
    t8 = destinationProperties && headingsOrder.map((importKey) => {
      ...
      return /* @__PURE__ */ jsxs(TableRow, { style: {
        height: "90px"
      }, children: [
        /* @__PURE__ */ jsxs(TableCell, { style: {
          width: "20%"
        }, children: [
          /* @__PURE__ */ jsx(Typography, { variant: "body2", children: importKey }),
          originProperty && /* @__PURE__ */ jsx(Typography, { variant: "caption", color: "secondary", children: originDataType })
        ] }),
        /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(ChevronRightIcon, {}) }),
        /* @__PURE__ */ jsx(TableCell, { className: importKey === idColumn ? "text-center" : void 0, style: {
          width: "75%"
    ...
    $[11] = buildPropertyView;
    $[12] = destinationProperties;
    $[13] = headersMapping;
    $[14] = headingsOrder;
    $[15] = idColumn;
    $[16] = originProperties;
  ...
  let t9;
  if ($[18] !== t8) {
    t9 = /* @__PURE__ */ jsxs(Table, { style: t4, children: [
      t7,
      /* @__PURE__ */ jsx(TableBody, { children: t8 })
    ] });
    $[18] = t8;
    $[19] = t9;
  } else {
  ...
  if ($[20] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t10 = /* @__PURE__ */ jsx("div", { className: "text-sm text-surface-accent-500 dark:text-surface-accent-300 font-medium ml-3.5 mb-1", children: "You can select a default value for unmapped columns and empty values:" });
    $[20] = t10;
  } else {
    t10 = $[20];
  }
  ...
  if ($[22] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t12 = /* @__PURE__ */ jsx(TableCell, { header: true, style: {
      width: "30%"
    }, children: "Property" });
    t13 = /* @__PURE__ */ jsx(TableCell, { header: true });
    $[22] = t12;
    $[23] = t13;
  } else {
    t12 = $[22];
  ...
  if ($[24] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t14 = /* @__PURE__ */ jsxs(TableHeader, { children: [
      t12,
      t13,
      /* @__PURE__ */ jsx(TableCell, { header: true, style: {
        width: "65%"
  ...
  let t15;
  if ($[25] !== destinationProperties || $[26] !== idColumn || $[27] !== importConfig) {
    t15 = destinationProperties && getAllPropertyKeys(destinationProperties).map((key) => {
      const property_0 = getPropertyInPath(destinationProperties, key);
      ...
      return /* @__PURE__ */ jsxs(TableRow, { style: {
        ...
        /* @__PURE__ */ jsx(TableCell, { style: {
          width: "20%"
        }, children: /* @__PURE__ */ jsx(Typography, { variant: "body2", children: key }) }),
        /* @__PURE__ */ jsx(TableCell, { children: /* @__PURE__ */ jsx(ChevronRightIcon, {}) }),
        /* @__PURE__ */ jsx(TableCell, { className: key === idColumn ? "text-center" : void 0, style: {
          width: "75%"
        }, children: /* @__PURE__ */ jsx(DefaultValuesField, { property: property_0, defaultValue: getIn(importConfig.defaultValues, key), onValueChange: (value_0) => {
          const newValues = setIn(importConfig.defaultValues, key, value_0);
          importConfig.setDefaultValues(newValues);
        } }) })
      ] }, key);
    });
    $[25] = destinationProperties;
    $[26] = idColumn;
    $[27] = importConfig;
    $[28] = t15;
  } else {
  ...
  let t16;
  if ($[29] !== t15) {
    t16 = /* @__PURE__ */ jsxs(ExpandablePanel, { title: "Default values", initiallyExpanded: false, innerClassName: "p-4 mt-4", children: [
      t10,
      /* @__PURE__ */ jsxs(Table, { style: t11, children: [
        t14,
        /* @__PURE__ */ jsx(TableBody, { children: t15 })
      ] })
    ] });
    $[29] = t15;
    $[30] = t16;
...
function IdSelectField(t0) {
  ...
  let t3;
  if ($[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t3 = /* @__PURE__ */ jsx(SelectItem, { value: "__none__", children: "Autogenerate ID" });
    $[2] = t3;
  } else {
    t3 = $[2];
  }
  let t4;
  if ($[3] !== headersMapping) {
    t4 = Object.entries(headersMapping).map(_temp2$1);
    $[3] = headersMapping;
    $[4] = t4;
  } else {
    t4 = $[4];
  ...
  let t5;
  if ($[5] !== t1 || $[6] !== t2 || $[7] !== t4) {
    t5 = /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs(Select, { size: "medium", value: t1, fullWidth: true, onChange: t2, placeholder: "Autogenerate ID", renderValue: _temp$1, label: "Column that will be used as ID for each document", children: [
      t3,
      t4
    ] }) });
    $[5] = t1;
...
function _temp2$1(t0) {
  const [key] = t0;
  return /* @__PURE__ */ jsx(SelectItem, { value: key, children: key }, key);
}
function _temp$1(value_0) {
  return /* @__PURE__ */ jsx(Typography, { variant: "body2", children: value_0 !== "__none__" ? value_0 : "Autogenerate ID" });
}
function DefaultValuesField(t0) {
  ...
  if (property.dataType === "string") {
    ...
    let t3;
    if ($[2] !== t1 || $[3] !== t2) {
      t3 = /* @__PURE__ */ jsx(TextField, { size: "medium", placeholder: "Default value", value: t1, onChange: t2 });
      $[2] = t1;
      $[3] = t2;
      $[4] = t3;
    } else {
    ...
    if (property.dataType === "number") {
      ...
      let t3;
      if ($[7] !== t1 || $[8] !== t2) {
        t3 = /* @__PURE__ */ jsx(TextField, { size: "medium", type: "number", value: t1, placeholder: "Default value", onChange: t2 });
        $[7] = t1;
        $[8] = t2;
        $[9] = t3;
      } else {
      ...
      if (property.dataType === "boolean") {
        ...
        let t2;
        if ($[10] !== onValueChange) {
          t2 = (v) => onValueChange(v === null ? void 0 : v);
          $[10] = onValueChange;
          $[11] = t2;
        } else {
          t2 = $[11];
        ...
        if ($[12] !== t1 || $[13] !== t2 || $[14] !== t3) {
          t4 = /* @__PURE__ */ jsx(BooleanSwitchWithLabel, { value: t1, allowIndeterminate: true, size: "small", onValueChange: t2, label: t3 });
          $[12] = t1;
          $[13] = t2;
          $[14] = t3;
          $[15] = t4;
        ...
        if (property.dataType === "date") {
          ...
          if ($[18] !== t1 || $[19] !== t2 || $[20] !== t3) {
            t4 = /* @__PURE__ */ jsx(DateTimeField, { mode: t1, size: "medium", value: t2, onChange: t3, clearable: true });
            $[18] = t1;
            $[19] = t2;
            $[20] = t3;
            $[21] = t4;
...
function ImportFileUpload(t0) {
  ...
  let t3;
  if ($[2] !== onDataAdded || $[3] !== snackbarController) {
    t3 = /* @__PURE__ */ jsx(FileUpload, { accept: t1, preventDropOnDocument: true, size: "small", maxFiles: 1, uploadDescription: t2, onFilesAdded: (files) => {
      if (files.length > 0) {
...
function ImportNewPropertyFieldPreview(t0) {
  ...
  const widget = t2;
  let t3;
  if ($[3] !== propertyTypeView || $[4] !== widget) {
    t3 = propertyTypeView ?? /* @__PURE__ */ jsx(PropertyConfigBadge, { propertyConfig: widget ?? void 0 });
    $[3] = propertyTypeView;
    $[4] = widget;
    $[5] = t3;
  } else {
  ...
  let t4;
  if ($[6] !== t3) {
    t4 = /* @__PURE__ */ jsx("div", { className: "mx-4", children: t3 });
    $[6] = t3;
    $[7] = t4;
  } else {
    t4 = $[7];
  ...
  let t5;
  if ($[8] !== includeName || $[9] !== onPropertyNameChanged || $[10] !== property?.name || $[11] !== propertyKey) {
    t5 = includeName && /* @__PURE__ */ jsx(TextField, { size: "medium", className: "text-base grow", value: property?.name ?? "", onChange: (e) => {
      if (onPropertyNameChanged && propertyKey) {
        onPropertyNameChanged(propertyKey, e.target.value);
      }
    } });
    $[8] = includeName;
    $[9] = onPropertyNameChanged;
    $[10] = property?.name;
    $[11] = propertyKey;
    $[12] = t5;
  } else {
  ...
  if ($[13] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t6 = /* @__PURE__ */ jsx(EditIcon, { size: "small" });
    $[13] = t6;
  } else {
    t6 = $[13];
  }
  let t7;
  if ($[14] !== onEditClick) {
    t7 = /* @__PURE__ */ jsx(IconButton, { onClick: onEditClick, size: "small", children: t6 });
    $[14] = onEditClick;
    $[15] = t7;
  } else {
    t7 = $[15];
  ...
  let t8;
  if ($[16] !== t5 || $[17] !== t7) {
    t8 = /* @__PURE__ */ jsx("div", { className: "w-full flex flex-col grow", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center gap-2", children: [
      t5,
      t7
    ] }) });
    $[16] = t5;
  ...
  let t9;
  if ($[19] !== t4 || $[20] !== t8) {
    t9 = /* @__PURE__ */ jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-row w-full items-center", children: [
      t4,
      t8
    ] }) });
    $[19] = t4;
...
function ImportSaveInProgress(t0) {
  ...
  let t1;
  if ($[0] !== collection || $[1] !== dataSource || $[2] !== importConfig || $[3] !== onImportSuccess || $[4] !== path) {
    t1 = function save2() {
      if (savingRef.current) {
        return;
      }
      savingRef.current = true;
      saveDataBatch(dataSource, collection, path, importConfig.entities, 0, 25, setProcessedEntities).then(() => {
  ...
  if (errorSaving) {
    ...
    if ($[9] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
      t42 = /* @__PURE__ */ jsx(Typography, { variant: "h6", children: "Error saving data" });
      $[9] = t42;
    } else {
      t42 = $[9];
    }
    let t52;
    if ($[10] !== errorSaving.message) {
      t52 = /* @__PURE__ */ jsx(Typography, { variant: "body2", color: "error", children: errorSaving.message });
      $[10] = errorSaving.message;
      $[11] = t52;
    } else {
      t52 = $[11];
    }
    let t62;
    if ($[12] !== save) {
      t62 = /* @__PURE__ */ jsx(Button, { onClick: save, children: "Retry" });
      $[12] = save;
      $[13] = t62;
    } else {
      t62 = $[13];
    ...
    let t72;
    if ($[14] !== t52 || $[15] !== t62) {
      t72 = /* @__PURE__ */ jsxs(CenteredView, { className: "flex flex-col gap-4 items-center", children: [
        t42,
        t52,
        t62
      ] });
  ...
  if ($[17] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t4 = /* @__PURE__ */ jsx(CircularProgress, {});
    t5 = /* @__PURE__ */ jsx(Typography, { variant: "h6", children: "Saving data" });
    $[17] = t4;
    $[18] = t5;
  } else {
    t4 = $[17];
  ...
  let t6;
  if ($[19] !== importConfig.entities.length || $[20] !== processedEntities) {
    t6 = /* @__PURE__ */ jsxs(Typography, { variant: "body2", children: [
      processedEntities,
      "/",
      importConfig.entities.length,
      " entities saved"
    ] });
    $[19] = importConfig.entities.length;
    $[20] = processedEntities;
    $[21] = t6;
  } else {
    t6 = $[21];
  }
  let t7;
  if ($[22] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t7 = /* @__PURE__ */ jsx(Typography, { variant: "caption", children: "Do not close this tab or the import will be interrupted." });
    $[22] = t7;
  } else {
    t7 = $[22];
  }
  let t8;
  if ($[23] !== t6) {
    t8 = /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 items-center", children: [
      t4,
      t5,
      t6,
      t7
...
function saveDataBatch(dataSource, collection, path, data, offset = 0, batchSize = 25, onProgressUpdate) {
...
function ImportCollectionAction(t0) {
  ...
  let t6;
  if ($[11] !== authController || $[12] !== collection || $[13] !== customizationController.propertyConfigs || $[14] !== path) {
    ...
    properties = getPropertiesWithPropertiesOrder(resolvedCollection.properties, resolvedCollection.propertiesOrder);
    t6 = Object.entries(properties).flatMap(_temp);
    $[11] = authController;
    $[12] = collection;
    $[13] = customizationController.propertyConfigs;
    $[14] = path;
    $[15] = properties;
    $[16] = resolvedCollection;
    $[17] = t6;
  } else {
    properties = $[15];
    resolvedCollection = $[16];
    t6 = $[17];
  }
  const propertiesAndLevel = t6;
  let t7;
  if ($[18] !== resolvedCollection.properties || $[19] !== resolvedCollection.propertiesOrder) {
    t7 = resolvedCollection.propertiesOrder ?? Object.keys(resolvedCollection.properties);
    $[18] = resolvedCollection.properties;
    $[19] = resolvedCollection.propertiesOrder;
    $[20] = t7;
  } else {
    t7 = $[20];
  }
  const propertiesOrder = t7;
  if (collection.collectionGroup) {
    return null;
  }
  let t8;
  if ($[21] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t8 = /* @__PURE__ */ jsx(UploadIcon, { size: "small" });
    $[21] = t8;
  } else {
    t8 = $[21];
  }
  let t9;
  if ($[22] !== handleClickOpen) {
    t9 = /* @__PURE__ */ jsx(Tooltip, { title: "Import", asChild: true, children: /* @__PURE__ */ jsx(IconButton, { size: "small", color: "primary", onClick: handleClickOpen, children: t8 }) });
    $[22] = handleClickOpen;
    $[23] = t9;
  } else {
    t9 = $[23];
  }
  const t10 = step !== "initial";
  const t11 = step !== "initial";
  const t12 = step === "initial" ? "lg" : "7xl";
  const t13 = step === "preview";
  let t14;
  if ($[24] !== t13) {
    t14 = /* @__PURE__ */ jsx(DialogTitle, { variant: "h6", hidden: t13, children: "Import data" });
    $[24] = t13;
    $[25] = t14;
  } else {
    t14 = $[25];
  }
  const t15 = step === "preview";
  let t16;
  if ($[26] !== onDataAdded || $[27] !== step) {
    t16 = step === "initial" && /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  let t17;
  if ($[29] !== importConfig || $[30] !== onAnalyticsEvent || $[31] !== properties || $[32] !== propertiesAndLevel || $[33] !== step) {
    t17 = step === "mapping" && /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(DataNewPropertiesMapping, { importConfig, destinationProperties: properties, buildPropertyView: (t182) => {
      const {
        isIdColumn,
        propertyKey,
        importKey
      ...
      return /* @__PURE__ */ jsx(PropertyTreeSelect, { selectedPropertyKey: propertyKey ?? "", properties, propertiesAndLevel, isIdColumn, onIdSelected: () => {
        ...
        const newHeadersMapping = Object.entries(importConfig.headersMapping).map((t192) => {
          const [currentImportKey, currentPropertyKey] = t192;
  ...
  let t18;
  if ($[35] !== importConfig || $[36] !== properties || $[37] !== propertiesOrder || $[38] !== step) {
    t18 = step === "preview" && /* @__PURE__ */ jsx(ImportDataPreview, { importConfig, properties, propertiesOrder });
    $[35] = importConfig;
    $[36] = properties;
    $[37] = propertiesOrder;
    $[38] = step;
  ...
  let t19;
  if ($[40] !== collection || $[41] !== importConfig || $[42] !== path || $[43] !== snackbarController || $[44] !== step) {
    t19 = step === "import_data_saving" && importConfig && /* @__PURE__ */ jsx(ImportSaveInProgress, { importConfig, collection, path, onImportSuccess: (importedCollection) => {
      handleClose();
      snackbarController.open({
        type: "info",
  ...
  let t20;
  if ($[46] !== t15 || $[47] !== t16 || $[48] !== t17 || $[49] !== t18 || $[50] !== t19) {
    t20 = /* @__PURE__ */ jsxs(DialogContent, { className: "h-full flex flex-col gap-4 my-4", fullHeight: t15, children: [
      t16,
      t17,
      t18,
      t19
  ...
  let t21;
  if ($[52] !== step) {
    t21 = step === "mapping" && /* @__PURE__ */ jsx(Button, { onClick: () => setStep("initial"), variant: "text", children: "Back" });
    $[52] = step;
    $[53] = t21;
  } else {
    t21 = $[53];
  ...
  let t22;
  if ($[54] !== step) {
    t22 = step === "preview" && /* @__PURE__ */ jsx(Button, { onClick: () => setStep("mapping"), variant: "text", children: "Back" });
    $[54] = step;
    $[55] = t22;
  } else {
    t22 = $[55];
  ...
  if ($[56] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t23 = /* @__PURE__ */ jsx(Button, { onClick: handleClose, variant: "text", children: "Cancel" });
    $[56] = t23;
  } else {
    t23 = $[56];
  }
  let t24;
  if ($[57] !== onMappingComplete || $[58] !== step) {
    t24 = step === "mapping" && /* @__PURE__ */ jsx(Button, { variant: "filled", color: "primary", onClick: onMappingComplete, children: "Next" });
    $[57] = onMappingComplete;
    $[58] = step;
    $[59] = t24;
  } else {
    t24 = $[59];
  ...
  let t25;
  if ($[60] !== onPreviewComplete || $[61] !== step) {
    t25 = step === "preview" && /* @__PURE__ */ jsx(Button, { variant: "filled", color: "primary", onClick: onPreviewComplete, children: "Save data" });
    $[60] = onPreviewComplete;
    $[61] = step;
    $[62] = t25;
  } else {
    t25 = $[62];
  ...
  let t26;
  if ($[63] !== t21 || $[64] !== t22 || $[65] !== t24 || $[66] !== t25) {
    t26 = /* @__PURE__ */ jsxs(DialogActions, { children: [
      t21,
      t22,
      t23,
      t24,
  ...
  let t27;
  if ($[68] !== open || $[69] !== t10 || $[70] !== t11 || $[71] !== t12 || $[72] !== t14 || $[73] !== t20 || $[74] !== t26) {
    t27 = /* @__PURE__ */ jsxs(Dialog, { open, fullWidth: t10, fullHeight: t11, maxWidth: t12, children: [
      t14,
      t20,
      t26
    ] });
...
function PropertyTreeSelect(t0) {
  ...
  if ($[12] !== onSelectValueChange || $[13] !== renderValue || $[14] !== t4 || $[15] !== t7) {
    t8 = /* @__PURE__ */ jsxs(Select, { value: t4, size: "large", fullWidth: true, onValueChange: onSelectValueChange, renderValue, children: [
      t5,
      t6,
      t7
    ] });
...
function _temp3(t0) {
  ...
  return /* @__PURE__ */ jsx(SelectItem, { value: propertyKey, disabled: property.dataType === "map", children: /* @__PURE__ */ jsx(PropertySelectEntry, { propertyKey, property, level }) }, propertyKey);
}
...
function PropertySelectEntry(t0) {
  ...
  let t8;
  if ($[10] !== t7) {
    t8 = /* @__PURE__ */ jsx(Typography, { variant: "body1", component: "span", className: "flex-grow pr-2", children: t7 });
    $[10] = t7;
    $[11] = t8;
  } else {
    t8 = $[11];
  ...
  let t10;
  if ($[14] !== t8 || $[15] !== t9) {
    t10 = /* @__PURE__ */ jsxs("div", { className: "flex flex-col flex-grow p-2 pl-2", children: [
      t8,
      t9
    ] });
    $[14] = t8;
