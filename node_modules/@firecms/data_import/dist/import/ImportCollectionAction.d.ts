...
export declare function ImportCollectionAction<M extends Record<string, any>, USER extends User>({ collection, path, onAnalyticsEvent }: CollectionActionsProps<M, USER> & {
